...
{{/unless}}`});var T,w=i(()=>{T=`<!-- QGDS Component: Callout -->
...
`});var A,S=i(()=>{A=`<a class="qld-cta-link {{getClassNames "small, view-all" class}}"
    {{#if id}}id="{{id}}"{{/if}}
    href="{{href}}"
    target="{{target}}"
...
`});var e1,K=i(()=>{e1=`<!-- QGDS Component: Details -->
...
`});var a1,i1=i(()=>{a1=`{{! valid class values are: up, down, left, right}}
<a class="qld-dir-link {{class}}" 
  ...
  <span class="qld-icon qld-icon-md qld-icon-arrow-{{class}}" aria-hidden="true"></span>
</a>`});var C1,t1=i(()=>{C1=`<div class="col-12 col-md-6 col-lg-12">
    ...
    </div>`});var l1,s1=i(()=>{l1=`{{#if followLinks }}
...
{{/if}}`});var o1,n1=i(()=>{o1=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
...
</html>`});var u1,p1=i(()=>{u1=`<!-- QGDS Component: Global Alert -->
...
`});var h1,v1=i(()=>{h1=`<header class="qld-header " role="banner">
...
</html>`});var k1,M1=i(()=>{k1=`<svg class="qld-icon-{{size}}"{{#if ariaLabel}} aria-label="{{ariaLabel}}"{{/if}}{{#if ariaHidden}} aria-hidden="{{ariaHidden}}"{{/if}}>
  <use href="./assets/img/icons-sprite.svg#qgds-icon-{{iconId}}"></use>
</svg>`});var q1,y1=i(()=>{q1=`{{! Image template }}
{{#*inline "imageTag"}}
...
{{#if src}}
  ...
  {{/ifAny}}
{{/if}}
`});var x1,Z1=i(()=>{x1=`<div class="alert {{variantClass}} {{customClass}}" role="alert"
    {{#if ariaLabel}}
...
>
    ...
    {{/if}}
    {{{ content }}}
</div>`});var T1,w1=i(()=>{T1=`<!-- QGDS Partial: inpage-nav -->
...
</nav>`});var A1,S1=i(()=>{A1=`{{!-- Link icon partial --}}
{{#*inline "linkIcon"~}}
<span class="qld-icon qld-icon-md {{iconClass}} {{iconPosition}}" aria-hidden="true"></span>
{{~/inline}} 
...
{{/inline}}`});var R1,O1=i(()=>{R1=`{{#ifCond logo "===" "coa-landscape"}}
    {{>logoCOALandscape}}
...
</svg>`});var F1,G1=i(()=>{F1=`{{!prettier-ignore}}
...
</svg>`});var B1,Q1=i(()=>{B1=`{{> header header}}
{{> navbar navbar}}
{{> globalAlert globalAlert}}
<main>
  {{#> breadcrumbsWrapper}}
...
{{> footer footer}}`});var W1,j1=i(()=>{W1=`<!-- DCTERMS https://www.dublincore.org/specifications/dublin-core/dcmi-terms/-->
{{#if dcTerms}}
...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`});var $1,U1=i(()=>{$1=`<!-- Example button to trigger the modal -->
...
</div>`});var X1,z1=i(()=>{X1=`<!-- QGDS Partial: Primary navigation -->
...
<nav id="main-nav" class="navbar navbar-expand-lg{{#if metadata.alternativeColor}} dark{{/if}}{{#if metadata.verticalOrientation}} vertical{{/if}}" aria-label="Website navigation" role="navigation">
    <div id="navbarNav" class="container">
        ...
        <div id="overlay"></div>
</nav>`});var e5,K1=i(()=>{e5=`<nav aria-label="{{ arialabel }}">
...
</nav>`});var a5,i5=i(()=>{a5=`<section class="qld-promo-panel {{#ifCond type '==' 'indent-text'}}indent{{/ifCond}} {{#ifCond type '==' 'indent-img'}}indent{{/ifCond}} {{type}}">
...
</section>`});var C5,t5=i(()=>{C5=`<!-- QGDS Component: Loading Quick exit -->
...
<div class="qld-search-input {{customClass}}">
    ...
    {{/ifCond}}    
</div>`});var o5,n5=i(()=>{o5=`<!-- QGDS Component: Select -->
...
`});var d5,r5=i(()=>{d5=`<nav class="qld-side-navigation" aria-label="Side Navigation">
  <button
...
</nav>`});var f5,c5=i(()=>{f5=`<!-- Side Nav -->
<div class="col-12 col-lg-3 pe-lg-0 order-last order-lg-first mt-5 mt-lg-0">
  {{> @partial-block }}
</div>
`});var u5,p5=i(()=>{u5=`<nav class="qld-skip-links" aria-label="skip to content links">
  {{#each skipLinks}}
    <a class="qld-skip-links__item" href="#{{targetId}}">{{label}}</a>
  {{/each}}
</nav>`});var g5,m5=i(()=>{g5=`<!-- QGDS Component: Loading Spinner -->
...
`});var h5,v5=i(()=>{h5=`<!-- QGDS Component: Table -->
...
</section>`});var V5,H5=i(()=>{V5=`<!-- QGDS Component: Tag -->
...
`});var k5,M5=i(()=>{k5=`<!-- QGDS Component: Textarea -->
...
<textarea id="{{id}}" class="form-control {{customClass}} {{#if isFilled}}is-filled{{/if}} {{#if isValid}}is-valid{{else}}{{#ifCond isValid "===" false}}is-invalid{{/ifCond}}{{/if}}"
    ...
    {{#if hint-text}}aria-describedby="{{id}}-hint"{{/if}}>{{value}}</textarea>`});var q5,y5=i(()=>{q5=`<!-- QGDS Component: Textbox -->
...
<input id={{id}} {{#if value}}value="{{value}}"{{/if}}  class="form-control {{customClass}} {{#if isFilled}}is-filled{{/if}} {{#if isValid}}is-valid{{else}}{{#ifCond isValid "===" false}}is-invalid{{/ifCond}}{{/if}}"
    ...
    isRequired}}required{{/if}} {{#if hint-text}}aria-describedby="{{id}}-hint"{{/if}} />`});var x5,Z5=i(()=>{x5="<!-- QGDS Partial: typography -->"});var T5,w5=i(()=>{T5=`<!-- QGDS Component: Video -->
...
`});function c(e){e.registerPartial("accordion",g),e.registerPartial("backToTop",h),e.registerPartial("banner",L),e.registerPartial("blockquote",V),e.registerPartial("breadcrumbs",k),e.registerPartial("breadcrumbsWrapper",q),e.registerPartial("button",x),e.registerPartial("callout",T),e.registerPartial("callToAction",A),e.registerPartial("card",P),e.registerPartial("containerLayout",R),e.registerPartial("contentFooter",E),e.registerPartial("contentFooterWrapper",N),e.registerPartial("contentPageWithForm",F),e.registerPartial("contentPageWithSideNavigation",B),e.registerPartial("contentWrapper",W),e.registerPartial("correctincorrect",Y),e.registerPartial("customLinks",$),e.registerPartial("dateinput",X),e.registerPartial("details",e1),e.registerPartial("directionLinks",a1),e.registerPartial("feedbackForm",C1),e.registerPartial("followLinks",l1),e.registerPartial("footer",o1),e.registerPartial("formcheck",d1),e.registerPartial("fullPage",f1),e.registerPartial("globalAlert",u1),e.registerPartial("head",g1),e.registerPartial("header",h1),e.registerPartial("headerBrand",L1),e.registerPartial("homePage",V1),e.registerPartial("icon",k1),e.registerPartial("image",q1),e.registerPartial("inpageAlert",x1),e.registerPartial("inpagenav",T1),e.registerPartial("link",A1),e.registerPartial("linkColumns",P1),e.registerPartial("logo",R1),e.registerPartial("logoCOADeliveringForQLD",E1),e.registerPartial("logoCOALandscape",N1),e.registerPartial("logoCOALandscape2Lines",F1),e.registerPartial("mainContainerWrapper",B1),e.registerPartial("metaDcTerms",W1),e.registerPartial("metaOpenGraph",Y1),e.registerPartial("modal",$1),e.registerPartial("navbar",X1),e.registerPartial("pagination",e5),e.registerPartial("promotionalPanel",a5),e.registerPartial("quickexit",C5),e.registerPartial("searchInput",l5),e.registerPartial("select",o5),e.registerPartial("sidenav",d5),e.registerPartial("sidenavWrapper",f5),e.registerPartial("skipLinks",u5),e.registerPartial("spinner",g5),e.registerPartial("table",h5),e.registerPartial("tabs",L5),e.registerPartial("tag",V5),e.registerPartial("textarea",k5),e.registerPartial("textbox",q5),e.registerPartial("typography",x5),e.registerPartial("video",T5)}var S5=i(()=>{"use strict";m();v();b();H();M();y();Z();w();S();D();O();I();_();G();Q();j();J();U();z();K();i1();t1();s1();n1();r1();c1();p1();m1();v1();b1();H1();M1();y1();Z1();w1();S1();D1();O1();I1();_1();G1();Q1();j1();J1();U1();z1();K1();i5();t5();s5();n5();r5();c5();p5();m5();v5();b5();H5();M5();y5();Z5();w5();typeof Handlebars<"u"&&c(Handlebars)});function f(e){typeof e>"u"&&console.error("Handlebars.init requires HandleBars"),typeof e<"u"?(A5?console.log("HandleBars Helpers And Partials already loaded, loading again"):A5=!0,d(e),c(e)):console.log("Handlebars not found, init failed")}var A5,D5=i(()=>{"use strict";u();S5();A5=!1;typeof Handlebars<"u"&&f(Handlebars)});var B2=O5((u7,P5)=>{D5();P5.exports={init:f}});export default B2();
