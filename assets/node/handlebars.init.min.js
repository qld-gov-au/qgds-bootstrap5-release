var i=(e,t,a)=>()=>{if(a)throw a[0];try{return e&&(t=e(e=0)),t}catch(C){throw a=[C],C}};var O5=(e,t)=>()=>{try{return t||e((t={exports:{}}).exports,t),t.exports}catch(a){throw t=0,a}};function p(e,t,a){switch(t){case"==":return e==a;case"===":return e===a;case"!=":return e!=a;case"!==":return e!==a;case"<":return e<a;case"<=":return e<=a;case">":return e>a;case">=":return e>=a;case"&&":return e&&a;case"||":return e||a;case"in":return typeof e=="string"&&typeof a=="string"?a.split(",").map(C=>C.trim()).includes(e):!1;case"contains":return typeof e=="string"&&typeof a=="string"?e.toLowerCase().indexOf(a.toLowerCase())>=0:!1;default:return!1}}function d(e){e.registerHelper("contains",function(t,a,C){return t=e.escapeExpression(t),a=e.escapeExpression(a),a.indexOf(t)>-1?C.fn(this):C.inverse(this)}),e.registerHelper("ifCond",function(t,a,C,s){return p(t,a,C)?s.fn(this):s.inverse(this)}),e.registerHelper("cond",(t,a,C)=>p(t,a,C)),e.registerHelper("isType",function(t,a,C){return t===a?C.fn(this):C.inverse(this)}),e.registerHelper("ifAny",function(...t){let a=t.pop();return t.some(C=>!!C)?a.fn(this):a.inverse(this)}),e.registerHelper("ifAll",function(...t){let a=t.pop();return t.every(C=>!!C)?a.fn(this):a.inverse(this)}),e.registerHelper("now",function(){return new Date().toISOString()}),e.registerHelper("formatDate",function(t,a,C){let s;if(t&&(s=new Date(t)),isNaN(s)&&a&&(s=new Date(a)),isNaN(s))return"Invalid Date";var l=["January","February","March","April","May","June","July","August","September","October","November","December"],o=s.getDate(),n=l[s.getMonth()],r=s.getFullYear();switch(C){case"YYYY":return`${r}`;case"MMMM YYYY":return`${n} ${r}`;default:return`${o} ${n} ${r}`}}),e.registerHelper("formatDateOrToday",function(t,a){let C=t||new Date().toISOString();return e.helpers.formatDate(t,C,a)}),e.registerHelper("formatDuration",function(t,a){if(!t)return"";if(typeof t=="string"&&a!=="long")return t;let C="",s=[],l,o,n;if(typeof t=="string"){let r=t.split(":");n=r[0],r.length==2?[o="",n=""]=r:r.length==3&&([l="",o="",n=""]=r)}else[l="",o="",n=""]=t;return a==="long"?(l>0&&s.push(`${l} hour${l>1?"s":""}`),o>0&&s.push(`${o} minute${o>1?"s":""}`),n>0&&s.push(`${n} second${n>1?"s":""}`),C=s.join(" ")):(l>0&&s.push(l.toString().padStart(2,0)),s.push(o.toString().padStart(2,0)),s.push(n.toString().padStart(2,0)),C=s.join(":")),C}),e.registerHelper("isdefined",function(t,a){return t!==void 0&&t!==""?t:a}),e.registerHelper("getClassNames",function(t,a){let C=t.split(",").map(l=>l.trim()),s=[];for(let l=0;l<C.length;l++){let o=C[l];if(a){for(let n=0;n<a.length;n++)if(a[n][o]===!0){s.push(o);break}}}return s.length>0?s.join(" "):""}),e.registerHelper("join",function(t,a){return(!a||typeof a!="string")&&(a=" "),Array.isArray(t)?t.join(a):t}),e.registerHelper("toCamelCase",function(t){return typeof t!="string"?t:t.toLowerCase().replace(/(?:^\w|[A-Z]|\b\w|\s+)/g,(a,C)=>C===0?a.toLowerCase():a.toUpperCase()).replace(/\s+/g,"")})}var u=i(()=>{"use strict";typeof Handlebars<"u"&&d(Handlebars)});var g,m=i(()=>{g=`<!-- QGDS Component: Accordion -->
