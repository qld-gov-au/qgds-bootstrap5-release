var i=(e,a)=>()=>(e&&(a=e(e=0)),a);var Q5=(e,a)=>()=>(a||e((a={exports:{}}).exports,a),a.exports);function f(e,a,t){switch(a){case"==":return e==t;case"===":return e===t;case"!=":return e!=t;case"!==":return e!==t;case"<":return e<t;case"<=":return e<=t;case">":return e>t;case">=":return e>=t;case"&&":return e&&t;case"||":return e||t;case"in":return typeof e=="string"&&typeof t=="string"?t.split(",").map(C=>C.trim()).includes(e):!1;case"contains":return typeof e=="string"&&typeof t=="string"?e.toLowerCase().indexOf(t.toLowerCase())>=0:!1;default:return!1}}function d(e){e.registerHelper("contains",function(a,t,C){return a=e.escapeExpression(a),t=e.escapeExpression(t),t.indexOf(a)>-1?C.fn(this):C.inverse(this)}),e.registerHelper("ifCond",function(a,t,C,s){return f(a,t,C)?s.fn(this):s.inverse(this)}),e.registerHelper("cond",(a,t,C)=>f(a,t,C)),e.registerHelper("isType",function(a,t,C){return a===t?C.fn(this):C.inverse(this)}),e.registerHelper("ifAny",function(...a){let t=a.pop();return a.some(C=>!!C)?t.fn(this):t.inverse(this)}),e.registerHelper("ifAll",function(...a){let t=a.pop();return a.every(C=>!!C)?t.fn(this):t.inverse(this)}),e.registerHelper("now",function(){return new Date().toISOString()}),e.registerHelper("formatDate",function(a,t,C){let s;if(a&&(s=new Date(a)),isNaN(s)&&t&&(s=new Date(t)),isNaN(s))return"Invalid Date";var l=["January","February","March","April","May","June","July","August","September","October","November","December"],o=s.getDate(),n=l[s.getMonth()],r=s.getFullYear();switch(C){case"YYYY":return`${r}`;case"MMMM YYYY":return`${n} ${r}`;default:return`${o} ${n} ${r}`}}),e.registerHelper("formatDateOrToday",function(a,t){let C=a||new Date().toISOString();return e.helpers.formatDate(a,C,t)}),e.registerHelper("formatDuration",function(a,t){if(!a)return"";if(typeof a=="string"&&t!=="long")return a;let C="",s=[],l,o,n;if(typeof a=="string"){let r=a.split(":");n=r[0],r.length==2?[o="",n=""]=r:r.length==3&&([l="",o="",n=""]=r)}else[l="",o="",n=""]=a;return t==="long"?(l>0&&s.push(`${l} hour${l>1?"s":""}`),o>0&&s.push(`${o} minute${o>1?"s":""}`),n>0&&s.push(`${n} second${n>1?"s":""}`),C=s.join(" ")):(l>0&&s.push(l.toString().padStart(2,0)),s.push(o.toString().padStart(2,0)),s.push(n.toString().padStart(2,0)),C=s.join(":")),C}),e.registerHelper("isdefined",function(a,t){return a!==void 0&&a!==""?a:t}),e.registerHelper("getClassNames",function(a,t){let C=a.split(",").map(l=>l.trim()),s=[];for(let l=0;l<C.length;l++){let o=C[l];if(t){for(let n=0;n<t.length;n++)if(t[n][o]===!0){s.push(o);break}}}return s.length>0?s.join(" "):""}),e.registerHelper("join",function(a,t){return(!t||typeof t!="string")&&(t=" "),Array.isArray(a)?a.join(t):a}),e.registerHelper("toCamelCase",function(a){return typeof a!="string"?a:a.toLowerCase().replace(/(?:^\w|[A-Z]|\b\w|\s+)/g,(t,C)=>C===0?t.toLowerCase():t.toUpperCase()).replace(/\s+/g,"")})}var u=i(()=>{"use strict";typeof Handlebars<"u"&&d(Handlebars)});var g,m=i(()=>{g=`<!-- QGDS Component: Accordion -->
...
`});var h,v=i(()=>{h=`{{#unless hide_back_to_top}}
...
{{/unless}}`});var L,b=i(()=>{L=`<!-- QGDS Banner Component -->
  ...
  </div>`});var V,H=i(()=>{V=`<!-- QGDS Component: Blockquote -->
...
</figure>`});var k,M=i(()=>{k=`<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    {{#each breadcrumbs}}
...
</div>`});var Z,x=i(()=>{Z=`{{!-- Button icon partial --}}
{{#*inline "buttonIcon"~}}
...
{{/unless}}`});var S,w=i(()=>{S=`<!-- QGDS Component: Callout -->
...
`});var O,T=i(()=>{O=`<a class="qld-cta-link {{getClassNames "small, view-all" class}}"
    {{#if id}}id="{{id}}"{{/if}}
    href="{{href}}"
    target="{{target}}"
...
</a>`});var R,A=i(()=>{R=`<!-- QGDS Partial: card -->
...
<script type="text/javascript" async src="https://beta-static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/js/qld.bootstrap.min.js"></script>`});var I,E=i(()=>{I=`{{!-- DEV CDN --}}
...
<script type="text/javascript" async src="https://dev-static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/js/qld.bootstrap.min.js"></script>`});var N,_=i(()=>{N=`{{!-- PROD CDN --}}
...
<script type="text/javascript" async src="https://staging-static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/js/qld.bootstrap.min.js"></script>`});var J,j=i(()=>{J=`{{!-- TEST CDN --}}
...
<script type="text/javascript" async src="https://test-static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/js/qld.bootstrap.min.js"></script>`});var B,Q=i(()=>{B=`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
</html>`});var Y,W=i(()=>{Y=`  <div class="row {{classes}}">
    {{#if lastUpdated}}
    <div class="col-auto">
...
`});var $,U=i(()=>{$=`<div class="container qld-content-footer">
  <div class="row">
    {{> @partial-block }}
  </div>
</div>`});var X,z=i(()=>{X=`<!DOCTYPE html>
<html lang="en">
...
</html>`});var e1,K=i(()=>{e1=`<!DOCTYPE html>
<html lang="en">
...
</html>`});var a1,i1=i(()=>{a1=`<!-- Content Wrapper -->
<div class="col-12 col-lg-8 ps-lg-64 qld-content-body" id="content">
  {{#if title}}<h1>{{title}}</h1>{{/if}}
  {{> @partial-block }}
</div>
`});var C1,t1=i(()=>{C1=""});var l1,s1=i(()=>{l1=`{{#if customLinks }}
...
{{/if}}`});var o1,n1=i(()=>{o1=`<!-- QGDS Component: Date input -->
...
`});var d1,r1=i(()=>{d1=`<!-- QGDS Component: Details -->
...
`});var p1,c1=i(()=>{p1=`{{! valid class values are: up, down, left, right}}
<a class="qld-dir-link {{class}}" 
  ...
  <span class="qld-icon qld-icon-md qld-icon-arrow-{{class}}" aria-hidden="true"></span>
</a>`});var u1,f1=i(()=>{u1=`<div class="col-12 col-md-6 col-lg-12">
    ...
    </div>`});var g1,m1=i(()=>{g1=`{{#if followLinks }}
...
{{/if}}`});var h1,v1=i(()=>{h1=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
...
</html>`});var k1,M1=i(()=>{k1=`<!-- QGDS Component: Global Alert -->
...
`});var Z1,x1=i(()=>{Z1=`<header class="qld-header " role="banner">
...
</html>`});var R1,A1=i(()=>{R1=`<svg class="qld-icon-{{size}}"{{#if ariaLabel}} aria-label="{{ariaLabel}}"{{/if}}{{#if ariaHidden}} aria-hidden="{{ariaHidden}}"{{/if}}>
  <use href="./assets/img/icons-sprite.svg#qgds-icon-{{iconId}}"></use>
</svg>`});var P1,D1=i(()=>{P1=`{{! Image template }}
{{#*inline "imageTag"}}
...
{{#if src}}
  ...
  {{/ifAny}}
{{/if}}
`});var I1,E1=i(()=>{I1=`<div class="alert {{variantClass}} {{customClass}}" role="alert"
    {{#if ariaLabel}}
...
>
    ...
    {{/if}}
    {{{ content }}}
</div>`});var N1,_1=i(()=>{N1=`<!-- QGDS Partial: inpage-nav -->
...
</nav>`});var F1,G1=i(()=>{F1=`{{!-- Link icon partial --}}
{{#*inline "linkIcon"~}}
<span class="qld-icon qld-icon-md {{iconClass}} {{iconPosition}}" aria-hidden="true"></span>
{{~/inline}} 
...
{{/inline}}`});var B1,Q1=i(()=>{B1=`{{#ifCond logo "===" "coa-landscape"}}
    {{>logoCOALandscape}}
...
</svg>`});var $1,U1=i(()=>{$1=`{{!prettier-ignore}}
...
</svg>`});var X1,z1=i(()=>{X1=`{{!prettier-ignore}}
...
</svg>`});var e5,K1=i(()=>{e5=`{{> header header}}
{{> navbar navbar}}
{{> globalAlert globalAlert}}
<main>
  {{#> breadcrumbsWrapper}}
...
{{> footer footer}}`});var a5,i5=i(()=>{a5=`<!-- DCTERMS https://www.dublincore.org/specifications/dublin-core/dcmi-terms/-->
{{#if dcTerms}}
...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`});var l5,s5=i(()=>{l5=`<!-- Example button to trigger the modal -->
...
</div>`});var o5,n5=i(()=>{o5=`<!-- QGDS Partial: Primary navigation -->
...
<nav id="main-nav" class="navbar navbar-expand-lg{{#if metadata.alternativeColor}} dark{{/if}}{{#if metadata.verticalOrientation}} vertical{{/if}}" aria-label="Website navigation" role="navigation">
    <div id="navbarNav" class="container">
        ...
        <div id="overlay"></div>
</nav>`});var d5,r5=i(()=>{d5=`<nav aria-label="{{ arialabel }}">
...
</nav>`});var p5,c5=i(()=>{p5=`<section class="qld-promo-panel {{#ifCond type '==' 'indent-text'}}indent{{/ifCond}} {{#ifCond type '==' 'indent-img'}}indent{{/ifCond}} {{type}}">
...
</section>`});var u5,f5=i(()=>{u5=`<!-- QGDS Component: Loading Quick exit -->
...
<div class="qld-search-input {{customClass}}">
    ...
    {{/ifCond}}    
</div>`});var h5,v5=i(()=>{h5=`<!-- QGDS Component: Select -->
...
`});var L5,b5=i(()=>{L5=`<nav class="qld-side-navigation" aria-label="Side Navigation">
  <button
...
</nav>`});var V5,H5=i(()=>{V5=`<!-- Side Nav -->
<div class="col-12 col-lg-3 pe-lg-0 order-last order-lg-first mt-5 mt-lg-0">
  {{> @partial-block }}
</div>
`});var k5,M5=i(()=>{k5=`<nav class="qld-skip-links" aria-label="skip to content links">
  {{#each skipLinks}}
    <a class="qld-skip-links__item" href="#{{targetId}}">{{label}}</a>
  {{/each}}
</nav>`});var y5,q5=i(()=>{y5=`<!-- QGDS Component: Loading Spinner -->
...
`});var Z5,x5=i(()=>{Z5=`<!-- QGDS Component: Table -->
...
</section>`});var O5,T5=i(()=>{O5=`<!-- QGDS Component: Tag -->
...
`});var R5,A5=i(()=>{R5=`<!-- QGDS Component: Textarea -->
...
<textarea id="{{id}}" class="form-control {{customClass}} {{#if isFilled}}is-filled{{/if}} {{#if isValid}}is-valid{{else}}{{#ifCond isValid "===" false}}is-invalid{{/ifCond}}{{/if}}"
    ...
    {{#if hint-text}}aria-describedby="{{id}}-hint"{{/if}}>{{value}}</textarea>`});var P5,D5=i(()=>{P5=`<!-- QGDS Component: Textbox -->
...
<input id={{id}} {{#if value}}value="{{value}}"{{/if}}  class="form-control {{customClass}} {{#if isFilled}}is-filled{{/if}} {{#if isValid}}is-valid{{else}}{{#ifCond isValid "===" false}}is-invalid{{/ifCond}}{{/if}}"
    ...
    isRequired}}required{{/if}} {{#if hint-text}}aria-describedby="{{id}}-hint"{{/if}} />`});var I5,E5=i(()=>{I5="<!-- QGDS Partial: typography -->"});var N5,_5=i(()=>{N5=`<!-- QGDS Component: Video -->
...
`});function c(e){e.registerPartial("accordion",g),e.registerPartial("backToTop",h),e.registerPartial("banner",L),e.registerPartial("blockquote",V),e.registerPartial("breadcrumbs",k),e.registerPartial("breadcrumbsWrapper",y),e.registerPartial("button",Z),e.registerPartial("callout",S),e.registerPartial("callToAction",O),e.registerPartial("card",R),e.registerPartial("cdn-beta",P),e.registerPartial("cdn-dev",I),e.registerPartial("cdn-prod",N),e.registerPartial("cdn-staging",F),e.registerPartial("cdn-test",J),e.registerPartial("containerLayout",B),e.registerPartial("contentFooter",Y),e.registerPartial("contentFooterWrapper",$),e.registerPartial("contentPageWithForm",X),e.registerPartial("contentPageWithSideNavigation",e1),e.registerPartial("contentWrapper",a1),e.registerPartial("correctincorrect",C1),e.registerPartial("customLinks",l1),e.registerPartial("dateinput",o1),e.registerPartial("details",d1),e.registerPartial("directionLinks",p1),e.registerPartial("feedbackForm",u1),e.registerPartial("followLinks",g1),e.registerPartial("footer",h1),e.registerPartial("formcheck",L1),e.registerPartial("fullPage",V1),e.registerPartial("globalAlert",k1),e.registerPartial("head",y1),e.registerPartial("header",Z1),e.registerPartial("headerBrand",S1),e.registerPartial("homePage",O1),e.registerPartial("icon",R1),e.registerPartial("image",P1),e.registerPartial("inpageAlert",I1),e.registerPartial("inpagenav",N1),e.registerPartial("link",F1),e.registerPartial("linkColumns",J1),e.registerPartial("logo",B1),e.registerPartial("logoCOADeliveringForQLD",Y1),e.registerPartial("logoCOALandscape",$1),e.registerPartial("logoCOALandscape2Lines",X1),e.registerPartial("mainContainerWrapper",e5),e.registerPartial("metaDcTerms",a5),e.registerPartial("metaOpenGraph",C5),e.registerPartial("modal",l5),e.registerPartial("navbar",o5),e.registerPartial("pagination",d5),e.registerPartial("promotionalPanel",p5),e.registerPartial("quickexit",u5),e.registerPartial("searchInput",g5),e.registerPartial("select",h5),e.registerPartial("sidenav",L5),e.registerPartial("sidenavWrapper",V5),e.registerPartial("skipLinks",k5),e.registerPartial("spinner",y5),e.registerPartial("table",Z5),e.registerPartial("tabs",S5),e.registerPartial("tag",O5),e.registerPartial("textarea",R5),e.registerPartial("textbox",P5),e.registerPartial("typography",I5),e.registerPartial("video",N5)}var G5=i(()=>{"use strict";m();v();b();H();M();q();x();w();T();A();D();E();_();G();j();Q();W();U();z();K();i1();t1();s1();n1();r1();c1();f1();m1();v1();b1();H1();M1();q1();x1();w1();T1();A1();D1();E1();_1();G1();j1();Q1();W1();U1();z1();K1();i5();t5();s5();n5();r5();c5();f5();m5();v5();b5();H5();M5();q5();x5();w5();T5();A5();D5();E5();_5();typeof Handlebars<"u"&&c(Handlebars)});function p(e){typeof e>"u"&&console.error("Handlebars.init requires HandleBars"),typeof e<"u"?(F5?console.log("HandleBars Helpers And Partials already loaded, loading again"):F5=!0,d(e),c(e)):console.log("Handlebars not found, init failed")}var F5,j5=i(()=>{"use strict";u();G5();F5=!1;typeof Handlebars<"u"&&p(Handlebars)});var s3=Q5((_7,J5)=>{j5();J5.exports={init:p}});export default s3();
