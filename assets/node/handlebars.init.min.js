...
</div>`});var x,Z=i(()=>{x=`{{!-- Button icon partial --}}
{{#*inline "buttonIcon"~}}
...
`});var A,T=i(()=>{A=`<a class="qld-cta-link {{getClassNames "small, view-all" class}}"
    {{#if id}}id="{{id}}"{{/if}}
    href="{{href}}"
    target="{{target}}"
...
</a>`});var P,D=i(()=>{P=`<!-- QGDS Partial: card -->
...
</html>`});var E,I=i(()=>{E=`  <div class="row {{classes}}">
    {{#if lastUpdated}}
    <div class="col-auto">
...
`});var N,_=i(()=>{N=`<div class="container qld-content-footer">
  <div class="row">
    {{> @partial-block }}
  </div>
</div>`});var G,F=i(()=>{G=`<!DOCTYPE html>
<html lang="en">
...
</html>`});var W,j=i(()=>{W=`<!-- Content Wrapper -->
<div class="col-12 col-lg-8 ps-lg-64 qld-content-body" id="content">
  {{#if title}}<h1>{{title}}</h1>{{/if}}
  {{> @partial-block }}
</div>
`});var Y,J=i(()=>{Y=""});var $,U=i(()=>{$=`{{#if customLinks }}
...
{{/if}}`});var X,z=i(()=>{X=`<!-- QGDS Component: Date input -->
...
`});var e1,K=i(()=>{e1=`{{! valid class values are: up, down, left, right}}
<a class="qld-dir-link {{class}}" 
  ...
  <span class="qld-icon qld-icon-md qld-icon-arrow-{{class}}" aria-hidden="true"></span>
</a>`});var a1,i1=i(()=>{a1=`<div class="col-12 col-md-6 col-lg-12">
    ...
    </div>`});var C1,t1=i(()=>{C1=`{{#if followLinks }}
...
{{/if}}`});var l1,s1=i(()=>{l1=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
...
</html>`});var f1,c1=i(()=>{f1=`<!-- QGDS Component: Global Alert -->
...
<!-- VERSION_DETAILS={"project_id":"@qld-gov-au/qgds-bootstrap5","version":"2.1.11","branch":"develop","tag":"","commit":"81f696bd600ddfbb36d893f304eb44342c05ba5a","majorVersion":"v2"} -->
...
`});var g1,m1=i(()=>{g1=`<header class="qld-header " role="banner">
...
</html>`});var V1,H1=i(()=>{V1=`<svg class="qld-icon-{{size}}"{{#if ariaLabel}} aria-label="{{ariaLabel}}"{{/if}}{{#if ariaHidden}} aria-hidden="{{ariaHidden}}"{{/if}}>
  <use href="./assets/img/icons-sprite.svg#qgds-icon-{{iconId}}"></use>
</svg>`});var k1,M1=i(()=>{k1=`{{! Image template }}
{{#*inline "imageTag"}}
...
{{#if src}}
  ...
  {{/ifAny}}
{{/if}}
`});var q1,y1=i(()=>{q1=`<div class="alert {{variantClass}} {{customClass}}" role="alert"
    {{#if ariaLabel}}
...
>
    ...
    {{/if}}
    {{{ content }}}
</div>`});var x1,Z1=i(()=>{x1=`<!-- QGDS Partial: inpage-nav -->
...
</nav>`});var S1,w1=i(()=>{S1=`{{!-- Link icon partial --}}
{{#*inline "linkIcon"~}}
<span class="qld-icon qld-icon-md {{iconClass}} {{iconPosition}}" aria-hidden="true"></span>
{{~/inline}} 
...
{{/inline}}`});var P1,D1=i(()=>{P1=`{{#ifCond logo "===" "coa-landscape"}}
    {{>logoCOALandscape}}
...
</svg>`});var E1,I1=i(()=>{E1=`{{!prettier-ignore}}
...
</svg>`});var N1,_1=i(()=>{N1=`{{!prettier-ignore}}
...
</svg>`});var G1,F1=i(()=>{G1=`{{> header header}}
{{> navbar navbar}}
{{> globalAlert globalAlert}}
<main>
  {{#> breadcrumbsWrapper}}
...
{{> footer footer}}`});var B1,Q1=i(()=>{B1=`<!-- DCTERMS https://www.dublincore.org/specifications/dublin-core/dcmi-terms/-->
{{#if dcTerms}}
...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`});var Y1,J1=i(()=>{Y1=`<!-- Example button to trigger the modal -->
...
</div>`});var $1,U1=i(()=>{$1=`<!-- QGDS Partial: Primary navigation -->
...
<nav id="main-nav" class="navbar navbar-expand-lg{{#if metadata.alternativeColor}} dark{{/if}}{{#if metadata.verticalOrientation}} vertical{{/if}}" aria-label="Website navigation" role="navigation">
    <div id="navbarNav" class="container">
        ...
        <div id="overlay"></div>
</nav>`});var X1,z1=i(()=>{X1=`<nav aria-label="{{ arialabel }}">
...
</nav>`});var e5,K1=i(()=>{e5=`<section class="qld-promo-panel {{#ifCond type '==' 'indent-text'}}indent{{/ifCond}} {{#ifCond type '==' 'indent-img'}}indent{{/ifCond}} {{type}}">
...
</section>`});var a5,i5=i(()=>{a5=`<!-- QGDS Component: Loading Quick exit -->
...
<div class="qld-search-input {{customClass}}">
    ...
    {{/ifCond}}    
</div>`});var l5,s5=i(()=>{l5=`<!-- QGDS Component: Select -->
...
`});var o5,n5=i(()=>{o5=`<nav class="qld-side-navigation" aria-label="Side Navigation">
  <button
...
</nav>`});var d5,r5=i(()=>{d5=`<!-- Side Nav -->
<div class="col-12 col-lg-3 pe-lg-0 order-last order-lg-first mt-5 mt-lg-0">
  {{> @partial-block }}
</div>
`});var f5,c5=i(()=>{f5=`<nav class="qld-skip-links" aria-label="skip to content links">
  {{#each skipLinks}}
    <a class="qld-skip-links__item" href="#{{targetId}}">{{label}}</a>
  {{/each}}
</nav>`});var u5,p5=i(()=>{u5=`<!-- QGDS Component: Loading Spinner -->
...
`});var g5,m5=i(()=>{g5=`<!-- QGDS Component: Table -->
...
</section>`});var L5,b5=i(()=>{L5=`<!-- QGDS Component: Tag -->
...
`});var V5,H5=i(()=>{V5=`<!-- QGDS Component: Textarea -->
...
<textarea id="{{id}}" class="form-control {{customClass}} {{#if isFilled}}is-filled{{/if}} {{#if isValid}}is-valid{{else}}{{#ifCond isValid "===" false}}is-invalid{{/ifCond}}{{/if}}"
    ...
    {{#if hint-text}}aria-describedby="{{id}}-hint"{{/if}}>{{value}}</textarea>`});var k5,M5=i(()=>{k5=`<!-- QGDS Component: Textbox -->
...
<input id={{id}} {{#if value}}value="{{value}}"{{/if}}  class="form-control {{customClass}} {{#if isFilled}}is-filled{{/if}} {{#if isValid}}is-valid{{else}}{{#ifCond isValid "===" false}}is-invalid{{/ifCond}}{{/if}}"
    ...
    isRequired}}required{{/if}} {{#if hint-text}}aria-describedby="{{id}}-hint"{{/if}} />`});var q5,y5=i(()=>{q5="<!-- QGDS Partial: typography -->"});var x5,Z5=i(()=>{x5=`<!-- QGDS Component: Video -->
...
`});function c(e){e.registerPartial("accordion",g),e.registerPartial("backToTop",h),e.registerPartial("banner",L),e.registerPartial("blockquote",V),e.registerPartial("breadcrumbs",k),e.registerPartial("breadcrumbsWrapper",q),e.registerPartial("button",x),e.registerPartial("callout",S),e.registerPartial("callToAction",A),e.registerPartial("card",P),e.registerPartial("containerLayout",R),e.registerPartial("contentFooter",E),e.registerPartial("contentFooterWrapper",N),e.registerPartial("contentPageWithForm",G),e.registerPartial("contentPageWithSideNavigation",B),e.registerPartial("contentWrapper",W),e.registerPartial("correctincorrect",Y),e.registerPartial("customLinks",$),e.registerPartial("dateinput",X),e.registerPartial("directionLinks",e1),e.registerPartial("feedbackForm",a1),e.registerPartial("followLinks",C1),e.registerPartial("footer",l1),e.registerPartial("formcheck",o1),e.registerPartial("fullPage",d1),e.registerPartial("globalAlert",f1),e.registerPartial("head",u1),e.registerPartial("header",g1),e.registerPartial("headerBrand",h1),e.registerPartial("homePage",L1),e.registerPartial("icon",V1),e.registerPartial("image",k1),e.registerPartial("inpageAlert",q1),e.registerPartial("inpagenav",x1),e.registerPartial("link",S1),e.registerPartial("linkColumns",A1),e.registerPartial("logo",P1),e.registerPartial("logoCOADeliveringForQLD",R1),e.registerPartial("logoCOALandscape",E1),e.registerPartial("logoCOALandscape2Lines",N1),e.registerPartial("mainContainerWrapper",G1),e.registerPartial("metaDcTerms",B1),e.registerPartial("metaOpenGraph",W1),e.registerPartial("modal",Y1),e.registerPartial("navbar",$1),e.registerPartial("pagination",X1),e.registerPartial("promotionalPanel",e5),e.registerPartial("quickexit",a5),e.registerPartial("searchInput",C5),e.registerPartial("select",l5),e.registerPartial("sidenav",o5),e.registerPartial("sidenavWrapper",d5),e.registerPartial("skipLinks",f5),e.registerPartial("spinner",u5),e.registerPartial("table",g5),e.registerPartial("tabs",h5),e.registerPartial("tag",L5),e.registerPartial("textarea",V5),e.registerPartial("textbox",k5),e.registerPartial("typography",q5),e.registerPartial("video",x5)}var w5=i(()=>{"use strict";m();v();b();H();M();y();Z();w();T();D();O();I();_();F();Q();j();J();U();z();K();i1();t1();s1();n1();r1();c1();p1();m1();v1();b1();H1();M1();y1();Z1();w1();T1();D1();O1();I1();_1();F1();Q1();j1();J1();U1();z1();K1();i5();t5();s5();n5();r5();c5();p5();m5();v5();b5();H5();M5();y5();Z5();typeof Handlebars<"u"&&c(Handlebars)});function f(e){typeof e>"u"&&console.error("Handlebars.init requires HandleBars"),typeof e<"u"?(S5?console.log("HandleBars Helpers And Partials already loaded, loading again"):S5=!0,d(e),c(e)):console.log("Handlebars not found, init failed")}var S5,T5=i(()=>{"use strict";u();w5();S5=!1;typeof Handlebars<"u"&&f(Handlebars)});var F2=D5((r7,A5)=>{T5();A5.exports={init:f}});export default F2();
