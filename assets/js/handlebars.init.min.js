"use strict";(()=>{function n(C){C.registerHelper("contains",function(e,i,a){return e=C.escapeExpression(e),i=C.escapeExpression(i),i.indexOf(e)>-1?a.fn(this):a.inverse(this)}),C.registerHelper("ifCond",function(e,i,a,t){switch(i){case"==":return e==a?t.fn(this):t.inverse(this);case"===":return e===a?t.fn(this):t.inverse(this);case"!=":return e!=a?t.fn(this):t.inverse(this);case"!==":return e!==a?t.fn(this):t.inverse(this);case"<":return e<a?t.fn(this):t.inverse(this);case"<=":return e<=a?t.fn(this):t.inverse(this);case">":return e>a?t.fn(this):t.inverse(this);case">=":return e>=a?t.fn(this):t.inverse(this);case"&&":return e&&a?t.fn(this):t.inverse(this);case"||":return e||a?t.fn(this):t.inverse(this);case"contains":return typeof e=="string"&&typeof a=="string"?e.toLowerCase().indexOf(a.toLowerCase())>=0?t.fn(this):t.inverse(this):t.inverse(this);default:return t.inverse(this)}}),C.registerHelper("isType",function(e,i,a){return e===i?a.fn(this):a.inverse(this)}),C.registerHelper("ifAny",function(...e){let i=e.pop();return e.some(a=>!!a)?i.fn(this):i.inverse(this)}),C.registerHelper("now",function(){return new Date().toISOString()}),C.registerHelper("formatDate",function(e,i,a){let t;if(e&&(t=new Date(e)),isNaN(t)&&i&&(t=new Date(i)),isNaN(t))return"Invalid Date";var l=["January","February","March","April","May","June","July","August","September","October","November","December"],r=t.getDate(),o=l[t.getMonth()],s=t.getFullYear();switch(a){case"YYYY":return`${s}`;case"MMMM YYYY":return`${o} ${s}`;default:return`${r} ${o} ${s}`}}),C.registerHelper("formatDateOrToday",function(e,i){let a=e||new Date().toISOString();return C.helpers.formatDate(e,a,i)}),C.registerHelper("formatDuration",function(e,i){if(!e)return"";if(typeof e=="string"&&i!=="long")return e;let a="",t=[],l,r,o;if(typeof e=="string"){let s=e.split(":");o=s[0],s.length==2?[r="",o=""]=s:s.length==3&&([l="",r="",o=""]=s)}else[l="",r="",o=""]=e;return i==="long"?(l>0&&t.push(`${l} hour${l>1?"s":""}`),r>0&&t.push(`${r} minute${r>1?"s":""}`),o>0&&t.push(`${o} second${o>1?"s":""}`),a=t.join(" ")):(l>0&&t.push(l.toString().padStart(2,0)),t.push(r.toString().padStart(2,0)),t.push(o.toString().padStart(2,0)),a=t.join(":")),a}),C.registerHelper("isdefined",function(e,i){return e!==void 0?e:i}),C.registerHelper("isdefined",function(e,i){return e!==void 0&&e!==""?e:i}),C.registerHelper("getClassNames",function(e,i){let a=e.split(",").map(l=>l.trim()),t=[];for(let l=0;l<a.length;l++){let r=a[l];if(i){for(let o=0;o<i.length;o++)if(i[o][r]===!0){t.push(r);break}}}return t.length>0?t.join(" "):""}),C.registerHelper("join",function(e,i){return(!i||typeof i!="string")&&(i=" "),Array.isArray(e)?e.join(i):e}),C.registerHelper("toCamelCase",function(e){return typeof e!="string"?e:e.toLowerCase().replace(/(?:^\w|[A-Z]|\b\w|\s+)/g,(i,a)=>a===0?i.toLowerCase():i.toUpperCase()).replace(/\s+/g,"")})}typeof Handlebars!="undefined"&&n(Handlebars);var c=`<!-- QGDS Component: Accordion -->
...
</dl>`;var H=`<div class="container qld-content-footer">
  <div class="row">
    {{> @partial-block }}
  </div>
...
`;var D=`<header class="qld__header" role="banner">
...
<!-- HEADER END -->`;var O=`{{! Image template }}
{{#*inline "imageTag"}}
...
{{#if src}}
  ...
  {{else}}
    {{> imageTag}}
  {{/if}}
{{/if}}`;var E=`<div class="alert {{variantClass}} {{customClass}}" role="alert" 
...
</section>`;var a2=`<!-- QGDS Component: Tag -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",f),C.registerPartial("banner",p),C.registerPartial("blockquote",u),C.registerPartial("breadcrumbs",h),C.registerPartial("breadcrumbsWrapper",L),C.registerPartial("button",v),C.registerPartial("callToAction",m),C.registerPartial("callout",g),C.registerPartial("card",b),C.registerPartial("contentFooter",V),C.registerPartial("contentFooterWrapper",H),C.registerPartial("contentWrapper",M),C.registerPartial("correctincorrect",Z),C.registerPartial("dateinput",_),C.registerPartial("directionLinks",w),C.registerPartial("customLinks",k),C.registerPartial("feedbackForm",y),C.registerPartial("followLinks",q),C.registerPartial("footer",x),C.registerPartial("footerForgov",T),C.registerPartial("formcheck",S),C.registerPartial("fullPage",R),C.registerPartial("globalAlert",P),C.registerPartial("head",A),C.registerPartial("header",D),C.registerPartial("image",O),C.registerPartial("inpageAlert",E),C.registerPartial("inpagenav",I),C.registerPartial("linkColumns",F),C.registerPartial("mainContainerWrapper",N),C.registerPartial("metaDcTerms",G),C.registerPartial("metaOpenGraph",Q),C.registerPartial("modal",B),C.registerPartial("navbar",J),C.registerPartial("pageLayout",W),C.registerPartial("pagination",Y),C.registerPartial("promotionalPanel",j),C.registerPartial("quickexit",U),C.registerPartial("searchInput",$),C.registerPartial("select",z),C.registerPartial("sidenav",X),C.registerPartial("sidenavWrapper",K),C.registerPartial("skipLinks",C2),C.registerPartial("spinner",e2),C.registerPartial("table",t2),C.registerPartial("tabs",i2),C.registerPartial("tag",a2),C.registerPartial("textarea",l2),C.registerPartial("textbox",o2),C.registerPartial("typography",r2),C.registerPartial("video",s2)}typeof Handlebars!="undefined"&&d(Handlebars);var n2=!1;function d2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(n2?console.log("HandleBars Helpers And Partials already loaded, loading again"):n2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&d2(Handlebars);})();
