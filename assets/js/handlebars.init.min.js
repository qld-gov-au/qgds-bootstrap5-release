...
</dl>`;var g=`<div class="container qld-content-footer">
  <div class="row">
    {{> @partial-block }}
  </div>
...
`;var H="";var V=`<!-- QGDS Component: Date input -->
...
`;var x=`<header class="qld__header" role="banner">
    ...
    <div class="qld__header__pre-header">
        <div class="container-fluid">
            <a href="{{#if sitePreHeader.preHeaderBrand.url}}{{sitePreHeader.preHeaderBrand.url}}{{else}}https://www.qld.gov.au{{/if}}">
                <span class="qld__header__pre-header-url">{{#if sitePreHeader.preHeaderBrand.text}}{{sitePreHeader.preHeaderBrand.text}}{{else}}qld.gov.au{{/if}}</span>
                {{!why is this svg here}}<svg class="qld__header__pre-header-brand-image" viewBox="0 0 165 28" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="qld__header__cta-wrapper">
                        ...
                        <span {{#if dropdown_enabled}} class="dropdown dropdownCTA" {{/if}}>
                            <a {{#if dropdown_enabled}} id="dropdown{{id}}" role="button" data-bs-toggle="dropdown" aria-expanded="false" class="qld__header__cta-link" href="#" {{else}} href="{{url.value}}" class="qld__header__cta-link" {{/if}}>
                                ...
                                <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" class="qld__header__cta-link-icon">
                                        <use href="{{#if @root.icon-root}}{{@root.icon-root}}{{else}}assets/img/svg-icons.svg{{/if}}#{{#if @root.icons.chevron_down}}{{@root.icons.chevron_down}}{{else}}qld__icon__chevron-down{{/if}}"></use>
                                </svg>
                                {{/if}}
                            </a>
                            {{#if dropdown_enabled}}
                ...
                {{else}}
                    {{! Default pre header }}
                    <span class="dropdown dropdownCTA">
                        <a id="dropdownCTAone" role="button" data-bs-toggle="dropdown" aria-expanded="false" class="qld__header__cta-link" href="#">
                            <span class="qld__header__cta-link-text">For Queenslanders</span>
                                <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" class="qld__header__cta-link-icon">
                                        <use href="assets/img/svg-icons.svg#qld__icon__chevron-down"></use>
                                </svg>
                        </a>
                        <ul class="dropdown-menu dark" aria-labelledby="dropdownCTAone" role="list">
                            <li class="qld__header__cta-list">
                                <a href="#" target="_blank">
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="cta_arrow">
                                        <path d="M18.8592 12.6135L13.6659 17.6633C13.5721 17.7781 13.4156 17.8068 13.2905 17.8068C13.1654 17.8068 13.0402 17.7781 12.9464 17.692C12.7274 17.5199 12.7274 17.233 12.9151 17.0608L17.295 12.757H5.50056C5.21899 12.757 5 12.5562 5 12.3266C5 12.0971 5.21899 11.8389 5.50056 11.8389H17.295L12.9151 7.56375C12.7274 7.3916 12.7274 7.10468 12.9464 6.93253C13.1654 6.76038 13.4782 6.76038 13.6659 6.96122L18.8592 12.011C19.0469 12.1832 19.0469 12.4414 18.8592 12.6135Z" fill="#FFE500"></path>
                                    </svg>
                                </a>
                            </li>
                            <li class="qld__header__cta-list">
                            ...
                            <li class="qld__header__cta-list">
                                <a href="https://www.qld.gov.au/queenslanders" target="_blank" class="view-all border-bottom-0">
                                    View all
                                </a>
                            </li>
                        </ul>
                    ...
                    <span class="dropdown dropdownCTA">
                        <a id="dropdownCTAtwo" role="button" data-bs-toggle="dropdown" aria-expanded="false" class="qld__header__cta-link" href="#">
                            <span class="qld__header__cta-link-text">Business and Industry</span>
                                <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" class="qld__header__cta-link-icon">
                                        <use href="assets/img/svg-icons.svg#qld__icon__chevron-down"></use>
                                </svg>
                        </a>
                        <ul class="dropdown-menu dark" aria-labelledby="dropdownCTAtwo" role="list">
                            <li class="qld__header__cta-list">
                                <a href="#" target="_blank">
                                    Transport and motoring
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="cta_arrow">
            ...
            <div class="qld__header__main-nav-controls">
                ...
                <button aria-controls="qld-header-search"
                    ...
                    <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <use class="icon-search" href="{{#if @root.icon-root}}{{@root.icon-root}}{{else}}assets/img/svg-icons.svg{{/if}}#{{#if @root.icons.search-icon}}{{@root.icons.search-icon}}{{else}}qld__icon__search{{/if}}"
                            style="display: block;"></use>
                        <use class="icon-close" href="{{#if @root.icon-root}}{{@root.icon-root}}{{else}}assets/img/svg-icons.svg{{/if}}#{{#if @root.icons.close-icon}}{{@root.icons.close-icon}}{{else}}qld__icon__close{{/if}}"
                ...
                <button aria-controls="main-nav" class="qld__header__toggle-main-nav qld__main-nav__toggle--open"
                    ...
                    <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg"
                        class="qld__icon qld__icon--lg">
                        <use href="{{#if @root.icon-root}}{{@root.icon-root}}{{else}}assets/img/svg-icons.svg{{/if}}#{{#if @root.icons.menu-icon}}{{@root.icons.menu-icon}}{{else}}qld__icon__mobile-menu{{/if}}"></use>
                    </svg>
    ...
    <div
            class="qld__header__main {{#unless siteHeader.config.masterbrand_disabled}}qld__header__main--masterbrand--true{{/unless}}">
        <div class="container-fluid">
            {{#unless siteHeader.config.masterbrand_disabled}}
                <div class="qld__header__brand">
                    <a href="{{#if siteHeader.url.value}}{{siteHeader.url.value}}{{else}}https://www.qld.gov.au{{/if}}">
                        <div class="qld__header__brand-image">
                            {{#if siteHeader.logo.value}}<img src="{{siteHeader.logo.value}}" width="329.57" height="56"><title>Queensland Government</title></img>
                            {{else}}
            ...
            <div class="qld__header__brand">
                    <a href="{{#if siteHeader.url.value}}{{siteHeader.url.value}}{{else}}https://www.qld.gov.au{{/if}}">
                    <div class="qld__header__brand-image">
                        {{#if siteHeader.logo.value}}<img src="{{siteHeader.logo.value}}" width="170" height="56"><title>Queensland Government</title></img>{{/if}}
                    </div>
                    {{#if siteHeader.secondaryType.logo.value}}
                    <div class="qld__header__site-name">
                        <img class="qld__header__secondary-image" alt="{{siteHeader.secondaryType.siteTitle.value}}"
                    ...
                    {{/if}}
                    {{#ifAny siteHeader.secondaryType.siteTitle.value siteHeader.secondaryType.subline.value}}
                    <div class="qld__header__site-name">
                        {{#if siteHeader.secondaryType.siteTitle.value}}
            ...
            {{/if}}
            {{#unless siteSearch_disabled}}
            <div id="qld-header-search" class="qld__header__site-search qld__header__site-search--closed">
                <form class="site-search" role="search" action="{{#if siteSearchAsset.formAction.url}}{{siteSearchAsset.formAction.url}}{{else}}https://www.qld.gov.au/search{{/if}}">
                    {{{ searchInput }}}
                </form>
            </div>
            {{/unless}}
...
</nav>`;var A=`<!-- QGDS Component: Loading Quick exit -->
...
`;var I=`<div class="qld-side-navigation">
...
`;var G=`<!-- QGDS Component: Loading Spinner -->
...
`;function o(C){C.registerPartial("accordion",n),C.registerPartial("banner",d),C.registerPartial("blockquote",c),C.registerPartial("breadcrumbs",p),C.registerPartial("breadcrumbsWrapper",f),C.registerPartial("button",h),C.registerPartial("callout",u),C.registerPartial("card",L),C.registerPartial("contentFooter",v),C.registerPartial("contentFooterWrapper",g),C.registerPartial("contentWrapper",m),C.registerPartial("correctincorrect",H),C.registerPartial("dateinput",V),C.registerPartial("footer",M),C.registerPartial("footerForgov",_),C.registerPartial("formcheck",b),C.registerPartial("fullPage",Z),C.registerPartial("globalAlert",w),C.registerPartial("head",q),C.registerPartial("header",x),C.registerPartial("inpageAlert",y),C.registerPartial("inpagenav",k),C.registerPartial("mainContainerWrapper",T),C.registerPartial("metaDcTerms",S),C.registerPartial("metaOpenGraph",R),C.registerPartial("modal",D),C.registerPartial("navbar",O),C.registerPartial("pagination",E),C.registerPartial("quickexit",A),C.registerPartial("searchInput",P),C.registerPartial("select",F),C.registerPartial("sidenav",I),C.registerPartial("sidenavWrapper",N),C.registerPartial("spinner",G),C.registerPartial("table",B),C.registerPartial("tag",Q),C.registerPartial("textarea",J),C.registerPartial("textbox",W),C.registerPartial("typography",Y),C.registerPartial("video",j)}typeof Handlebars!="undefined"&&o(Handlebars);var U=!1;function $(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(U?console.log("HandleBars Helpers And Partials already loaded, loading again"):U=!0,l(C),o(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&$(Handlebars);})();
