"use strict";(()=>{function n(C){C.registerHelper("contains",function(t,a,i){return t=C.escapeExpression(t),a=C.escapeExpression(a),a.indexOf(t)>-1?i.fn(this):i.inverse(this)}),C.registerHelper("ifCond",function(t,a,i,e){switch(a){case"==":return t==i?e.fn(this):e.inverse(this);case"===":return t===i?e.fn(this):e.inverse(this);case"!=":return t!=i?e.fn(this):e.inverse(this);case"!==":return t!==i?e.fn(this):e.inverse(this);case"<":return t<i?e.fn(this):e.inverse(this);case"<=":return t<=i?e.fn(this):e.inverse(this);case">":return t>i?e.fn(this):e.inverse(this);case">=":return t>=i?e.fn(this):e.inverse(this);case"&&":return t&&i?e.fn(this):e.inverse(this);case"||":return t||i?e.fn(this):e.inverse(this);case"contains":return typeof t=="string"&&typeof i=="string"?t.toLowerCase().indexOf(i.toLowerCase())>=0?e.fn(this):e.inverse(this):e.inverse(this);default:return e.inverse(this)}}),C.registerHelper("isType",function(t,a,i){return t===a?i.fn(this):i.inverse(this)}),C.registerHelper("ifAny",function(...t){let a=t.pop();return t.some(i=>!!i)?a.fn(this):a.inverse(this)}),C.registerHelper("now",function(){return new Date().toISOString()}),C.registerHelper("formatDate",function(t,a,i){let e;if(t&&(e=new Date(t)),isNaN(e)&&a&&(e=new Date(a)),isNaN(e))return"Invalid Date";var o=["January","February","March","April","May","June","July","August","September","October","November","December"],r=e.getDate(),l=o[e.getMonth()],s=e.getFullYear();switch(i){case"YYYY":return`${s}`;case"MMMM YYYY":return`${l} ${s}`;default:return`${r} ${l} ${s}`}}),C.registerHelper("formatDateOrToday",function(t,a){let i=t||new Date().toISOString();return C.helpers.formatDate(t,i,a)}),C.registerHelper("formatDuration",function(t,a){if(!t)return"";if(typeof t=="string"&&a!=="long")return t;let i="",e=[],o,r,l;if(typeof t=="string"){let s=t.split(":");l=s[0],s.length==2?[r="",l=""]=s:s.length==3&&([o="",r="",l=""]=s)}else[o="",r="",l=""]=t;return a==="long"?(o>0&&e.push(`${o} hour${o>1?"s":""}`),r>0&&e.push(`${r} minute${r>1?"s":""}`),l>0&&e.push(`${l} second${l>1?"s":""}`),i=e.join(" ")):(o>0&&e.push(o.toString().padStart(2,0)),e.push(r.toString().padStart(2,0)),e.push(l.toString().padStart(2,0)),i=e.join(":")),i}),C.registerHelper("default",function(t,a){return t!==void 0?t:a}),C.registerHelper("isdefined",function(t,a){return t!==void 0?t:a})}typeof Handlebars!="undefined"&&n(Handlebars);var c=`<!-- QGDS Component: Accordion -->
...
{{/unless }}`;var g=`<!-- QGDS Component: Callout -->
...
`;var b="";var Z=`<!-- QGDS Component: Date input -->
...
`;var _=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
...
</html>`;var y=`<!-- QGDS Component: Global Alert -->
...
`;var T=`<header class="qld__header" role="banner">
...
<!-- HEADER END -->`;var S=`<div class="alert {{variantClass}} {{customClass}}" role="alert">
    {{#if heading}}
...
{{> footer footer}}`;var O=`<!-- DCTERMS https://www.dublincore.org/specifications/dublin-core/dcmi-terms/-->
{{#if dcTerms}}
...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`;var P=`<!-- Example button to trigger the modal -->
...
</div>`;var E=`<!-- QGDS Partial: Primary navigation -->
...
</nav>`;var F=`<!-- QGDS Component: Loading Quick exit -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",f),C.registerPartial("banner",p),C.registerPartial("blockquote",u),C.registerPartial("breadcrumbs",h),C.registerPartial("breadcrumbsWrapper",L),C.registerPartial("button",v),C.registerPartial("callout",g),C.registerPartial("card",m),C.registerPartial("contentFooter",V),C.registerPartial("contentFooterWrapper",H),C.registerPartial("contentWrapper",M),C.registerPartial("correctincorrect",b),C.registerPartial("dateinput",Z),C.registerPartial("footer",_),C.registerPartial("footerForgov",w),C.registerPartial("formcheck",q),C.registerPartial("fullPage",x),C.registerPartial("globalAlert",y),C.registerPartial("head",k),C.registerPartial("header",T),C.registerPartial("inpageAlert",S),C.registerPartial("inpagenav",R),C.registerPartial("mainContainerWrapper",D),C.registerPartial("metaDcTerms",O),C.registerPartial("metaOpenGraph",A),C.registerPartial("modal",P),C.registerPartial("navbar",E),C.registerPartial("pagination",I),C.registerPartial("quickexit",F),C.registerPartial("searchInput",N),C.registerPartial("select",G),C.registerPartial("sidenav",Q),C.registerPartial("sidenavWrapper",B),C.registerPartial("spinner",J),C.registerPartial("table",W),C.registerPartial("tag",Y),C.registerPartial("textarea",j),C.registerPartial("textbox",$),C.registerPartial("typography",U),C.registerPartial("video",z)}typeof Handlebars!="undefined"&&d(Handlebars);var X=!1;function K(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(X?console.log("HandleBars Helpers And Partials already loaded, loading again"):X=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&K(Handlebars);})();
