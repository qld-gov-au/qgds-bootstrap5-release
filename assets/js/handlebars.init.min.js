"use strict";(()=>{function p2(C,i,a,e){switch(i){case"==":return C==a?e.fn(this):e.inverse(this);case"===":return C===a?e.fn(this):e.inverse(this);case"!=":return C!=a?e.fn(this):e.inverse(this);case"!==":return C!==a?e.fn(this):e.inverse(this);case"<":return C<a?e.fn(this):e.inverse(this);case"<=":return C<=a?e.fn(this):e.inverse(this);case">":return C>a?e.fn(this):e.inverse(this);case">=":return C>=a?e.fn(this):e.inverse(this);case"&&":return C&&a?e.fn(this):e.inverse(this);case"||":return C||a?e.fn(this):e.inverse(this);case"contains":return typeof C=="string"&&typeof a=="string"?C.toLowerCase().indexOf(a.toLowerCase())>=0?e.fn(this):e.inverse(this):e.inverse(this);default:return e.inverse(this)}}function r(C){C.registerHelper("contains",function(i,a,e){return i=C.escapeExpression(i),a=C.escapeExpression(a),a.indexOf(i)>-1?e.fn(this):e.inverse(this)}),C.registerHelper("ifCond",p2),C.registerHelper("isType",function(i,a,e){return i===a?e.fn(this):e.inverse(this)}),C.registerHelper("ifAny",function(...i){let a=i.pop();return i.some(e=>!!e)?a.fn(this):a.inverse(this)}),C.registerHelper("now",function(){return new Date().toISOString()}),C.registerHelper("formatDate",function(i,a,e){let t;if(i&&(t=new Date(i)),isNaN(t)&&a&&(t=new Date(a)),isNaN(t))return"Invalid Date";var l=["January","February","March","April","May","June","July","August","September","October","November","December"],o=t.getDate(),s=l[t.getMonth()],n=t.getFullYear();switch(e){case"YYYY":return`${n}`;case"MMMM YYYY":return`${s} ${n}`;default:return`${o} ${s} ${n}`}}),C.registerHelper("formatDateOrToday",function(i,a){let e=i||new Date().toISOString();return C.helpers.formatDate(i,e,a)}),C.registerHelper("formatDuration",function(i,a){if(!i)return"";if(typeof i=="string"&&a!=="long")return i;let e="",t=[],l,o,s;if(typeof i=="string"){let n=i.split(":");s=n[0],n.length==2?[o="",s=""]=n:n.length==3&&([l="",o="",s=""]=n)}else[l="",o="",s=""]=i;return a==="long"?(l>0&&t.push(`${l} hour${l>1?"s":""}`),o>0&&t.push(`${o} minute${o>1?"s":""}`),s>0&&t.push(`${s} second${s>1?"s":""}`),e=t.join(" ")):(l>0&&t.push(l.toString().padStart(2,0)),t.push(o.toString().padStart(2,0)),t.push(s.toString().padStart(2,0)),e=t.join(":")),e}),C.registerHelper("isdefined",function(i,a){return i!==void 0&&i!==""?i:a}),C.registerHelper("getClassNames",function(i,a){let e=i.split(",").map(l=>l.trim()),t=[];for(let l=0;l<e.length;l++){let o=e[l];if(a){for(let s=0;s<a.length;s++)if(a[s][o]===!0){t.push(o);break}}}return t.length>0?t.join(" "):""}),C.registerHelper("join",function(i,a){return(!a||typeof a!="string")&&(a=" "),Array.isArray(i)?i.join(a):i}),C.registerHelper("toCamelCase",function(i){return typeof i!="string"?i:i.toLowerCase().replace(/(?:^\w|[A-Z]|\b\w|\s+)/g,(a,e)=>e===0?a.toLowerCase():a.toUpperCase()).replace(/\s+/g,"")})}typeof Handlebars!="undefined"&&r(Handlebars);var c=`<!-- QGDS Component: Accordion -->
...
</dl>`;var w=`<div class="container qld-content-footer">
  <div class="row">
    {{> @partial-block }}
  </div>
...
`;var A=`<header class="qld-header" role="banner">
...
</header>`;var R=`<svg class="qld-icon-{{size}}"{{#if ariaLabel}} aria-label="{{ariaLabel}}"{{/if}}{{#if ariaHidden}} aria-hidden="{{ariaHidden}}"{{/if}}>
...
`;var e2=`<nav class="qld-skip-links" aria-label="skip to content links">
  ...
  {{/each}}
</nav>`;var a2=`<!-- QGDS Component: Loading Spinner -->
...
`;var s2=`<!-- QGDS Component: Textarea -->
...
<input id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    isRequired}}required aria-required="true" {{/if}} />`;var n2="<!-- QGDS Partial: typography -->";var r2=`<!-- QGDS Component: Video -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",p),C.registerPartial("banner",f),C.registerPartial("blockquote",h),C.registerPartial("breadcrumbs",u),C.registerPartial("breadcrumbsWrapper",v),C.registerPartial("button",g),C.registerPartial("callToAction",m),C.registerPartial("callout",b),C.registerPartial("card",L),C.registerPartial("contentFooter",V),C.registerPartial("contentFooterWrapper",w),C.registerPartial("contentWrapper",H),C.registerPartial("correctincorrect",M),C.registerPartial("dateinput",_),C.registerPartial("directionLinks",Z),C.registerPartial("footer",k),C.registerPartial("footerForgov",y),C.registerPartial("formcheck",q),C.registerPartial("fullPage",x),C.registerPartial("globalAlert",T),C.registerPartial("head",S),C.registerPartial("header",A),C.registerPartial("icon",R),C.registerPartial("image",O),C.registerPartial("inpageAlert",D),C.registerPartial("inpagenav",P),C.registerPartial("linkColumns",I),C.registerPartial("logo",E),C.registerPartial("logoCOALandscape",N),C.registerPartial("logoCOALandscape2Lines",F),C.registerPartial("mainContainerWrapper",G),C.registerPartial("metaDcTerms",Q),C.registerPartial("metaOpenGraph",B),C.registerPartial("modal",J),C.registerPartial("navbar",W),C.registerPartial("pageLayout",Y),C.registerPartial("pagination",j),C.registerPartial("promotionalPanel",U),C.registerPartial("quickexit",$),C.registerPartial("searchInput",z),C.registerPartial("select",X),C.registerPartial("sidenav",K),C.registerPartial("sidenavWrapper",C2),C.registerPartial("skipLinks",e2),C.registerPartial("spinner",a2),C.registerPartial("table",i2),C.registerPartial("tabs",t2),C.registerPartial("tag",l2),C.registerPartial("textarea",s2),C.registerPartial("textbox",o2),C.registerPartial("typography",n2),C.registerPartial("video",r2)}typeof Handlebars!="undefined"&&d(Handlebars);var d2=!1;function c2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(d2?console.log("HandleBars Helpers And Partials already loaded, loading again"):d2=!0,r(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&c2(Handlebars);})();
