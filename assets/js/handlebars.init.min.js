...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",p),C.registerPartial("banner",f),C.registerPartial("blockquote",u),C.registerPartial("breadcrumbs",h),C.registerPartial("breadcrumbsWrapper",m),C.registerPartial("button",L),C.registerPartial("callToAction",v),C.registerPartial("callout",g),C.registerPartial("card",b),C.registerPartial("containerLayout",H),C.registerPartial("contentFooter",V),C.registerPartial("contentFooterWrapper",M),C.registerPartial("contentWrapper",Z),C.registerPartial("correctincorrect",_),C.registerPartial("dateinput",y),C.registerPartial("directionLinks",q),C.registerPartial("customLinks",k),C.registerPartial("feedbackForm",w),C.registerPartial("followLinks",x),C.registerPartial("footer",T),C.registerPartial("formcheck",S),C.registerPartial("fullPage",A),C.registerPartial("globalAlert",P),C.registerPartial("head",O),C.registerPartial("header",R),C.registerPartial("icon",D),C.registerPartial("image",I),C.registerPartial("inpageAlert",E),C.registerPartial("inpagenav",F),C.registerPartial("link",N),C.registerPartial("linkColumns",G),C.registerPartial("logo",Q),C.registerPartial("logoCOALandscape",j),C.registerPartial("logoCOALandscape2Lines",B),C.registerPartial("mainContainerWrapper",J),C.registerPartial("metaDcTerms",W),C.registerPartial("metaOpenGraph",Y),C.registerPartial("modal",U),C.registerPartial("navbar",$),C.registerPartial("contentPageWithForm",z),C.registerPartial("contentPageWithSideNavigation",X),C.registerPartial("homePage",K),C.registerPartial("pagination",C2),C.registerPartial("promotionalPanel",e2),C.registerPartial("quickexit",i2),C.registerPartial("searchInput",t2),C.registerPartial("select",a2),C.registerPartial("sidenav",l2),C.registerPartial("sidenavWrapper",o2),C.registerPartial("skipLinks",r2),C.registerPartial("spinner",s2),C.registerPartial("table",n2),C.registerPartial("tabs",d2),C.registerPartial("tag",c2),C.registerPartial("textarea",p2),C.registerPartial("textbox",f2),C.registerPartial("typography",u2),C.registerPartial("video",h2)}typeof Handlebars!="undefined"&&d(Handlebars);var m2=!1;function L2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(m2?console.log("HandleBars Helpers And Partials already loaded, loading again"):m2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&L2(Handlebars);})();
