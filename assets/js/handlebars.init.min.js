...
`;function d(e){e.registerPartial("accordion",c),e.registerPartial("backToTop",p),e.registerPartial("banner",f),e.registerPartial("blockquote",u),e.registerPartial("breadcrumbs",m),e.registerPartial("breadcrumbsWrapper",g),e.registerPartial("button",v),e.registerPartial("callToAction",h),e.registerPartial("callout",b),e.registerPartial("card",L),e.registerPartial("containerLayout",k),e.registerPartial("contentFooter",q),e.registerPartial("contentFooterWrapper",y),e.registerPartial("contentWrapper",M),e.registerPartial("correctincorrect",x),e.registerPartial("dateinput",w),e.registerPartial("directionLinks",V),e.registerPartial("customLinks",H),e.registerPartial("feedbackForm",Z),e.registerPartial("followLinks",T),e.registerPartial("footer",S),e.registerPartial("formcheck",A),e.registerPartial("fullPage",P),e.registerPartial("globalAlert",O),e.registerPartial("head",R),e.registerPartial("header",D),e.registerPartial("headerBrand",I),e.registerPartial("icon",_),e.registerPartial("image",E),e.registerPartial("inpageAlert",G),e.registerPartial("inpagenav",N),e.registerPartial("link",F),e.registerPartial("linkColumns",B),e.registerPartial("logo",Q),e.registerPartial("logoCOALandscape",j),e.registerPartial("logoCOALandscape2Lines",J),e.registerPartial("mainContainerWrapper",W),e.registerPartial("metaDcTerms",Y),e.registerPartial("metaOpenGraph",U),e.registerPartial("modal",$),e.registerPartial("navbar",z),e.registerPartial("contentPageWithForm",X),e.registerPartial("contentPageWithSideNavigation",K),e.registerPartial("homePage",e5),e.registerPartial("pagination",i5),e.registerPartial("promotionalPanel",a5),e.registerPartial("quickexit",t5),e.registerPartial("searchInput",s5),e.registerPartial("select",l5),e.registerPartial("sidenav",n5),e.registerPartial("sidenavWrapper",o5),e.registerPartial("skipLinks",C5),e.registerPartial("spinner",r5),e.registerPartial("table",d5),e.registerPartial("tabs",c5),e.registerPartial("tag",p5),e.registerPartial("textarea",f5),e.registerPartial("textbox",u5),e.registerPartial("typography",m5),e.registerPartial("video",g5)}typeof Handlebars!="undefined"&&d(Handlebars);var v5=!1;function h5(e){typeof e=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof e!="undefined"?(v5?console.log("HandleBars Helpers And Partials already loaded, loading again"):v5=!0,r(e),d(e)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&h5(Handlebars);})();
