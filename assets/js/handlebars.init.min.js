"use strict";(()=>{function v2(C,i,t,e){switch(i){case"==":return C==t?e.fn(this):e.inverse(this);case"===":return C===t?e.fn(this):e.inverse(this);case"!=":return C!=t?e.fn(this):e.inverse(this);case"!==":return C!==t?e.fn(this):e.inverse(this);case"<":return C<t?e.fn(this):e.inverse(this);case"<=":return C<=t?e.fn(this):e.inverse(this);case">":return C>t?e.fn(this):e.inverse(this);case">=":return C>=t?e.fn(this):e.inverse(this);case"&&":return C&&t?e.fn(this):e.inverse(this);case"||":return C||t?e.fn(this):e.inverse(this);case"contains":return typeof C=="string"&&typeof t=="string"?C.toLowerCase().indexOf(t.toLowerCase())>=0?e.fn(this):e.inverse(this):e.inverse(this);default:return e.inverse(this)}}function s(C){C.registerHelper("contains",function(i,t,e){return i=C.escapeExpression(i),t=C.escapeExpression(t),t.indexOf(i)>-1?e.fn(this):e.inverse(this)}),C.registerHelper("ifCond",v2),C.registerHelper("isType",function(i,t,e){return i===t?e.fn(this):e.inverse(this)}),C.registerHelper("ifAny",function(...i){let t=i.pop();return i.some(e=>!!e)?t.fn(this):t.inverse(this)}),C.registerHelper("now",function(){return new Date().toISOString()}),C.registerHelper("formatDate",function(i,t,e){let a;if(i&&(a=new Date(i)),isNaN(a)&&t&&(a=new Date(t)),isNaN(a))return"Invalid Date";var l=["January","February","March","April","May","June","July","August","September","October","November","December"],r=a.getDate(),o=l[a.getMonth()],n=a.getFullYear();switch(e){case"YYYY":return`${n}`;case"MMMM YYYY":return`${o} ${n}`;default:return`${r} ${o} ${n}`}}),C.registerHelper("formatDateOrToday",function(i,t){let e=i||new Date().toISOString();return C.helpers.formatDate(i,e,t)}),C.registerHelper("formatDuration",function(i,t){if(!i)return"";if(typeof i=="string"&&t!=="long")return i;let e="",a=[],l,r,o;if(typeof i=="string"){let n=i.split(":");o=n[0],n.length==2?[r="",o=""]=n:n.length==3&&([l="",r="",o=""]=n)}else[l="",r="",o=""]=i;return t==="long"?(l>0&&a.push(`${l} hour${l>1?"s":""}`),r>0&&a.push(`${r} minute${r>1?"s":""}`),o>0&&a.push(`${o} second${o>1?"s":""}`),e=a.join(" ")):(l>0&&a.push(l.toString().padStart(2,0)),a.push(r.toString().padStart(2,0)),a.push(o.toString().padStart(2,0)),e=a.join(":")),e}),C.registerHelper("isdefined",function(i,t){return i!==void 0&&i!==""?i:t}),C.registerHelper("getClassNames",function(i,t){let e=i.split(",").map(l=>l.trim()),a=[];for(let l=0;l<e.length;l++){let r=e[l];if(t){for(let o=0;o<t.length;o++)if(t[o][r]===!0){a.push(r);break}}}return a.length>0?a.join(" "):""}),C.registerHelper("join",function(i,t){return(!t||typeof t!="string")&&(t=" "),Array.isArray(i)?i.join(t):i}),C.registerHelper("toCamelCase",function(i){return typeof i!="string"?i:i.toLowerCase().replace(/(?:^\w|[A-Z]|\b\w|\s+)/g,(t,e)=>e===0?t.toLowerCase():t.toUpperCase()).replace(/\s+/g,"")})}typeof Handlebars!="undefined"&&s(Handlebars);var c=`<!-- QGDS Component: Accordion -->
...
</html>`;var V=`  <div class="row {{classes}}">
    {{#if lastUpdated}}
    <div class="col-auto">
...
{{/if}}`;var T=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
...
</section>`;var t2=`<!-- QGDS Component: Loading Quick exit -->
...
`;var p2=`<!-- QGDS Component: Textarea -->
...
<input id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    isRequired}}required aria-required="true" {{/if}} />`;var u2="<!-- QGDS Partial: typography -->";var h2=`<!-- QGDS Component: Video -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",p),C.registerPartial("banner",f),C.registerPartial("blockquote",u),C.registerPartial("breadcrumbs",h),C.registerPartial("breadcrumbsWrapper",L),C.registerPartial("button",m),C.registerPartial("callToAction",v),C.registerPartial("callout",g),C.registerPartial("card",b),C.registerPartial("containerLayout",H),C.registerPartial("contentFooter",V),C.registerPartial("contentFooterWrapper",M),C.registerPartial("contentWrapper",Z),C.registerPartial("correctincorrect",_),C.registerPartial("dateinput",w),C.registerPartial("directionLinks",y),C.registerPartial("customLinks",q),C.registerPartial("feedbackForm",k),C.registerPartial("followLinks",x),C.registerPartial("footer",T),C.registerPartial("formcheck",S),C.registerPartial("fullPage",P),C.registerPartial("globalAlert",A),C.registerPartial("head",D),C.registerPartial("header",R),C.registerPartial("icon",O),C.registerPartial("image",E),C.registerPartial("inpageAlert",I),C.registerPartial("inpagenav",F),C.registerPartial("linkColumns",G),C.registerPartial("logo",N),C.registerPartial("logoCOALandscape",Q),C.registerPartial("logoCOALandscape2Lines",W),C.registerPartial("mainContainerWrapper",j),C.registerPartial("metaDcTerms",J),C.registerPartial("metaOpenGraph",B),C.registerPartial("modal",Y),C.registerPartial("navbar",U),C.registerPartial("pageLayout",$),C.registerPartial("contentPageWithForm",z),C.registerPartial("contentPageWithSideNavigation",X),C.registerPartial("fullWidthLandingPage",K),C.registerPartial("pagination",C2),C.registerPartial("promotionalPanel",e2),C.registerPartial("quickexit",t2),C.registerPartial("searchInput",i2),C.registerPartial("select",a2),C.registerPartial("sidenav",l2),C.registerPartial("sidenavWrapper",o2),C.registerPartial("skipLinks",r2),C.registerPartial("spinner",n2),C.registerPartial("table",s2),C.registerPartial("tabs",d2),C.registerPartial("tag",c2),C.registerPartial("textarea",p2),C.registerPartial("textbox",f2),C.registerPartial("typography",u2),C.registerPartial("video",h2)}typeof Handlebars!="undefined"&&d(Handlebars);var L2=!1;function m2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(L2?console.log("HandleBars Helpers And Partials already loaded, loading again"):L2=!0,s(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&m2(Handlebars);})();
