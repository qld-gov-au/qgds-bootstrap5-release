...
`;var P=`<header class="qld__header" role="banner">
...
{{#if src}}
  ...
  {{else}}
    {{> imageTag}}
  {{/if}}
{{/if}}`;var O=`<div class="alert {{variantClass}} {{customClass}}" role="alert" 
    ...
    {{/if}}
    {{{ content }}}
</div>`;var R=`<!-- QGDS Partial: inpage-nav -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",p),C.registerPartial("banner",f),C.registerPartial("blockquote",h),C.registerPartial("breadcrumbs",L),C.registerPartial("breadcrumbsWrapper",u),C.registerPartial("button",v),C.registerPartial("callToAction",m),C.registerPartial("callout",g),C.registerPartial("card",V),C.registerPartial("contentFooter",H),C.registerPartial("contentFooterWrapper",M),C.registerPartial("contentWrapper",b),C.registerPartial("correctincorrect",Z),C.registerPartial("dateinput",_),C.registerPartial("directionLinks",w),C.registerPartial("footer",y),C.registerPartial("footerForgov",k),C.registerPartial("formcheck",q),C.registerPartial("fullPage",x),C.registerPartial("globalAlert",T),C.registerPartial("head",S),C.registerPartial("header",P),C.registerPartial("icon",A),C.registerPartial("image",D),C.registerPartial("inpageAlert",O),C.registerPartial("inpagenav",R),C.registerPartial("linkColumns",E),C.registerPartial("logo",I),C.registerPartial("logoCOALandscape",F),C.registerPartial("logoCOALandscape2Lines",N),C.registerPartial("mainContainerWrapper",G),C.registerPartial("metaDcTerms",Q),C.registerPartial("metaOpenGraph",B),C.registerPartial("modal",W),C.registerPartial("navbar",J),C.registerPartial("pageLayout",Y),C.registerPartial("contentPageWithForm",j),C.registerPartial("contentPageWithSideNavigation",U),C.registerPartial("fullWidthLandingPage",$),C.registerPartial("pagination",z),C.registerPartial("promotionalPanel",X),C.registerPartial("quickexit",K),C.registerPartial("searchInput",C2),C.registerPartial("select",e2),C.registerPartial("sidenav",t2),C.registerPartial("sidenavWrapper",i2),C.registerPartial("skipLinks",a2),C.registerPartial("spinner",l2),C.registerPartial("table",o2),C.registerPartial("tabs",r2),C.registerPartial("tag",s2),C.registerPartial("textarea",n2),C.registerPartial("textbox",d2),C.registerPartial("typography",c2),C.registerPartial("video",p2)}typeof Handlebars!="undefined"&&d(Handlebars);var f2=!1;function h2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(f2?console.log("HandleBars Helpers And Partials already loaded, loading again"):f2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&h2(Handlebars);})();
