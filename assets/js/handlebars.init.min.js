"use strict";(()=>{function m2(C,t,i,e){switch(t){case"==":return C==i?e.fn(this):e.inverse(this);case"===":return C===i?e.fn(this):e.inverse(this);case"!=":return C!=i?e.fn(this):e.inverse(this);case"!==":return C!==i?e.fn(this):e.inverse(this);case"<":return C<i?e.fn(this):e.inverse(this);case"<=":return C<=i?e.fn(this):e.inverse(this);case">":return C>i?e.fn(this):e.inverse(this);case">=":return C>=i?e.fn(this):e.inverse(this);case"&&":return C&&i?e.fn(this):e.inverse(this);case"||":return C||i?e.fn(this):e.inverse(this);case"contains":return typeof C=="string"&&typeof i=="string"?C.toLowerCase().indexOf(i.toLowerCase())>=0?e.fn(this):e.inverse(this):e.inverse(this);default:return e.inverse(this)}}function s(C){C.registerHelper("contains",function(t,i,e){return t=C.escapeExpression(t),i=C.escapeExpression(i),i.indexOf(t)>-1?e.fn(this):e.inverse(this)}),C.registerHelper("ifCond",m2),C.registerHelper("isType",function(t,i,e){return t===i?e.fn(this):e.inverse(this)}),C.registerHelper("ifAny",function(...t){let i=t.pop();return t.some(e=>!!e)?i.fn(this):i.inverse(this)}),C.registerHelper("now",function(){return new Date().toISOString()}),C.registerHelper("formatDate",function(t,i,e){let a;if(t&&(a=new Date(t)),isNaN(a)&&i&&(a=new Date(i)),isNaN(a))return"Invalid Date";var l=["January","February","March","April","May","June","July","August","September","October","November","December"],n=a.getDate(),o=l[a.getMonth()],r=a.getFullYear();switch(e){case"YYYY":return`${r}`;case"MMMM YYYY":return`${o} ${r}`;default:return`${n} ${o} ${r}`}}),C.registerHelper("formatDateOrToday",function(t,i){let e=t||new Date().toISOString();return C.helpers.formatDate(t,e,i)}),C.registerHelper("formatDuration",function(t,i){if(!t)return"";if(typeof t=="string"&&i!=="long")return t;let e="",a=[],l,n,o;if(typeof t=="string"){let r=t.split(":");o=r[0],r.length==2?[n="",o=""]=r:r.length==3&&([l="",n="",o=""]=r)}else[l="",n="",o=""]=t;return i==="long"?(l>0&&a.push(`${l} hour${l>1?"s":""}`),n>0&&a.push(`${n} minute${n>1?"s":""}`),o>0&&a.push(`${o} second${o>1?"s":""}`),e=a.join(" ")):(l>0&&a.push(l.toString().padStart(2,0)),a.push(n.toString().padStart(2,0)),a.push(o.toString().padStart(2,0)),e=a.join(":")),e}),C.registerHelper("isdefined",function(t,i){return t!==void 0&&t!==""?t:i}),C.registerHelper("getClassNames",function(t,i){let e=t.split(",").map(l=>l.trim()),a=[];for(let l=0;l<e.length;l++){let n=e[l];if(i){for(let o=0;o<i.length;o++)if(i[o][n]===!0){a.push(n);break}}}return a.length>0?a.join(" "):""}),C.registerHelper("join",function(t,i){return(!i||typeof i!="string")&&(i=" "),Array.isArray(t)?t.join(i):t}),C.registerHelper("toCamelCase",function(t){return typeof t!="string"?t:t.toLowerCase().replace(/(?:^\w|[A-Z]|\b\w|\s+)/g,(i,e)=>e===0?i.toLowerCase():i.toUpperCase()).replace(/\s+/g,"")})}typeof Handlebars!="undefined"&&s(Handlebars);var c=`<!-- QGDS Component: Accordion -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",p),C.registerPartial("banner",f),C.registerPartial("blockquote",u),C.registerPartial("breadcrumbs",h),C.registerPartial("breadcrumbsWrapper",L),C.registerPartial("button",m),C.registerPartial("callToAction",v),C.registerPartial("callout",g),C.registerPartial("card",b),C.registerPartial("contentFooter",H),C.registerPartial("contentFooterWrapper",V),C.registerPartial("contentWrapper",M),C.registerPartial("correctincorrect",Z),C.registerPartial("dateinput",_),C.registerPartial("directionLinks",w),C.registerPartial("customLinks",q),C.registerPartial("feedbackForm",k),C.registerPartial("followLinks",y),C.registerPartial("footer",x),C.registerPartial("formcheck",T),C.registerPartial("fullPage",S),C.registerPartial("globalAlert",P),C.registerPartial("head",A),C.registerPartial("header",R),C.registerPartial("icon",O),C.registerPartial("image",D),C.registerPartial("inpageAlert",E),C.registerPartial("inpagenav",I),C.registerPartial("linkColumns",F),C.registerPartial("logo",G),C.registerPartial("logoCOALandscape",N),C.registerPartial("logoCOALandscape2Lines",Q),C.registerPartial("mainContainerWrapper",W),C.registerPartial("metaDcTerms",J),C.registerPartial("metaOpenGraph",j),C.registerPartial("modal",B),C.registerPartial("navbar",Y),C.registerPartial("pageLayout",U),C.registerPartial("contentPageWithForm",$),C.registerPartial("contentPageWithSideNavigation",z),C.registerPartial("fullWidthLandingPage",X),C.registerPartial("pagination",K),C.registerPartial("promotionalPanel",C2),C.registerPartial("quickexit",e2),C.registerPartial("searchInput",i2),C.registerPartial("select",t2),C.registerPartial("sidenav",a2),C.registerPartial("sidenavWrapper",l2),C.registerPartial("skipLinks",o2),C.registerPartial("spinner",n2),C.registerPartial("table",r2),C.registerPartial("tabs",s2),C.registerPartial("tag",d2),C.registerPartial("textarea",c2),C.registerPartial("textbox",p2),C.registerPartial("typography",f2),C.registerPartial("video",u2)}typeof Handlebars!="undefined"&&d(Handlebars);var h2=!1;function L2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(h2?console.log("HandleBars Helpers And Partials already loaded, loading again"):h2=!0,s(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&L2(Handlebars);})();
