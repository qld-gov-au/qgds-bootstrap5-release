...
</nav>`;var Y=`<section class="qld-promo-panel {{#ifCond type '==' 'indent-text'}}indent{{/ifCond}} {{#ifCond type '==' 'indent-img'}}indent{{/ifCond}} {{type}}">
...
</section>`;var j=`<!-- QGDS Component: Loading Quick exit -->
...
`;var z=`<div class="qld-side-navigation">
...
`;var K=`<!-- QGDS Component: Loading Spinner -->
...
</section>`;var t2=`<!-- QGDS Component: Tag -->
...
`;var i2=`<!-- QGDS Component: Textarea -->
