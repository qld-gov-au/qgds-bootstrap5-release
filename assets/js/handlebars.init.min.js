...
{{/if}}`;var q=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
...
{{> footer footer}}`;var N=`<!-- DCTERMS https://www.dublincore.org/specifications/dublin-core/dcmi-terms/-->
{{#if dcTerms}}
...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`;var Q=`<!-- Example button to trigger the modal -->
...
</div>`;var B=`<!-- QGDS Partial: Primary navigation -->
...
`;var X=`<!-- QGDS Component: Loading Spinner -->
...
</section>`;var e2=`<!-- QGDS Component: Tag -->
...
<textarea id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    aria-required="true" {{/if}}></textarea>`;var i2=`<!-- QGDS Component: Textbox -->
...
<input id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    isRequired}}required aria-required="true" {{/if}} />`;var a2="<!-- QGDS Partial: typography -->";var l2=`<!-- QGDS Component: Video -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",f),C.registerPartial("banner",p),C.registerPartial("blockquote",u),C.registerPartial("breadcrumbs",h),C.registerPartial("breadcrumbsWrapper",L),C.registerPartial("button",v),C.registerPartial("callToAction",m),C.registerPartial("callout",g),C.registerPartial("card",b),C.registerPartial("contentFooter",V),C.registerPartial("contentFooterWrapper",H),C.registerPartial("contentWrapper",M),C.registerPartial("correctincorrect",Z),C.registerPartial("dateinput",_),C.registerPartial("directionLinks",w),C.registerPartial("feedbackForm",k),C.registerPartial("followLinks",y),C.registerPartial("footer",q),C.registerPartial("footerForgov",x),C.registerPartial("formcheck",T),C.registerPartial("fullPage",S),C.registerPartial("globalAlert",R),C.registerPartial("head",P),C.registerPartial("header",A),C.registerPartial("image",D),C.registerPartial("inpageAlert",O),C.registerPartial("inpagenav",E),C.registerPartial("linkColumns",I),C.registerPartial("mainContainerWrapper",F),C.registerPartial("metaDcTerms",N),C.registerPartial("metaOpenGraph",G),C.registerPartial("modal",Q),C.registerPartial("navbar",B),C.registerPartial("pagination",J),C.registerPartial("promotionalPanel",W),C.registerPartial("quickexit",Y),C.registerPartial("searchInput",j),C.registerPartial("select",U),C.registerPartial("sidenav",$),C.registerPartial("sidenavWrapper",z),C.registerPartial("spinner",X),C.registerPartial("table",K),C.registerPartial("tabs",C2),C.registerPartial("tag",e2),C.registerPartial("textarea",t2),C.registerPartial("textbox",i2),C.registerPartial("typography",a2),C.registerPartial("video",l2)}typeof Handlebars!="undefined"&&d(Handlebars);var o2=!1;function r2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(o2?console.log("HandleBars Helpers And Partials already loaded, loading again"):o2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&r2(Handlebars);})();
