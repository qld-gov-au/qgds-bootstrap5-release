...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",p),C.registerPartial("banner",f),C.registerPartial("blockquote",u),C.registerPartial("breadcrumbs",h),C.registerPartial("breadcrumbsWrapper",L),C.registerPartial("button",m),C.registerPartial("callToAction",v),C.registerPartial("callout",g),C.registerPartial("card",b),C.registerPartial("contentFooter",H),C.registerPartial("contentFooterWrapper",V),C.registerPartial("contentWrapper",M),C.registerPartial("correctincorrect",Z),C.registerPartial("dateinput",_),C.registerPartial("directionLinks",w),C.registerPartial("customLinks",y),C.registerPartial("feedbackForm",q),C.registerPartial("followLinks",k),C.registerPartial("footer",x),C.registerPartial("formcheck",T),C.registerPartial("fullPage",S),C.registerPartial("globalAlert",P),C.registerPartial("head",A),C.registerPartial("header",R),C.registerPartial("icon",O),C.registerPartial("image",D),C.registerPartial("inpageAlert",E),C.registerPartial("inpagenav",I),C.registerPartial("linkColumns",F),C.registerPartial("logo",G),C.registerPartial("logoCOALandscape",N),C.registerPartial("logoCOALandscape2Lines",Q),C.registerPartial("mainContainerWrapper",W),C.registerPartial("metaDcTerms",J),C.registerPartial("metaOpenGraph",j),C.registerPartial("modal",B),C.registerPartial("navbar",Y),C.registerPartial("pageLayout",U),C.registerPartial("contentPageWithForm",$),C.registerPartial("contentPageWithSideNavigation",z),C.registerPartial("fullWidthLandingPage",X),C.registerPartial("pagination",K),C.registerPartial("promotionalPanel",C2),C.registerPartial("quickexit",e2),C.registerPartial("searchInput",t2),C.registerPartial("select",i2),C.registerPartial("sidenav",a2),C.registerPartial("sidenavWrapper",l2),C.registerPartial("skipLinks",o2),C.registerPartial("spinner",r2),C.registerPartial("table",n2),C.registerPartial("tabs",s2),C.registerPartial("tag",d2),C.registerPartial("textarea",c2),C.registerPartial("textbox",p2),C.registerPartial("typography",f2),C.registerPartial("video",u2)}typeof Handlebars!="undefined"&&d(Handlebars);var h2=!1;function L2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(h2?console.log("HandleBars Helpers And Partials already loaded, loading again"):h2=!0,s(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&L2(Handlebars);})();
