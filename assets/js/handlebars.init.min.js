...
`;var b=`<dl class="qld-content-dates">
  <dt>Last updated:</dt>
  <dd>{{formatDateOrToday lastUpdated }}</dd>
</dl>`;var V="";var H=`<!-- QGDS Component: Date input -->
...
`;var M=`{{! valid class values are: up, down, left, right}}
<a class="qld-dir-link {{class}}" 
  ...
  {{{label}}}
  <span class="icon" aria-hidden="true"></span>
</a>`;var Z=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
...
</footer>`;var _=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
  <!-- Footer content container -->
    <div class="container">
        <div class="row">
            <div class="col title">
...
`;var q=`<header class="qld__header" role="banner">
...
<!-- HEADER END -->`;var x=`<div class="alert {{variantClass}} {{customClass}}" role="alert">
    {{#if heading}}
    <div class="alert-heading" role="heading">{{{ heading }}}</div>
    {{/if}}
    {{{ content }}}
</div>`;var T=`<!-- QGDS Partial: inpage-nav -->
...
</nav>`;var E=`<section class="qld-promo-panel {{#ifCond type '==' 'indent-text'}}indent{{/ifCond}} {{#ifCond type '==' 'indent-img'}}indent{{/ifCond}} {{type}}">
...
</section>`;var I=`<!-- QGDS Component: Loading Quick exit -->
...
`;var G=`<div class="qld-side-navigation">
...
</div>`;var Q=`<!-- QGDS Component: Loading Spinner -->
...
</section>`;var W=`<!-- QGDS Component: Tag -->
...
<textarea id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    aria-required="true" {{/if}}></textarea>`;var j=`<!-- QGDS Component: Textbox -->
...
<input id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    isRequired}}required aria-required="true" {{/if}} />`;var U="<!-- QGDS Partial: typography -->";var $=`<!-- QGDS Component: Video -->
...
</div>`;var X=`<div class="container qld-content-footer">
    {{> @partial-block }}
</div>`;var K=`<!-- Content Wrapper -->
...
</html>`;var e2=`{{> globalAlert globalAlert}}
{{> header header}}
{{> navbar navbar}}
<main>
  {{#>breadcrumbsWrapper}}
...
{{> footer footer}}`;var t2=`<!-- Side Nav -->
<div class="col-12 col-lg-3 pe-lg-0 order-last order-lg-first mt-5 mt-lg-0">
  {{> @partial-block }}
</div>
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",f),C.registerPartial("banner",p),C.registerPartial("blockquote",u),C.registerPartial("breadcrumbs",h),C.registerPartial("button",L),C.registerPartial("callToAction",v),C.registerPartial("callout",m),C.registerPartial("card",g),C.registerPartial("contentFooter",b),C.registerPartial("correctincorrect",V),C.registerPartial("dateinput",H),C.registerPartial("directionLinks",M),C.registerPartial("footer",Z),C.registerPartial("footerForgov",_),C.registerPartial("formcheck",w),C.registerPartial("globalAlert",k),C.registerPartial("head",y),C.registerPartial("header",q),C.registerPartial("inpageAlert",x),C.registerPartial("inpagenav",T),C.registerPartial("linkColumns",S),C.registerPartial("metaDcTerms",R),C.registerPartial("metaOpenGraph",D),C.registerPartial("modal",A),C.registerPartial("navbar",O),C.registerPartial("pagination",P),C.registerPartial("promotionalPanel",E),C.registerPartial("quickexit",I),C.registerPartial("searchInput",F),C.registerPartial("select",N),C.registerPartial("sidenav",G),C.registerPartial("spinner",Q),C.registerPartial("table",B),C.registerPartial("tabs",J),C.registerPartial("tag",W),C.registerPartial("textarea",Y),C.registerPartial("textbox",j),C.registerPartial("typography",U),C.registerPartial("video",$),C.registerPartial("breadcrumbsWrapper",z),C.registerPartial("contentFooterWrapper",X),C.registerPartial("contentWrapper",K),C.registerPartial("fullPage",C2),C.registerPartial("mainContainerWrapper",e2),C.registerPartial("sidenavWrapper",t2)}typeof Handlebars!="undefined"&&d(Handlebars);var i2=!1;function a2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(i2?console.log("HandleBars Helpers And Partials already loaded, loading again"):i2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&a2(Handlebars);})();
