"use strict";(()=>{function v2(C,a,i,e){switch(a){case"==":return C==i?e.fn(this):e.inverse(this);case"===":return C===i?e.fn(this):e.inverse(this);case"!=":return C!=i?e.fn(this):e.inverse(this);case"!==":return C!==i?e.fn(this):e.inverse(this);case"<":return C<i?e.fn(this):e.inverse(this);case"<=":return C<=i?e.fn(this):e.inverse(this);case">":return C>i?e.fn(this):e.inverse(this);case">=":return C>=i?e.fn(this):e.inverse(this);case"&&":return C&&i?e.fn(this):e.inverse(this);case"||":return C||i?e.fn(this):e.inverse(this);case"contains":return typeof C=="string"&&typeof i=="string"?C.toLowerCase().indexOf(i.toLowerCase())>=0?e.fn(this):e.inverse(this):e.inverse(this);default:return e.inverse(this)}}function r(C){C.registerHelper("contains",function(a,i,e){return a=C.escapeExpression(a),i=C.escapeExpression(i),i.indexOf(a)>-1?e.fn(this):e.inverse(this)}),C.registerHelper("ifCond",v2),C.registerHelper("isType",function(a,i,e){return a===i?e.fn(this):e.inverse(this)}),C.registerHelper("ifAny",function(...a){let i=a.pop();return a.some(e=>!!e)?i.fn(this):i.inverse(this)}),C.registerHelper("now",function(){return new Date().toISOString()}),C.registerHelper("formatDate",function(a,i,e){let t;if(a&&(t=new Date(a)),isNaN(t)&&i&&(t=new Date(i)),isNaN(t))return"Invalid Date";var l=["January","February","March","April","May","June","July","August","September","October","November","December"],n=t.getDate(),s=l[t.getMonth()],o=t.getFullYear();switch(e){case"YYYY":return`${o}`;case"MMMM YYYY":return`${s} ${o}`;default:return`${n} ${s} ${o}`}}),C.registerHelper("formatDateOrToday",function(a,i){let e=a||new Date().toISOString();return C.helpers.formatDate(a,e,i)}),C.registerHelper("formatDuration",function(a,i){if(!a)return"";if(typeof a=="string"&&i!=="long")return a;let e="",t=[],l,n,s;if(typeof a=="string"){let o=a.split(":");s=o[0],o.length==2?[n="",s=""]=o:o.length==3&&([l="",n="",s=""]=o)}else[l="",n="",s=""]=a;return i==="long"?(l>0&&t.push(`${l} hour${l>1?"s":""}`),n>0&&t.push(`${n} minute${n>1?"s":""}`),s>0&&t.push(`${s} second${s>1?"s":""}`),e=t.join(" ")):(l>0&&t.push(l.toString().padStart(2,0)),t.push(n.toString().padStart(2,0)),t.push(s.toString().padStart(2,0)),e=t.join(":")),e}),C.registerHelper("isdefined",function(a,i){return a!==void 0&&a!==""?a:i}),C.registerHelper("getClassNames",function(a,i){let e=a.split(",").map(l=>l.trim()),t=[];for(let l=0;l<e.length;l++){let n=e[l];if(i){for(let s=0;s<i.length;s++)if(i[s][n]===!0){t.push(n);break}}}return t.length>0?t.join(" "):""}),C.registerHelper("join",function(a,i){return(!i||typeof i!="string")&&(i=" "),Array.isArray(a)?a.join(i):a}),C.registerHelper("toCamelCase",function(a){return typeof a!="string"?a:a.toLowerCase().replace(/(?:^\w|[A-Z]|\b\w|\s+)/g,(i,e)=>e===0?i.toLowerCase():i.toUpperCase()).replace(/\s+/g,"")})}typeof Handlebars!="undefined"&&r(Handlebars);var c=`<!-- QGDS Component: Accordion -->
...
`;var R=`<svg class="qld-icon-{{size}}"{{#if ariaLabel}} aria-label="{{ariaLabel}}"{{/if}}{{#if ariaHidden}} aria-hidden="{{ariaHidden}}"{{/if}}>
  <use href="./assets/img/icons-sprite.svg#qgds-icon-{{iconId}}"></use>
</svg>`;var _=`{{! Image template }}
{{#*inline "imageTag"}}
...
`;var l2=`<div class="qld-side-navigation">
...
<input id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    isRequired}}required aria-required="true" {{/if}} />`;var h2="<!-- QGDS Partial: typography -->";var u2=`<!-- QGDS Component: Video -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",f),C.registerPartial("banner",p),C.registerPartial("blockquote",h),C.registerPartial("breadcrumbs",u),C.registerPartial("breadcrumbsWrapper",m),C.registerPartial("button",g),C.registerPartial("callToAction",v),C.registerPartial("callout",b),C.registerPartial("card",L),C.registerPartial("containerLayout",V),C.registerPartial("contentFooter",M),C.registerPartial("contentFooterWrapper",H),C.registerPartial("contentWrapper",w),C.registerPartial("correctincorrect",Z),C.registerPartial("dateinput",k),C.registerPartial("directionLinks",x),C.registerPartial("footer",y),C.registerPartial("footerForgov",q),C.registerPartial("formcheck",T),C.registerPartial("fullPage",S),C.registerPartial("globalAlert",P),C.registerPartial("head",O),C.registerPartial("header",A),C.registerPartial("headerBrand",D),C.registerPartial("icon",R),C.registerPartial("image",_),C.registerPartial("inpageAlert",I),C.registerPartial("inpagenav",E),C.registerPartial("link",F),C.registerPartial("linkColumns",N),C.registerPartial("logo",G),C.registerPartial("logoCOALandscape",B),C.registerPartial("logoCOALandscape2Lines",W),C.registerPartial("mainContainerWrapper",Q),C.registerPartial("metaDcTerms",j),C.registerPartial("metaOpenGraph",J),C.registerPartial("modal",Y),C.registerPartial("navbar",U),C.registerPartial("pageLayout",$),C.registerPartial("contentPageWithForm",z),C.registerPartial("contentPageWithSideNavigation",X),C.registerPartial("fullWidthLandingPage",K),C.registerPartial("pagination",C2),C.registerPartial("promotionalPanel",e2),C.registerPartial("quickexit",i2),C.registerPartial("searchInput",a2),C.registerPartial("select",t2),C.registerPartial("sidenav",l2),C.registerPartial("sidenavWrapper",s2),C.registerPartial("skipLinks",n2),C.registerPartial("spinner",o2),C.registerPartial("table",r2),C.registerPartial("tabs",d2),C.registerPartial("tag",c2),C.registerPartial("textarea",f2),C.registerPartial("textbox",p2),C.registerPartial("typography",h2),C.registerPartial("video",u2)}typeof Handlebars!="undefined"&&d(Handlebars);var m2=!1;function g2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(m2?console.log("HandleBars Helpers And Partials already loaded, loading again"):m2=!0,r(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&g2(Handlebars);})();
