...
`;var m=`<dl class="qld-content-dates">
  <dt>Last updated:</dt>
...
`;var Z=`<a class="qld-dir-link {{class}}"
    {{#if id}}id="{{id}}"{{/if}}
    href="{{href}}" 
    target="{{target}}" 
