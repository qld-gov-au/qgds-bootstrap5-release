...
`;var R=`<header class="qld-header" role="banner">
...
<!-- HEADER END -->`;var D=`{{! Image template }}
{{#*inline "imageTag"}}
...
{{#if src}}
  ...
  {{else}}
    {{> imageTag}}
  {{/if}}
{{/if}}`;var A=`<div class="alert {{variantClass}} {{customClass}}" role="alert" 
...
{{> footer footer}}`;var I=`<!-- DCTERMS https://www.dublincore.org/specifications/dublin-core/dcmi-terms/-->
{{#if dcTerms}}
...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`;var N=`<!-- Example button to trigger the modal -->
...
</div>`;var G=`<!-- QGDS Partial: Primary navigation -->
...
<!-- MAIN NAVIGATION END -->`;var Q=`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</section>`;var W=`<!-- QGDS Component: Loading Quick exit -->
...
`;var U=`<div class="qld-side-navigation">
...
`;var z=`<!-- QGDS Component: Loading Spinner -->
...
</section>`;var C2=`<!-- QGDS Component: Tag -->
...
`;var e2=`<!-- QGDS Component: Textarea -->
...
<textarea id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    aria-required="true" {{/if}}></textarea>`;var t2=`<!-- QGDS Component: Textbox -->
...
<input id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    isRequired}}required aria-required="true" {{/if}} />`;var i2="<!-- QGDS Partial: typography -->";var a2=`<!-- QGDS Component: Video -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",f),C.registerPartial("banner",p),C.registerPartial("blockquote",u),C.registerPartial("breadcrumbs",h),C.registerPartial("breadcrumbsWrapper",L),C.registerPartial("button",v),C.registerPartial("callToAction",m),C.registerPartial("callout",g),C.registerPartial("card",b),C.registerPartial("contentFooter",V),C.registerPartial("contentFooterWrapper",H),C.registerPartial("contentWrapper",M),C.registerPartial("correctincorrect",Z),C.registerPartial("dateinput",w),C.registerPartial("directionLinks",_),C.registerPartial("footer",y),C.registerPartial("footerForgov",k),C.registerPartial("formcheck",q),C.registerPartial("fullPage",x),C.registerPartial("globalAlert",T),C.registerPartial("head",S),C.registerPartial("header",R),C.registerPartial("image",D),C.registerPartial("inpageAlert",A),C.registerPartial("inpagenav",P),C.registerPartial("linkColumns",O),C.registerPartial("mainContainerWrapper",E),C.registerPartial("metaDcTerms",I),C.registerPartial("metaOpenGraph",F),C.registerPartial("modal",N),C.registerPartial("navbar",G),C.registerPartial("pageLayout",Q),C.registerPartial("pagination",B),C.registerPartial("promotionalPanel",J),C.registerPartial("quickexit",W),C.registerPartial("searchInput",Y),C.registerPartial("select",j),C.registerPartial("sidenav",U),C.registerPartial("sidenavWrapper",$),C.registerPartial("spinner",z),C.registerPartial("table",X),C.registerPartial("tabs",K),C.registerPartial("tag",C2),C.registerPartial("textarea",e2),C.registerPartial("textbox",t2),C.registerPartial("typography",i2),C.registerPartial("video",a2)}typeof Handlebars!="undefined"&&d(Handlebars);var l2=!1;function o2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(l2?console.log("HandleBars Helpers And Partials already loaded, loading again"):l2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&o2(Handlebars);})();
