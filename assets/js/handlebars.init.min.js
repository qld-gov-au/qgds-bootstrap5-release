...
</html>`;var V=`<dl class="qld-content-dates">
  <dt>Last updated:</dt>
  <dd>{{formatDateOrToday lastUpdated }}</dd>
</dl>`;var H="";var M=`<!-- QGDS Component: Date input -->
...
<a class="qld-dir-link {{class}}" 
  ...
  {{{label}}}
  <span class="icon" aria-hidden="true"></span>
</a>`;var _=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
...
</footer>`;var w=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
  <!-- Footer content container -->
    <div class="container">
        <div class="row">
            <div class="col title">
  ...
  {{/each}}
  `;var k=`<!-- QGDS Component: Global Alert -->
...
{{/inline}}`;var R=`<!-- DCTERMS https://www.dublincore.org/specifications/dublin-core/dcmi-terms/-->
{{#if dcTerms}}
...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`;var O=`<!-- Example button to trigger the modal -->
...
</nav>`;var I=`<section class="qld-promo-panel {{#ifCond type '==' 'indent-text'}}indent{{/ifCond}} {{#ifCond type '==' 'indent-img'}}indent{{/ifCond}} {{type}}">
...
</section>`;var N=`<!-- QGDS Component: Loading Quick exit -->
...
</div>`;var B=`<!-- QGDS Component: Loading Spinner -->
...
</section>`;var Y=`<!-- QGDS Component: Tag -->
...
<textarea id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    aria-required="true" {{/if}}></textarea>`;var U=`<!-- QGDS Component: Textbox -->
...
<input id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    isRequired}}required aria-required="true" {{/if}} />`;var $="<!-- QGDS Partial: typography -->";var z=`<!-- QGDS Component: Video -->
...
</div>`;var K=`<div class="container qld-content-footer">
    {{> @partial-block }}
</div>`;var C2=`<!-- Content Wrapper -->
...
</html>`;var t2=`{{> globalAlert globalAlert}}
{{> header header}}
{{> navbar navbar}}
<main>
  {{#>breadcrumbsWrapper}}
...
{{> footer footer}}`;var i2=`<!-- Side Nav -->
<div class="col-12 col-lg-3 pe-lg-0 order-last order-lg-first mt-5 mt-lg-0">
  {{> @partial-block }}
</div>
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",f),C.registerPartial("banner",p),C.registerPartial("blockquote",u),C.registerPartial("breadcrumbs",h),C.registerPartial("button",L),C.registerPartial("callToAction",v),C.registerPartial("callout",m),C.registerPartial("card",g),C.registerPartial("containerLayout",b),C.registerPartial("contentFooter",V),C.registerPartial("correctincorrect",H),C.registerPartial("dateinput",M),C.registerPartial("directionLinks",Z),C.registerPartial("footer",_),C.registerPartial("footerForgov",w),C.registerPartial("formcheck",y),C.registerPartial("globalAlert",k),C.registerPartial("head",q),C.registerPartial("header",x),C.registerPartial("inpageAlert",T),C.registerPartial("inpagenav",S),C.registerPartial("linkColumns",D),C.registerPartial("metaDcTerms",R),C.registerPartial("metaOpenGraph",A),C.registerPartial("modal",O),C.registerPartial("navbar",P),C.registerPartial("pagination",E),C.registerPartial("promotionalPanel",I),C.registerPartial("quickexit",N),C.registerPartial("searchInput",F),C.registerPartial("select",G),C.registerPartial("sidenav",Q),C.registerPartial("spinner",B),C.registerPartial("table",J),C.registerPartial("tabs",W),C.registerPartial("tag",Y),C.registerPartial("textarea",j),C.registerPartial("textbox",U),C.registerPartial("typography",$),C.registerPartial("video",z),C.registerPartial("breadcrumbsWrapper",X),C.registerPartial("contentFooterWrapper",K),C.registerPartial("contentWrapper",C2),C.registerPartial("fullPage",e2),C.registerPartial("mainContainerWrapper",t2),C.registerPartial("sidenavWrapper",i2)}typeof Handlebars!="undefined"&&d(Handlebars);var a2=!1;function l2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(a2?console.log("HandleBars Helpers And Partials already loaded, loading again"):a2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&l2(Handlebars);})();
