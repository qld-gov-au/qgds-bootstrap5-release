...
</header>`;var A=`<div class="qld-header__brand">
    <a href="{{url}}">
...
</div>`;var O=`<svg class="qld-icon-{{size}}"{{#if ariaLabel}} aria-label="{{ariaLabel}}"{{/if}}{{#if ariaHidden}} aria-hidden="{{ariaHidden}}"{{/if}}>
...
</nav>`;var $=`<section class="qld-promo-panel {{#ifCond type '==' 'indent-text'}}indent{{/ifCond}} {{#ifCond type '==' 'indent-img'}}indent{{/ifCond}} {{type}}">
...
</section>`;var z=`<!-- QGDS Component: Loading Quick exit -->
...
`;var C2=`<div class="qld-side-navigation">
...
`;var i2=`<nav class="qld-skip-links" aria-label="skip to content links">
  {{#each skipLinks}}
...
<textarea id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    aria-required="true" {{/if}}></textarea>`;var n2=`<!-- QGDS Component: Textbox -->
...
<input id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    isRequired}}required aria-required="true" {{/if}} />`;var r2="<!-- QGDS Partial: typography -->";var d2=`<!-- QGDS Component: Video -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",f),C.registerPartial("banner",p),C.registerPartial("blockquote",h),C.registerPartial("breadcrumbs",u),C.registerPartial("breadcrumbsWrapper",v),C.registerPartial("button",m),C.registerPartial("callToAction",g),C.registerPartial("callout",L),C.registerPartial("card",b),C.registerPartial("contentFooter",V),C.registerPartial("contentFooterWrapper",M),C.registerPartial("contentWrapper",w),C.registerPartial("correctincorrect",H),C.registerPartial("dateinput",Z),C.registerPartial("directionLinks",_),C.registerPartial("footer",k),C.registerPartial("footerForgov",x),C.registerPartial("formcheck",q),C.registerPartial("fullPage",y),C.registerPartial("globalAlert",T),C.registerPartial("head",S),C.registerPartial("header",R),C.registerPartial("headerBrand",A),C.registerPartial("icon",O),C.registerPartial("image",D),C.registerPartial("inpageAlert",P),C.registerPartial("inpagenav",E),C.registerPartial("linkColumns",I),C.registerPartial("logo",N),C.registerPartial("logoCOALandscape",F),C.registerPartial("logoCOALandscape2Lines",G),C.registerPartial("mainContainerWrapper",B),C.registerPartial("metaDcTerms",Q),C.registerPartial("metaOpenGraph",J),C.registerPartial("modal",W),C.registerPartial("navbar",Y),C.registerPartial("pageLayout",j),C.registerPartial("pagination",U),C.registerPartial("promotionalPanel",$),C.registerPartial("quickexit",z),C.registerPartial("searchInput",X),C.registerPartial("select",K),C.registerPartial("sidenav",C2),C.registerPartial("sidenavWrapper",e2),C.registerPartial("skipLinks",i2),C.registerPartial("spinner",a2),C.registerPartial("table",t2),C.registerPartial("tabs",s2),C.registerPartial("tag",l2),C.registerPartial("textarea",o2),C.registerPartial("textbox",n2),C.registerPartial("typography",r2),C.registerPartial("video",d2)}typeof Handlebars!="undefined"&&d(Handlebars);var c2=!1;function f2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(c2?console.log("HandleBars Helpers And Partials already loaded, loading again"):c2=!0,r(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&f2(Handlebars);})();
