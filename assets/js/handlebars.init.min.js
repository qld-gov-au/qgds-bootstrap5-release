"use strict";(()=>{function n(C){C.registerHelper("contains",function(t,i,a){return t=C.escapeExpression(t),i=C.escapeExpression(i),i.indexOf(t)>-1?a.fn(this):a.inverse(this)}),C.registerHelper("ifCond",function(t,i,a,e){switch(i){case"==":return t==a?e.fn(this):e.inverse(this);case"===":return t===a?e.fn(this):e.inverse(this);case"!=":return t!=a?e.fn(this):e.inverse(this);case"!==":return t!==a?e.fn(this):e.inverse(this);case"<":return t<a?e.fn(this):e.inverse(this);case"<=":return t<=a?e.fn(this):e.inverse(this);case">":return t>a?e.fn(this):e.inverse(this);case">=":return t>=a?e.fn(this):e.inverse(this);case"&&":return t&&a?e.fn(this):e.inverse(this);case"||":return t||a?e.fn(this):e.inverse(this);case"contains":return typeof t=="string"&&typeof a=="string"?t.toLowerCase().indexOf(a.toLowerCase())>=0?e.fn(this):e.inverse(this):e.inverse(this);default:return e.inverse(this)}}),C.registerHelper("isType",function(t,i,a){return t===i?a.fn(this):a.inverse(this)}),C.registerHelper("ifAny",function(...t){let i=t.pop();return t.some(a=>!!a)?i.fn(this):i.inverse(this)}),C.registerHelper("now",function(){return new Date().toISOString()}),C.registerHelper("formatDate",function(t,i,a){let e;if(t&&(e=new Date(t)),isNaN(e)&&i&&(e=new Date(i)),isNaN(e))return"Invalid Date";var o=["January","February","March","April","May","June","July","August","September","October","November","December"],r=e.getDate(),l=o[e.getMonth()],s=e.getFullYear();switch(a){case"YYYY":return`${s}`;case"MMMM YYYY":return`${l} ${s}`;default:return`${r} ${l} ${s}`}}),C.registerHelper("formatDateOrToday",function(t,i){let a=t||new Date().toISOString();return C.helpers.formatDate(t,a,i)}),C.registerHelper("formatDuration",function(t,i){if(!t)return"";if(typeof t=="string"&&i!=="long")return t;let a="",e=[],o,r,l;if(typeof t=="string"){let s=t.split(":");l=s[0],s.length==2?[r="",l=""]=s:s.length==3&&([o="",r="",l=""]=s)}else[o="",r="",l=""]=t;return i==="long"?(o>0&&e.push(`${o} hour${o>1?"s":""}`),r>0&&e.push(`${r} minute${r>1?"s":""}`),l>0&&e.push(`${l} second${l>1?"s":""}`),a=e.join(" ")):(o>0&&e.push(o.toString().padStart(2,0)),e.push(r.toString().padStart(2,0)),e.push(l.toString().padStart(2,0)),a=e.join(":")),a})}typeof Handlebars!="undefined"&&n(Handlebars);var c=`<!-- QGDS Component: Accordion -->
...
</div>`;var p=`<!-- QGDS Component: Blockquote -->
...
`;var g=`<dl class="qld-content-dates">
  <dt>Last updated:</dt>
  <dd>{{formatDateOrToday lastUpdated }}</dd>
</dl>`;var V=`<div class="container qld-content-footer">
  <div class="row">
    {{> @partial-block }}
  </div>
</div>`;var H=`<!-- Content Wrapper -->
<div class="col-12 col-lg-8 ps-lg-64 qld-content-body" id="content">
  {{#if title}}<h1>{{title}}</h1>{{/if}}
  {{> @partial-block }}
</div>
`;var M="";var _=`<!-- QGDS Component: Date input -->
...
`;var b=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
...
</footer>`;var Z=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
  <!-- Footer content container -->
    <div class="container">
        <div class="row">
            <div class="col title">
...
</html>`;var q=`<!-- QGDS Component: Global Alert -->
...
<!-- HEADER END -->`;var T=`<div class="alert {{variantClass}} {{customClass}}" role="alert">
    {{#if heading}}
    <div class="alert-heading" role="heading">{{{ heading }}}</div>
    {{/if}}
    {{{ content }}}
</div>`;var S=`<!-- QGDS Partial: inpage-nav -->
...
{{> footer footer}}`;var D=`<!-- DCTERMS https://www.dublincore.org/specifications/dublin-core/dcmi-terms/-->
{{#if dcTerms}}
...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`;var A=`<!-- Example button to trigger the modal -->
...
</div>`;var P=`<!-- QGDS Partial: Primary navigation -->
...
<nav aria-label="{{ arialabel }}">
    ...
    {{/ifCond}}
{{/with}}
`;var F=`<!-- QGDS Component: Loading Quick exit -->
...
`;var Q=`<div class="qld-side-navigation">
...
`;var B=`<!-- QGDS Component: Loading Spinner -->
...
<textarea id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    aria-required="true" {{/if}}></textarea>`;var $=`<!-- QGDS Component: Textbox -->
...
<input id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    isRequired}}required aria-required="true" {{/if}} />`;var U="<!-- QGDS Partial: typography -->";var z=`<!-- QGDS Component: Video -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("banner",f),C.registerPartial("blockquote",p),C.registerPartial("breadcrumbs",u),C.registerPartial("breadcrumbsWrapper",h),C.registerPartial("button",L),C.registerPartial("callout",v),C.registerPartial("card",m),C.registerPartial("contentFooter",g),C.registerPartial("contentFooterWrapper",V),C.registerPartial("contentWrapper",H),C.registerPartial("correctincorrect",M),C.registerPartial("dateinput",_),C.registerPartial("footer",b),C.registerPartial("footerForgov",Z),C.registerPartial("formcheck",w),C.registerPartial("fullPage",y),C.registerPartial("globalAlert",q),C.registerPartial("head",k),C.registerPartial("header",x),C.registerPartial("inpageAlert",T),C.registerPartial("inpagenav",S),C.registerPartial("mainContainerWrapper",R),C.registerPartial("metaDcTerms",D),C.registerPartial("metaOpenGraph",O),C.registerPartial("modal",A),C.registerPartial("navbar",P),C.registerPartial("pagination",E),C.registerPartial("promotionalPanel",I),C.registerPartial("quickexit",F),C.registerPartial("searchInput",N),C.registerPartial("select",G),C.registerPartial("sidenav",Q),C.registerPartial("sidenavWrapper",J),C.registerPartial("spinner",B),C.registerPartial("table",W),C.registerPartial("tag",Y),C.registerPartial("textarea",j),C.registerPartial("textbox",$),C.registerPartial("typography",U),C.registerPartial("video",z)}typeof Handlebars!="undefined"&&d(Handlebars);var X=!1;function K(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(X?console.log("HandleBars Helpers And Partials already loaded, loading again"):X=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&K(Handlebars);})();
