...
`;var V=`<div class="container qld-content-footer">
  <div class="row">
    {{> @partial-block }}
  </div>
...
`;var k=`{{! valid class values are: up, down, left, right}}
...
</header>`;var D=`<div class="qld-header__brand">
    <a href="{{url}}">
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",p),C.registerPartial("banner",f),C.registerPartial("blockquote",h),C.registerPartial("breadcrumbs",u),C.registerPartial("breadcrumbsWrapper",m),C.registerPartial("button",v),C.registerPartial("callToAction",g),C.registerPartial("callout",b),C.registerPartial("card",L),C.registerPartial("containerLayout",w),C.registerPartial("contentFooter",M),C.registerPartial("contentFooterWrapper",V),C.registerPartial("contentWrapper",H),C.registerPartial("correctincorrect",Z),C.registerPartial("dateinput",_),C.registerPartial("directionLinks",k),C.registerPartial("footer",y),C.registerPartial("footerForgov",x),C.registerPartial("formcheck",q),C.registerPartial("fullPage",T),C.registerPartial("globalAlert",S),C.registerPartial("head",P),C.registerPartial("header",A),C.registerPartial("headerBrand",D),C.registerPartial("icon",O),C.registerPartial("image",R),C.registerPartial("inpageAlert",I),C.registerPartial("inpagenav",E),C.registerPartial("linkColumns",F),C.registerPartial("logo",N),C.registerPartial("logoCOALandscape",G),C.registerPartial("logoCOALandscape2Lines",B),C.registerPartial("mainContainerWrapper",W),C.registerPartial("metaDcTerms",Q),C.registerPartial("metaOpenGraph",j),C.registerPartial("modal",J),C.registerPartial("navbar",Y),C.registerPartial("pageLayout",U),C.registerPartial("contentPageWithForm",$),C.registerPartial("contentPageWithSideNavigation",z),C.registerPartial("fullWidthLandingPage",X),C.registerPartial("pagination",K),C.registerPartial("promotionalPanel",C2),C.registerPartial("quickexit",e2),C.registerPartial("searchInput",i2),C.registerPartial("select",a2),C.registerPartial("sidenav",t2),C.registerPartial("sidenavWrapper",s2),C.registerPartial("skipLinks",l2),C.registerPartial("spinner",o2),C.registerPartial("table",n2),C.registerPartial("tabs",r2),C.registerPartial("tag",d2),C.registerPartial("textarea",c2),C.registerPartial("textbox",p2),C.registerPartial("typography",f2),C.registerPartial("video",h2)}typeof Handlebars!="undefined"&&d(Handlebars);var u2=!1;function m2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(u2?console.log("HandleBars Helpers And Partials already loaded, loading again"):u2=!0,r(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&m2(Handlebars);})();
