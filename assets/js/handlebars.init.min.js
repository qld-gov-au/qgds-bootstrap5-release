...
`;var _="";var y=`<!-- QGDS Component: Date input -->
...
`;var q=`{{! valid class values are: up, down, left, right}}
...
{{/if}}`;var w=`<div class="col-12 col-md-6 col-lg-12">
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",p),C.registerPartial("banner",f),C.registerPartial("blockquote",u),C.registerPartial("breadcrumbs",h),C.registerPartial("breadcrumbsWrapper",L),C.registerPartial("button",m),C.registerPartial("callToAction",v),C.registerPartial("callout",g),C.registerPartial("card",b),C.registerPartial("containerLayout",H),C.registerPartial("contentFooter",V),C.registerPartial("contentFooterWrapper",M),C.registerPartial("contentWrapper",Z),C.registerPartial("correctincorrect",_),C.registerPartial("dateinput",y),C.registerPartial("directionLinks",q),C.registerPartial("customLinks",k),C.registerPartial("feedbackForm",w),C.registerPartial("followLinks",x),C.registerPartial("footer",T),C.registerPartial("formcheck",S),C.registerPartial("fullPage",P),C.registerPartial("globalAlert",A),C.registerPartial("head",O),C.registerPartial("header",R),C.registerPartial("icon",D),C.registerPartial("image",I),C.registerPartial("inpageAlert",E),C.registerPartial("inpagenav",F),C.registerPartial("link",N),C.registerPartial("linkColumns",G),C.registerPartial("logo",Q),C.registerPartial("logoCOALandscape",W),C.registerPartial("logoCOALandscape2Lines",j),C.registerPartial("mainContainerWrapper",J),C.registerPartial("metaDcTerms",B),C.registerPartial("metaOpenGraph",Y),C.registerPartial("modal",U),C.registerPartial("navbar",$),C.registerPartial("pageLayout",z),C.registerPartial("contentPageWithForm",X),C.registerPartial("contentPageWithSideNavigation",K),C.registerPartial("fullWidthLandingPage",C2),C.registerPartial("pagination",e2),C.registerPartial("promotionalPanel",i2),C.registerPartial("quickexit",t2),C.registerPartial("searchInput",a2),C.registerPartial("select",l2),C.registerPartial("sidenav",o2),C.registerPartial("sidenavWrapper",r2),C.registerPartial("skipLinks",s2),C.registerPartial("spinner",n2),C.registerPartial("table",d2),C.registerPartial("tabs",c2),C.registerPartial("tag",p2),C.registerPartial("textarea",f2),C.registerPartial("textbox",u2),C.registerPartial("typography",h2),C.registerPartial("video",L2)}typeof Handlebars!="undefined"&&d(Handlebars);var m2=!1;function v2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(m2?console.log("HandleBars Helpers And Partials already loaded, loading again"):m2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&v2(Handlebars);})();
