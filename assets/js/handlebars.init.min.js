"use strict";(()=>{function n(C){C.registerHelper("contains",function(t,a,i){return t=C.escapeExpression(t),a=C.escapeExpression(a),a.indexOf(t)>-1?i.fn(this):i.inverse(this)}),C.registerHelper("ifCond",function(t,a,i,e){switch(a){case"==":return t==i?e.fn(this):e.inverse(this);case"===":return t===i?e.fn(this):e.inverse(this);case"!=":return t!=i?e.fn(this):e.inverse(this);case"!==":return t!==i?e.fn(this):e.inverse(this);case"<":return t<i?e.fn(this):e.inverse(this);case"<=":return t<=i?e.fn(this):e.inverse(this);case">":return t>i?e.fn(this):e.inverse(this);case">=":return t>=i?e.fn(this):e.inverse(this);case"&&":return t&&i?e.fn(this):e.inverse(this);case"||":return t||i?e.fn(this):e.inverse(this);case"contains":return typeof t=="string"&&typeof i=="string"?t.toLowerCase().indexOf(i.toLowerCase())>=0?e.fn(this):e.inverse(this):e.inverse(this);default:return e.inverse(this)}}),C.registerHelper("isType",function(t,a,i){return t===a?i.fn(this):i.inverse(this)}),C.registerHelper("ifAny",function(...t){let a=t.pop();return t.some(i=>!!i)?a.fn(this):a.inverse(this)}),C.registerHelper("now",function(){return new Date().toISOString()}),C.registerHelper("formatDate",function(t,a,i){let e;if(t&&(e=new Date(t)),isNaN(e)&&a&&(e=new Date(a)),isNaN(e))return"Invalid Date";var r=["January","February","March","April","May","June","July","August","September","October","November","December"],s=e.getDate(),l=r[e.getMonth()],o=e.getFullYear();switch(i){case"YYYY":return`${o}`;case"MMMM YYYY":return`${l} ${o}`;default:return`${s} ${l} ${o}`}}),C.registerHelper("formatDateOrToday",function(t,a){let i=t||new Date().toISOString();return C.helpers.formatDate(t,i,a)}),C.registerHelper("formatDuration",function(t,a){if(!t)return"";if(typeof t=="string"&&a!=="long")return t;let i="",e=[],{hours:r="",minutes:s="",seconds:l=""}=t;if(typeof t=="string"){let o=t.split(":");l=o[0],o.length==2?[s="",l=""]=o:o.length==3&&([r="",s="",l=""]=o)}return a==="long"?(r>0&&e.push(`${r} hour${r>1?"s":""}`),s>0&&e.push(`${s} minute${s>1?"s":""}`),l>0&&e.push(`${l} second${l>1?"s":""}`),i=e.join(" ")):(r>0&&e.push(r.toString().padStart(2,0)),e.push(s.toString().padStart(2,0)),e.push(l.toString().padStart(2,0)),i=e.join(":")),i})}typeof Handlebars!="undefined"&&n(Handlebars);var c=`<!-- QGDS Component: Accordion -->
...
</div>`;var F=`<!-- QGDS Component: Select -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("banner",f),C.registerPartial("blockquote",p),C.registerPartial("breadcrumbs",u),C.registerPartial("breadcrumbsWrapper",h),C.registerPartial("button",L),C.registerPartial("callout",v),C.registerPartial("card",g),C.registerPartial("contentFooter",m),C.registerPartial("contentFooterWrapper",V),C.registerPartial("contentWrapper",H),C.registerPartial("correctincorrect",M),C.registerPartial("dateinput",b),C.registerPartial("footer",Z),C.registerPartial("footerForgov",_),C.registerPartial("formcheck",w),C.registerPartial("fullPage",q),C.registerPartial("globalAlert",y),C.registerPartial("head",x),C.registerPartial("header",k),C.registerPartial("inpageAlert",T),C.registerPartial("inpagenav",S),C.registerPartial("mainContainerWrapper",R),C.registerPartial("metaDcTerms",D),C.registerPartial("metaOpenGraph",O),C.registerPartial("modal",A),C.registerPartial("navbar",P),C.registerPartial("pagination",E),C.registerPartial("quickexit",I),C.registerPartial("searchInput",N),C.registerPartial("select",F),C.registerPartial("sidenav",G),C.registerPartial("sidenavWrapper",Q),C.registerPartial("spinner",J),C.registerPartial("table",B),C.registerPartial("tag",W),C.registerPartial("textarea",Y),C.registerPartial("textbox",j),C.registerPartial("typography",$),C.registerPartial("video",U)}typeof Handlebars!="undefined"&&d(Handlebars);var z=!1;function X(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(z?console.log("HandleBars Helpers And Partials already loaded, loading again"):z=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&X(Handlebars);})();
