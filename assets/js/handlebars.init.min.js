...
`;function d(e){e.registerPartial("accordion",c),e.registerPartial("backToTop",f),e.registerPartial("banner",p),e.registerPartial("blockquote",u),e.registerPartial("breadcrumbs",m),e.registerPartial("breadcrumbsWrapper",g),e.registerPartial("button",h),e.registerPartial("callToAction",v),e.registerPartial("callout",b),e.registerPartial("card",L),e.registerPartial("containerLayout",k),e.registerPartial("contentFooter",q),e.registerPartial("contentFooterWrapper",y),e.registerPartial("contentWrapper",M),e.registerPartial("correctincorrect",x),e.registerPartial("dateinput",w),e.registerPartial("directionLinks",V),e.registerPartial("customLinks",H),e.registerPartial("feedbackForm",Z),e.registerPartial("followLinks",T),e.registerPartial("footer",S),e.registerPartial("formcheck",P),e.registerPartial("fullPage",O),e.registerPartial("globalAlert",A),e.registerPartial("head",R),e.registerPartial("header",D),e.registerPartial("headerBrand",_),e.registerPartial("icon",I),e.registerPartial("image",E),e.registerPartial("inpageAlert",F),e.registerPartial("inpagenav",N),e.registerPartial("link",G),e.registerPartial("linkColumns",W),e.registerPartial("logo",B),e.registerPartial("logoCOALandscape",j),e.registerPartial("logoCOALandscape2Lines",Q),e.registerPartial("mainContainerWrapper",J),e.registerPartial("metaDcTerms",Y),e.registerPartial("metaOpenGraph",U),e.registerPartial("modal",$),e.registerPartial("navbar",z),e.registerPartial("pageLayout",X),e.registerPartial("contentPageWithForm",K),e.registerPartial("contentPageWithSideNavigation",e5),e.registerPartial("fullWidthLandingPage",i5),e.registerPartial("pagination",a5),e.registerPartial("promotionalPanel",t5),e.registerPartial("quickexit",s5),e.registerPartial("searchInput",l5),e.registerPartial("select",n5),e.registerPartial("sidenav",o5),e.registerPartial("sidenavWrapper",C5),e.registerPartial("skipLinks",r5),e.registerPartial("spinner",d5),e.registerPartial("table",c5),e.registerPartial("tabs",f5),e.registerPartial("tag",p5),e.registerPartial("textarea",u5),e.registerPartial("textbox",m5),e.registerPartial("typography",g5),e.registerPartial("video",h5)}typeof Handlebars!="undefined"&&d(Handlebars);var v5=!1;function b5(e){typeof e=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof e!="undefined"?(v5?console.log("HandleBars Helpers And Partials already loaded, loading again"):v5=!0,r(e),d(e)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&b5(Handlebars);})();
