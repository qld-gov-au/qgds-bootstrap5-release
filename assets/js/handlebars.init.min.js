"use strict";(()=>{function m2(C,t,i,e){switch(t){case"==":return C==i?e.fn(this):e.inverse(this);case"===":return C===i?e.fn(this):e.inverse(this);case"!=":return C!=i?e.fn(this):e.inverse(this);case"!==":return C!==i?e.fn(this):e.inverse(this);case"<":return C<i?e.fn(this):e.inverse(this);case"<=":return C<=i?e.fn(this):e.inverse(this);case">":return C>i?e.fn(this):e.inverse(this);case">=":return C>=i?e.fn(this):e.inverse(this);case"&&":return C&&i?e.fn(this):e.inverse(this);case"||":return C||i?e.fn(this):e.inverse(this);case"contains":return typeof C=="string"&&typeof i=="string"?C.toLowerCase().indexOf(i.toLowerCase())>=0?e.fn(this):e.inverse(this):e.inverse(this);default:return e.inverse(this)}}function n(C){C.registerHelper("contains",function(t,i,e){return t=C.escapeExpression(t),i=C.escapeExpression(i),i.indexOf(t)>-1?e.fn(this):e.inverse(this)}),C.registerHelper("ifCond",m2),C.registerHelper("isType",function(t,i,e){return t===i?e.fn(this):e.inverse(this)}),C.registerHelper("ifAny",function(...t){let i=t.pop();return t.some(e=>!!e)?i.fn(this):i.inverse(this)}),C.registerHelper("now",function(){return new Date().toISOString()}),C.registerHelper("formatDate",function(t,i,e){let a;if(t&&(a=new Date(t)),isNaN(a)&&i&&(a=new Date(i)),isNaN(a))return"Invalid Date";var l=["January","February","March","April","May","June","July","August","September","October","November","December"],r=a.getDate(),s=l[a.getMonth()],o=a.getFullYear();switch(e){case"YYYY":return`${o}`;case"MMMM YYYY":return`${s} ${o}`;default:return`${r} ${s} ${o}`}}),C.registerHelper("formatDateOrToday",function(t,i){let e=t||new Date().toISOString();return C.helpers.formatDate(t,e,i)}),C.registerHelper("formatDuration",function(t,i){if(!t)return"";if(typeof t=="string"&&i!=="long")return t;let e="",a=[],l,r,s;if(typeof t=="string"){let o=t.split(":");s=o[0],o.length==2?[r="",s=""]=o:o.length==3&&([l="",r="",s=""]=o)}else[l="",r="",s=""]=t;return i==="long"?(l>0&&a.push(`${l} hour${l>1?"s":""}`),r>0&&a.push(`${r} minute${r>1?"s":""}`),s>0&&a.push(`${s} second${s>1?"s":""}`),e=a.join(" ")):(l>0&&a.push(l.toString().padStart(2,0)),a.push(r.toString().padStart(2,0)),a.push(s.toString().padStart(2,0)),e=a.join(":")),e}),C.registerHelper("isdefined",function(t,i){return t!==void 0&&t!==""?t:i}),C.registerHelper("getClassNames",function(t,i){let e=t.split(",").map(l=>l.trim()),a=[];for(let l=0;l<e.length;l++){let r=e[l];if(i){for(let s=0;s<i.length;s++)if(i[s][r]===!0){a.push(r);break}}}return a.length>0?a.join(" "):""}),C.registerHelper("join",function(t,i){return(!i||typeof i!="string")&&(i=" "),Array.isArray(t)?t.join(i):t}),C.registerHelper("toCamelCase",function(t){return typeof t!="string"?t:t.toLowerCase().replace(/(?:^\w|[A-Z]|\b\w|\s+)/g,(i,e)=>e===0?i.toLowerCase():i.toUpperCase()).replace(/\s+/g,"")})}typeof Handlebars!="undefined"&&n(Handlebars);var c=`<!-- QGDS Component: Accordion -->
...
<!-- HEADER END -->`;var O=`<svg class="qld-icon-{{size}}"{{#if ariaLabel}} aria-label="{{ariaLabel}}"{{/if}}{{#if ariaHidden}} aria-hidden="{{ariaHidden}}"{{/if}}>
...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`;var Y=`<!-- Example button to trigger the modal -->
...
`;var s2=`<nav class="qld-skip-links" aria-label="skip to content links">
  {{#each skipLinks}}
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",p),C.registerPartial("banner",f),C.registerPartial("blockquote",h),C.registerPartial("breadcrumbs",L),C.registerPartial("breadcrumbsWrapper",u),C.registerPartial("button",m),C.registerPartial("callToAction",v),C.registerPartial("callout",g),C.registerPartial("card",V),C.registerPartial("containerLayout",H),C.registerPartial("contentFooter",M),C.registerPartial("contentFooterWrapper",b),C.registerPartial("contentWrapper",Z),C.registerPartial("correctincorrect",w),C.registerPartial("dateinput",_),C.registerPartial("directionLinks",y),C.registerPartial("footer",k),C.registerPartial("footerForgov",q),C.registerPartial("formcheck",x),C.registerPartial("fullPage",T),C.registerPartial("globalAlert",S),C.registerPartial("head",A),C.registerPartial("header",P),C.registerPartial("icon",O),C.registerPartial("image",D),C.registerPartial("inpageAlert",R),C.registerPartial("inpagenav",I),C.registerPartial("link",E),C.registerPartial("linkColumns",F),C.registerPartial("logo",N),C.registerPartial("logoCOALandscape",G),C.registerPartial("logoCOALandscape2Lines",B),C.registerPartial("mainContainerWrapper",Q),C.registerPartial("metaDcTerms",W),C.registerPartial("metaOpenGraph",j),C.registerPartial("modal",Y),C.registerPartial("navbar",J),C.registerPartial("pageLayout",U),C.registerPartial("contentPageWithForm",$),C.registerPartial("contentPageWithSideNavigation",z),C.registerPartial("homePage",X),C.registerPartial("pagination",K),C.registerPartial("promotionalPanel",C2),C.registerPartial("quickexit",e2),C.registerPartial("searchInput",i2),C.registerPartial("select",t2),C.registerPartial("sidenav",a2),C.registerPartial("sidenavWrapper",l2),C.registerPartial("skipLinks",s2),C.registerPartial("spinner",r2),C.registerPartial("table",o2),C.registerPartial("tabs",n2),C.registerPartial("tag",d2),C.registerPartial("textarea",c2),C.registerPartial("textbox",p2),C.registerPartial("typography",f2),C.registerPartial("video",h2)}typeof Handlebars!="undefined"&&d(Handlebars);var L2=!1;function u2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(L2?console.log("HandleBars Helpers And Partials already loaded, loading again"):L2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&u2(Handlebars);})();
