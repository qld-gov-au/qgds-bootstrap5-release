...
{{/if}}`;var R=`<div class="alert {{variantClass}} {{customClass}}" role="alert" 
    ...
    {{/if}}
    {{{ content }}}
</div>`;var I=`<!-- QGDS Partial: inpage-nav -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",p),C.registerPartial("banner",f),C.registerPartial("blockquote",h),C.registerPartial("breadcrumbs",u),C.registerPartial("breadcrumbsWrapper",L),C.registerPartial("button",v),C.registerPartial("callToAction",m),C.registerPartial("callout",g),C.registerPartial("card",V),C.registerPartial("containerLayout",H),C.registerPartial("contentFooter",M),C.registerPartial("contentFooterWrapper",b),C.registerPartial("contentWrapper",Z),C.registerPartial("correctincorrect",_),C.registerPartial("dateinput",w),C.registerPartial("directionLinks",y),C.registerPartial("footer",q),C.registerPartial("footerForgov",k),C.registerPartial("formcheck",x),C.registerPartial("fullPage",T),C.registerPartial("globalAlert",S),C.registerPartial("head",A),C.registerPartial("header",P),C.registerPartial("icon",D),C.registerPartial("image",O),C.registerPartial("inpageAlert",R),C.registerPartial("inpagenav",I),C.registerPartial("linkColumns",E),C.registerPartial("logo",F),C.registerPartial("logoCOALandscape",N),C.registerPartial("logoCOALandscape2Lines",G),C.registerPartial("mainContainerWrapper",Q),C.registerPartial("metaDcTerms",B),C.registerPartial("metaOpenGraph",W),C.registerPartial("modal",j),C.registerPartial("navbar",J),C.registerPartial("pageLayout",Y),C.registerPartial("contentPageWithForm",U),C.registerPartial("contentPageWithSideNavigation",$),C.registerPartial("homePage",z),C.registerPartial("pagination",X),C.registerPartial("promotionalPanel",K),C.registerPartial("quickexit",C2),C.registerPartial("searchInput",e2),C.registerPartial("select",t2),C.registerPartial("sidenav",i2),C.registerPartial("sidenavWrapper",a2),C.registerPartial("skipLinks",l2),C.registerPartial("spinner",o2),C.registerPartial("table",s2),C.registerPartial("tabs",r2),C.registerPartial("tag",n2),C.registerPartial("textarea",d2),C.registerPartial("textbox",c2),C.registerPartial("typography",p2),C.registerPartial("video",f2)}typeof Handlebars!="undefined"&&d(Handlebars);var h2=!1;function u2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(h2?console.log("HandleBars Helpers And Partials already loaded, loading again"):h2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&u2(Handlebars);})();
