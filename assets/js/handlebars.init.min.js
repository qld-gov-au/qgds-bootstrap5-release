"use strict";(()=>{function m2(C,a,i,e){switch(a){case"==":return C==i?e.fn(this):e.inverse(this);case"===":return C===i?e.fn(this):e.inverse(this);case"!=":return C!=i?e.fn(this):e.inverse(this);case"!==":return C!==i?e.fn(this):e.inverse(this);case"<":return C<i?e.fn(this):e.inverse(this);case"<=":return C<=i?e.fn(this):e.inverse(this);case">":return C>i?e.fn(this):e.inverse(this);case">=":return C>=i?e.fn(this):e.inverse(this);case"&&":return C&&i?e.fn(this):e.inverse(this);case"||":return C||i?e.fn(this):e.inverse(this);case"contains":return typeof C=="string"&&typeof i=="string"?C.toLowerCase().indexOf(i.toLowerCase())>=0?e.fn(this):e.inverse(this):e.inverse(this);default:return e.inverse(this)}}function r(C){C.registerHelper("contains",function(a,i,e){return a=C.escapeExpression(a),i=C.escapeExpression(i),i.indexOf(a)>-1?e.fn(this):e.inverse(this)}),C.registerHelper("ifCond",m2),C.registerHelper("isType",function(a,i,e){return a===i?e.fn(this):e.inverse(this)}),C.registerHelper("ifAny",function(...a){let i=a.pop();return a.some(e=>!!e)?i.fn(this):i.inverse(this)}),C.registerHelper("now",function(){return new Date().toISOString()}),C.registerHelper("formatDate",function(a,i,e){let t;if(a&&(t=new Date(a)),isNaN(t)&&i&&(t=new Date(i)),isNaN(t))return"Invalid Date";var l=["January","February","March","April","May","June","July","August","September","October","November","December"],n=t.getDate(),o=l[t.getMonth()],s=t.getFullYear();switch(e){case"YYYY":return`${s}`;case"MMMM YYYY":return`${o} ${s}`;default:return`${n} ${o} ${s}`}}),C.registerHelper("formatDateOrToday",function(a,i){let e=a||new Date().toISOString();return C.helpers.formatDate(a,e,i)}),C.registerHelper("formatDuration",function(a,i){if(!a)return"";if(typeof a=="string"&&i!=="long")return a;let e="",t=[],l,n,o;if(typeof a=="string"){let s=a.split(":");o=s[0],s.length==2?[n="",o=""]=s:s.length==3&&([l="",n="",o=""]=s)}else[l="",n="",o=""]=a;return i==="long"?(l>0&&t.push(`${l} hour${l>1?"s":""}`),n>0&&t.push(`${n} minute${n>1?"s":""}`),o>0&&t.push(`${o} second${o>1?"s":""}`),e=t.join(" ")):(l>0&&t.push(l.toString().padStart(2,0)),t.push(n.toString().padStart(2,0)),t.push(o.toString().padStart(2,0)),e=t.join(":")),e}),C.registerHelper("isdefined",function(a,i){return a!==void 0&&a!==""?a:i}),C.registerHelper("getClassNames",function(a,i){let e=a.split(",").map(l=>l.trim()),t=[];for(let l=0;l<e.length;l++){let n=e[l];if(i){for(let o=0;o<i.length;o++)if(i[o][n]===!0){t.push(n);break}}}return t.length>0?t.join(" "):""}),C.registerHelper("join",function(a,i){return(!i||typeof i!="string")&&(i=" "),Array.isArray(a)?a.join(i):a}),C.registerHelper("toCamelCase",function(a){return typeof a!="string"?a:a.toLowerCase().replace(/(?:^\w|[A-Z]|\b\w|\s+)/g,(i,e)=>e===0?i.toLowerCase():i.toUpperCase()).replace(/\s+/g,"")})}typeof Handlebars!="undefined"&&r(Handlebars);var c=`<!-- QGDS Component: Accordion -->
...
{{/if}}`;var q=`<div class="col-12 col-md-6 col-lg-12">
...
`;var o2=`<nav class="qld-skip-links" aria-label="skip to content links">
  ...
  {{/each}}
</nav>`;var n2=`<!-- QGDS Component: Loading Spinner -->
...
<input id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    isRequired}}required aria-required="true" {{/if}} />`;var f2="<!-- QGDS Partial: typography -->";var u2=`<!-- QGDS Component: Video -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",p),C.registerPartial("banner",f),C.registerPartial("blockquote",u),C.registerPartial("breadcrumbs",h),C.registerPartial("breadcrumbsWrapper",L),C.registerPartial("button",m),C.registerPartial("callToAction",v),C.registerPartial("callout",g),C.registerPartial("card",b),C.registerPartial("contentFooter",H),C.registerPartial("contentFooterWrapper",V),C.registerPartial("contentWrapper",M),C.registerPartial("correctincorrect",Z),C.registerPartial("dateinput",_),C.registerPartial("directionLinks",w),C.registerPartial("customLinks",y),C.registerPartial("feedbackForm",q),C.registerPartial("followLinks",k),C.registerPartial("footer",x),C.registerPartial("formcheck",T),C.registerPartial("fullPage",S),C.registerPartial("globalAlert",P),C.registerPartial("head",A),C.registerPartial("header",O),C.registerPartial("icon",R),C.registerPartial("image",D),C.registerPartial("inpageAlert",E),C.registerPartial("inpagenav",I),C.registerPartial("linkColumns",F),C.registerPartial("logo",G),C.registerPartial("logoCOALandscape",N),C.registerPartial("logoCOALandscape2Lines",Q),C.registerPartial("mainContainerWrapper",W),C.registerPartial("metaDcTerms",J),C.registerPartial("metaOpenGraph",j),C.registerPartial("modal",B),C.registerPartial("navbar",Y),C.registerPartial("pageLayout",U),C.registerPartial("contentPageWithForm",$),C.registerPartial("contentPageWithSideNavigation",z),C.registerPartial("fullWidthLandingPage",X),C.registerPartial("pagination",K),C.registerPartial("promotionalPanel",C2),C.registerPartial("quickexit",e2),C.registerPartial("searchInput",i2),C.registerPartial("select",a2),C.registerPartial("sidenav",t2),C.registerPartial("sidenavWrapper",l2),C.registerPartial("skipLinks",o2),C.registerPartial("spinner",n2),C.registerPartial("table",s2),C.registerPartial("tabs",r2),C.registerPartial("tag",d2),C.registerPartial("textarea",c2),C.registerPartial("textbox",p2),C.registerPartial("typography",f2),C.registerPartial("video",u2)}typeof Handlebars!="undefined"&&d(Handlebars);var h2=!1;function L2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(h2?console.log("HandleBars Helpers And Partials already loaded, loading again"):h2=!0,r(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&L2(Handlebars);})();
