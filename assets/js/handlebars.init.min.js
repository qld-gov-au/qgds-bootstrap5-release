...
`;var e2=`<nav class="qld-skip-links" aria-label="skip to content links">
  ...
  {{/each}}
</nav>`;var i2=`<!-- QGDS Component: Loading Spinner -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",f),C.registerPartial("banner",p),C.registerPartial("blockquote",u),C.registerPartial("breadcrumbs",h),C.registerPartial("breadcrumbsWrapper",L),C.registerPartial("button",v),C.registerPartial("callToAction",m),C.registerPartial("callout",g),C.registerPartial("card",b),C.registerPartial("contentFooter",V),C.registerPartial("contentFooterWrapper",H),C.registerPartial("contentWrapper",M),C.registerPartial("correctincorrect",Z),C.registerPartial("dateinput",_),C.registerPartial("directionLinks",w),C.registerPartial("customLinks",k),C.registerPartial("feedbackForm",y),C.registerPartial("followLinks",q),C.registerPartial("footer",x),C.registerPartial("footerForgov",T),C.registerPartial("formcheck",S),C.registerPartial("fullPage",R),C.registerPartial("globalAlert",P),C.registerPartial("head",D),C.registerPartial("header",A),C.registerPartial("icon",O),C.registerPartial("image",E),C.registerPartial("inpageAlert",I),C.registerPartial("inpagenav",F),C.registerPartial("linkColumns",N),C.registerPartial("mainContainerWrapper",G),C.registerPartial("metaDcTerms",Q),C.registerPartial("metaOpenGraph",B),C.registerPartial("modal",J),C.registerPartial("navbar",W),C.registerPartial("pageLayout",Y),C.registerPartial("pagination",j),C.registerPartial("promotionalPanel",U),C.registerPartial("quickexit",$),C.registerPartial("searchInput",z),C.registerPartial("select",X),C.registerPartial("sidenav",K),C.registerPartial("sidenavWrapper",C2),C.registerPartial("skipLinks",e2),C.registerPartial("spinner",i2),C.registerPartial("table",t2),C.registerPartial("tabs",a2),C.registerPartial("tag",l2),C.registerPartial("textarea",o2),C.registerPartial("textbox",r2),C.registerPartial("typography",s2),C.registerPartial("video",n2)}typeof Handlebars!="undefined"&&d(Handlebars);var d2=!1;function c2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(d2?console.log("HandleBars Helpers And Partials already loaded, loading again"):d2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&c2(Handlebars);})();
