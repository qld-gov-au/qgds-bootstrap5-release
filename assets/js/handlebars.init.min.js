...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",f),C.registerPartial("banner",p),C.registerPartial("blockquote",h),C.registerPartial("breadcrumbs",u),C.registerPartial("breadcrumbsWrapper",m),C.registerPartial("button",v),C.registerPartial("callToAction",g),C.registerPartial("callout",b),C.registerPartial("card",L),C.registerPartial("containerLayout",V),C.registerPartial("contentFooter",M),C.registerPartial("contentFooterWrapper",H),C.registerPartial("contentWrapper",w),C.registerPartial("correctincorrect",Z),C.registerPartial("dateinput",k),C.registerPartial("directionLinks",x),C.registerPartial("footer",y),C.registerPartial("footerForgov",q),C.registerPartial("formcheck",T),C.registerPartial("fullPage",S),C.registerPartial("globalAlert",P),C.registerPartial("head",O),C.registerPartial("header",A),C.registerPartial("headerBrand",D),C.registerPartial("icon",R),C.registerPartial("image",_),C.registerPartial("inpageAlert",I),C.registerPartial("inpagenav",E),C.registerPartial("link",F),C.registerPartial("linkColumns",N),C.registerPartial("logo",G),C.registerPartial("logoCOALandscape",B),C.registerPartial("logoCOALandscape2Lines",W),C.registerPartial("mainContainerWrapper",Q),C.registerPartial("metaDcTerms",j),C.registerPartial("metaOpenGraph",J),C.registerPartial("modal",Y),C.registerPartial("navbar",U),C.registerPartial("pageLayout",$),C.registerPartial("contentPageWithForm",z),C.registerPartial("contentPageWithSideNavigation",X),C.registerPartial("fullWidthLandingPage",K),C.registerPartial("pagination",C2),C.registerPartial("promotionalPanel",e2),C.registerPartial("quickexit",i2),C.registerPartial("searchInput",a2),C.registerPartial("select",t2),C.registerPartial("sidenav",l2),C.registerPartial("sidenavWrapper",s2),C.registerPartial("skipLinks",n2),C.registerPartial("spinner",o2),C.registerPartial("table",r2),C.registerPartial("tabs",d2),C.registerPartial("tag",c2),C.registerPartial("textarea",f2),C.registerPartial("textbox",p2),C.registerPartial("typography",h2),C.registerPartial("video",u2)}typeof Handlebars!="undefined"&&d(Handlebars);var m2=!1;function v2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(m2?console.log("HandleBars Helpers And Partials already loaded, loading again"):m2=!0,r(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&v2(Handlebars);})();
