...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`;var E=`<!-- Example button to trigger the modal -->
...
</div>`;var I=`<!-- QGDS Partial: Primary navigation -->
...
</nav>`;var N=`<!-- QGDS Component: Loading Quick exit -->
...
`;var W=`<!-- QGDS Component: Loading Spinner -->
...
<input id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    isRequired}}required aria-required="true" {{/if}} />`;var z="<!-- QGDS Partial: typography -->";var X=`<!-- QGDS Component: Video -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("banner",f),C.registerPartial("blockquote",p),C.registerPartial("breadcrumbs",u),C.registerPartial("breadcrumbsWrapper",h),C.registerPartial("button",L),C.registerPartial("callToAction",v),C.registerPartial("callout",m),C.registerPartial("card",g),C.registerPartial("contentFooter",V),C.registerPartial("contentFooterWrapper",H),C.registerPartial("contentWrapper",M),C.registerPartial("correctincorrect",b),C.registerPartial("dateinput",Z),C.registerPartial("footer",_),C.registerPartial("footerForgov",w),C.registerPartial("formcheck",q),C.registerPartial("fullPage",k),C.registerPartial("globalAlert",y),C.registerPartial("head",x),C.registerPartial("header",T),C.registerPartial("inpageAlert",S),C.registerPartial("inpagenav",R),C.registerPartial("linkColumns",D),C.registerPartial("mainContainerWrapper",O),C.registerPartial("metaDcTerms",A),C.registerPartial("metaOpenGraph",P),C.registerPartial("modal",E),C.registerPartial("navbar",I),C.registerPartial("pagination",F),C.registerPartial("quickexit",N),C.registerPartial("searchInput",G),C.registerPartial("select",Q),C.registerPartial("sidenav",J),C.registerPartial("sidenavWrapper",B),C.registerPartial("spinner",W),C.registerPartial("table",Y),C.registerPartial("tag",j),C.registerPartial("textarea",$),C.registerPartial("textbox",U),C.registerPartial("typography",z),C.registerPartial("video",X)}typeof Handlebars!="undefined"&&d(Handlebars);var K=!1;function C2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(K?console.log("HandleBars Helpers And Partials already loaded, loading again"):K=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&C2(Handlebars);})();
