...
{{/unless}}`;var f=`<!-- QGDS Banner Component -->
  ...
  </div>`;var h=`<!-- QGDS Component: Blockquote -->
...
</figure>`;var L=`<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    {{#each breadcrumbs}}
...
`;var _="";var w=`<!-- QGDS Component: Date input -->
...
`;var A=`<header class="qld__header" role="banner">
...
<!-- MAIN NAVIGATION END -->`;var Y=`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
`;var l2=`<nav class="qld-skip-links" aria-label="skip to content links">
  ...
  {{/each}}
</nav>`;var o2=`<!-- QGDS Component: Loading Spinner -->
...
<input id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    isRequired}}required aria-required="true" {{/if}} />`;var p2="<!-- QGDS Partial: typography -->";var f2=`<!-- QGDS Component: Video -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",p),C.registerPartial("banner",f),C.registerPartial("blockquote",h),C.registerPartial("breadcrumbs",L),C.registerPartial("breadcrumbsWrapper",u),C.registerPartial("button",v),C.registerPartial("callToAction",m),C.registerPartial("callout",g),C.registerPartial("card",V),C.registerPartial("containerLayout",H),C.registerPartial("contentFooter",M),C.registerPartial("contentFooterWrapper",b),C.registerPartial("contentWrapper",Z),C.registerPartial("correctincorrect",_),C.registerPartial("dateinput",w),C.registerPartial("directionLinks",y),C.registerPartial("footer",k),C.registerPartial("footerForgov",q),C.registerPartial("formcheck",x),C.registerPartial("fullPage",T),C.registerPartial("globalAlert",S),C.registerPartial("head",P),C.registerPartial("header",A),C.registerPartial("icon",D),C.registerPartial("image",O),C.registerPartial("inpageAlert",R),C.registerPartial("inpagenav",E),C.registerPartial("linkColumns",I),C.registerPartial("logo",F),C.registerPartial("logoCOALandscape",N),C.registerPartial("logoCOALandscape2Lines",G),C.registerPartial("mainContainerWrapper",Q),C.registerPartial("metaDcTerms",B),C.registerPartial("metaOpenGraph",W),C.registerPartial("modal",j),C.registerPartial("navbar",J),C.registerPartial("pageLayout",Y),C.registerPartial("contentPageWithForm",U),C.registerPartial("contentPageWithSideNavigation",$),C.registerPartial("fullWidthLandingPage",z),C.registerPartial("pagination",X),C.registerPartial("promotionalPanel",K),C.registerPartial("quickexit",C2),C.registerPartial("searchInput",e2),C.registerPartial("select",t2),C.registerPartial("sidenav",i2),C.registerPartial("sidenavWrapper",a2),C.registerPartial("skipLinks",l2),C.registerPartial("spinner",o2),C.registerPartial("table",r2),C.registerPartial("tabs",s2),C.registerPartial("tag",n2),C.registerPartial("textarea",d2),C.registerPartial("textbox",c2),C.registerPartial("typography",p2),C.registerPartial("video",f2)}typeof Handlebars!="undefined"&&d(Handlebars);var h2=!1;function L2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(h2?console.log("HandleBars Helpers And Partials already loaded, loading again"):h2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&L2(Handlebars);})();
