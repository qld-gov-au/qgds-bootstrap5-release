...
</a>`;var L=`<!-- QGDS Component: Callout -->
...
`;var V=`{{!-- https://getbootstrap.com/docs/5.3/examples/grid/#containers --}}
...
</html>`;var M=`<dl class="qld-content-dates">
  <dt>Last updated:</dt>
  <dd>{{formatDateOrToday lastUpdated }}</dd>
</dl>`;var Z=`<div class="container qld-content-footer">
  <div class="row">
    {{> @partial-block }}
  </div>
</div>`;var w=`<!-- Content Wrapper -->
<div class="col-12 col-lg-8 ps-lg-64 qld-content-body" id="content">
  {{#if title}}<h1>{{title}}</h1>{{/if}}
  {{> @partial-block }}
</div>
`;var _="";var x=`<!-- QGDS Component: Date input -->
...
<!-- HEADER END -->`;var P=`{{! Image template }}
{{#*inline "imageTag"}}
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",p),C.registerPartial("banner",f),C.registerPartial("blockquote",h),C.registerPartial("breadcrumbs",u),C.registerPartial("breadcrumbsWrapper",m),C.registerPartial("button",v),C.registerPartial("callToAction",g),C.registerPartial("callout",L),C.registerPartial("card",b),C.registerPartial("_gridExample",V),C.registerPartial("containerLayout",H),C.registerPartial("contentFooter",M),C.registerPartial("contentFooterWrapper",Z),C.registerPartial("contentWrapper",w),C.registerPartial("correctincorrect",_),C.registerPartial("dateinput",x),C.registerPartial("directionLinks",y),C.registerPartial("footer",k),C.registerPartial("footerForgov",q),C.registerPartial("formcheck",T),C.registerPartial("fullPage",S),C.registerPartial("globalAlert",D),C.registerPartial("head",R),C.registerPartial("header",A),C.registerPartial("image",P),C.registerPartial("inpageAlert",O),C.registerPartial("inpagenav",E),C.registerPartial("linkColumns",I),C.registerPartial("mainContainerWrapper",F),C.registerPartial("metaDcTerms",G),C.registerPartial("metaOpenGraph",N),C.registerPartial("modal",B),C.registerPartial("navbar",Q),C.registerPartial("pageLayout",J),C.registerPartial("pagination",W),C.registerPartial("promotionalPanel",Y),C.registerPartial("quickexit",j),C.registerPartial("searchInput",U),C.registerPartial("select",$),C.registerPartial("sidenav",z),C.registerPartial("sidenavWrapper",X),C.registerPartial("spinner",K),C.registerPartial("table",C2),C.registerPartial("tabs",e2),C.registerPartial("tag",t2),C.registerPartial("textarea",i2),C.registerPartial("textbox",a2),C.registerPartial("typography",l2),C.registerPartial("video",o2)}typeof Handlebars!="undefined"&&d(Handlebars);var s2=!1;function r2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(s2?console.log("HandleBars Helpers And Partials already loaded, loading again"):s2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&r2(Handlebars);})();
