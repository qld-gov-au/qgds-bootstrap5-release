...
`;var M="";var b=`<!-- QGDS Component: Date input -->
...
`;var Z=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
...
`;var k=`<header class="qld__header" role="banner">
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("banner",f),C.registerPartial("blockquote",p),C.registerPartial("breadcrumbs",u),C.registerPartial("breadcrumbsWrapper",h),C.registerPartial("button",L),C.registerPartial("callout",v),C.registerPartial("card",m),C.registerPartial("contentFooter",g),C.registerPartial("contentFooterWrapper",V),C.registerPartial("contentWrapper",H),C.registerPartial("correctincorrect",M),C.registerPartial("dateinput",b),C.registerPartial("footer",Z),C.registerPartial("footerForgov",_),C.registerPartial("formcheck",w),C.registerPartial("fullPage",q),C.registerPartial("globalAlert",x),C.registerPartial("head",y),C.registerPartial("header",k),C.registerPartial("inpageAlert",T),C.registerPartial("inpagenav",S),C.registerPartial("linkColumns",R),C.registerPartial("mainContainerWrapper",D),C.registerPartial("metaDcTerms",O),C.registerPartial("metaOpenGraph",A),C.registerPartial("modal",P),C.registerPartial("navbar",E),C.registerPartial("pagination",I),C.registerPartial("quickexit",F),C.registerPartial("searchInput",N),C.registerPartial("select",G),C.registerPartial("sidenav",Q),C.registerPartial("sidenavWrapper",J),C.registerPartial("spinner",B),C.registerPartial("table",W),C.registerPartial("tag",Y),C.registerPartial("textarea",j),C.registerPartial("textbox",$),C.registerPartial("typography",U),C.registerPartial("video",z)}typeof Handlebars!="undefined"&&d(Handlebars);var X=!1;function K(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(X?console.log("HandleBars Helpers And Partials already loaded, loading again"):X=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&K(Handlebars);})();
