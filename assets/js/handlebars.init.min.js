...
`;var Z="";var w=`<!-- QGDS Component: Date input -->
...
`;var _=`{{! valid class values are: up, down, left, right}}
<a class="qld-dir-link {{class}}" 
  ...
  {{{label}}}
  <span class="icon" aria-hidden="true"></span>
</a>`;var y=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
...
</footer>`;var k=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
  <!-- Footer content container -->
    <div class="container">
        <div class="row">
            <div class="col title">
...
<!-- HEADER END -->`;var P=`<svg class="qld-icon-{{size}}"{{#if ariaLabel}} aria-label="{{ariaLabel}}"{{/if}}{{#if ariaHidden}} aria-hidden="{{ariaHidden}}"{{/if}}>
  <use href="./assets/img/icons-sprite.svg#qgds-icon-{{iconId}}"></use>
</svg>`;var A=`{{! Image template }}
{{#*inline "imageTag"}}
...
{{#if src}}
  ...
  {{else}}
    {{> imageTag}}
  {{/if}}
{{/if}}`;var R=`<div class="alert {{variantClass}} {{customClass}}" role="alert" 
    ...
    {{/if}}
    {{{ content }}}
</div>`;var D=`<!-- QGDS Partial: inpage-nav -->
...
{{/inline}}`;var I=`{{#ifCond logo "===" "coa-landscape"}}
    {{>logoCOALandscape}}
...
{{> footer footer}}`;var B=`<!-- DCTERMS https://www.dublincore.org/specifications/dublin-core/dcmi-terms/-->
{{#if dcTerms}}
...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`;var W=`<!-- Example button to trigger the modal -->
...
</div>`;var J=`<!-- QGDS Partial: Primary navigation -->
...
<input id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    isRequired}}required aria-required="true" {{/if}} />`;var c2="<!-- QGDS Partial: typography -->";var f2=`<!-- QGDS Component: Video -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",f),C.registerPartial("banner",p),C.registerPartial("blockquote",L),C.registerPartial("breadcrumbs",h),C.registerPartial("breadcrumbsWrapper",u),C.registerPartial("button",v),C.registerPartial("callToAction",m),C.registerPartial("callout",g),C.registerPartial("card",V),C.registerPartial("contentFooter",H),C.registerPartial("contentFooterWrapper",M),C.registerPartial("contentWrapper",b),C.registerPartial("correctincorrect",Z),C.registerPartial("dateinput",w),C.registerPartial("directionLinks",_),C.registerPartial("footer",y),C.registerPartial("footerForgov",k),C.registerPartial("formcheck",q),C.registerPartial("fullPage",x),C.registerPartial("globalAlert",T),C.registerPartial("head",S),C.registerPartial("header",O),C.registerPartial("icon",P),C.registerPartial("image",A),C.registerPartial("inpageAlert",R),C.registerPartial("inpagenav",D),C.registerPartial("linkColumns",E),C.registerPartial("logo",I),C.registerPartial("logoCOALandscape",F),C.registerPartial("logoCOALandscape2Lines",N),C.registerPartial("mainContainerWrapper",G),C.registerPartial("metaDcTerms",B),C.registerPartial("metaOpenGraph",Q),C.registerPartial("modal",W),C.registerPartial("navbar",J),C.registerPartial("pageLayout",Y),C.registerPartial("contentPageWithForm",j),C.registerPartial("contentPageWithSideNavigation",U),C.registerPartial("fullWidthLandingPage",$),C.registerPartial("pagination",z),C.registerPartial("promotionalPanel",X),C.registerPartial("quickexit",K),C.registerPartial("searchInput",C2),C.registerPartial("select",e2),C.registerPartial("sidenav",t2),C.registerPartial("sidenavWrapper",i2),C.registerPartial("skipLinks",a2),C.registerPartial("spinner",l2),C.registerPartial("table",o2),C.registerPartial("tabs",r2),C.registerPartial("tag",s2),C.registerPartial("textarea",n2),C.registerPartial("textbox",d2),C.registerPartial("typography",c2),C.registerPartial("video",f2)}typeof Handlebars!="undefined"&&d(Handlebars);var p2=!1;function L2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(p2?console.log("HandleBars Helpers And Partials already loaded, loading again"):p2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&L2(Handlebars);})();
