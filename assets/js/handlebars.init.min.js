...
<a class="qld-dir-link {{class}}" 
  ...
  {{{label}}}
  <span class="icon" aria-hidden="true"></span>
</a>`;var w=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
...
</html>`;var k=`<!-- QGDS Component: Global Alert -->
...
`;var S=`<header class="qld__header" role="banner">
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("banner",f),C.registerPartial("blockquote",p),C.registerPartial("breadcrumbs",u),C.registerPartial("breadcrumbsWrapper",h),C.registerPartial("button",L),C.registerPartial("callToAction",v),C.registerPartial("callout",g),C.registerPartial("card",m),C.registerPartial("contentFooter",V),C.registerPartial("contentFooterWrapper",H),C.registerPartial("contentWrapper",M),C.registerPartial("correctincorrect",b),C.registerPartial("dateinput",Z),C.registerPartial("directionLinks",_),C.registerPartial("footer",w),C.registerPartial("footerForgov",q),C.registerPartial("formcheck",y),C.registerPartial("fullPage",x),C.registerPartial("globalAlert",k),C.registerPartial("head",T),C.registerPartial("header",S),C.registerPartial("inpageAlert",R),C.registerPartial("inpagenav",D),C.registerPartial("mainContainerWrapper",O),C.registerPartial("metaDcTerms",A),C.registerPartial("metaOpenGraph",P),C.registerPartial("modal",E),C.registerPartial("navbar",I),C.registerPartial("pagination",F),C.registerPartial("quickexit",N),C.registerPartial("searchInput",G),C.registerPartial("select",Q),C.registerPartial("sidenav",B),C.registerPartial("sidenavWrapper",J),C.registerPartial("spinner",W),C.registerPartial("table",Y),C.registerPartial("tag",j),C.registerPartial("textarea",$),C.registerPartial("textbox",U),C.registerPartial("typography",z),C.registerPartial("video",X)}typeof Handlebars!="undefined"&&d(Handlebars);var K=!1;function C2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(K?console.log("HandleBars Helpers And Partials already loaded, loading again"):K=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&C2(Handlebars);})();
