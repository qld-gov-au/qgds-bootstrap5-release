"use strict";(()=>{function u2(C,i,a,e){switch(i){case"==":return C==a?e.fn(this):e.inverse(this);case"===":return C===a?e.fn(this):e.inverse(this);case"!=":return C!=a?e.fn(this):e.inverse(this);case"!==":return C!==a?e.fn(this):e.inverse(this);case"<":return C<a?e.fn(this):e.inverse(this);case"<=":return C<=a?e.fn(this):e.inverse(this);case">":return C>a?e.fn(this):e.inverse(this);case">=":return C>=a?e.fn(this):e.inverse(this);case"&&":return C&&a?e.fn(this):e.inverse(this);case"||":return C||a?e.fn(this):e.inverse(this);case"contains":return typeof C=="string"&&typeof a=="string"?C.toLowerCase().indexOf(a.toLowerCase())>=0?e.fn(this):e.inverse(this):e.inverse(this);default:return e.inverse(this)}}function n(C){C.registerHelper("contains",function(i,a,e){return i=C.escapeExpression(i),a=C.escapeExpression(a),a.indexOf(i)>-1?e.fn(this):e.inverse(this)}),C.registerHelper("ifCond",u2),C.registerHelper("isType",function(i,a,e){return i===a?e.fn(this):e.inverse(this)}),C.registerHelper("ifAny",function(...i){let a=i.pop();return i.some(e=>!!e)?a.fn(this):a.inverse(this)}),C.registerHelper("now",function(){return new Date().toISOString()}),C.registerHelper("formatDate",function(i,a,e){let t;if(i&&(t=new Date(i)),isNaN(t)&&a&&(t=new Date(a)),isNaN(t))return"Invalid Date";var l=["January","February","March","April","May","June","July","August","September","October","November","December"],r=t.getDate(),o=l[t.getMonth()],s=t.getFullYear();switch(e){case"YYYY":return`${s}`;case"MMMM YYYY":return`${o} ${s}`;default:return`${r} ${o} ${s}`}}),C.registerHelper("formatDateOrToday",function(i,a){let e=i||new Date().toISOString();return C.helpers.formatDate(i,e,a)}),C.registerHelper("formatDuration",function(i,a){if(!i)return"";if(typeof i=="string"&&a!=="long")return i;let e="",t=[],l,r,o;if(typeof i=="string"){let s=i.split(":");o=s[0],s.length==2?[r="",o=""]=s:s.length==3&&([l="",r="",o=""]=s)}else[l="",r="",o=""]=i;return a==="long"?(l>0&&t.push(`${l} hour${l>1?"s":""}`),r>0&&t.push(`${r} minute${r>1?"s":""}`),o>0&&t.push(`${o} second${o>1?"s":""}`),e=t.join(" ")):(l>0&&t.push(l.toString().padStart(2,0)),t.push(r.toString().padStart(2,0)),t.push(o.toString().padStart(2,0)),e=t.join(":")),e}),C.registerHelper("isdefined",function(i,a){return i!==void 0&&i!==""?i:a}),C.registerHelper("getClassNames",function(i,a){let e=i.split(",").map(l=>l.trim()),t=[];for(let l=0;l<e.length;l++){let r=e[l];if(a){for(let o=0;o<a.length;o++)if(a[o][r]===!0){t.push(r);break}}}return t.length>0?t.join(" "):""}),C.registerHelper("join",function(i,a){return(!a||typeof a!="string")&&(a=" "),Array.isArray(i)?i.join(a):i}),C.registerHelper("toCamelCase",function(i){return typeof i!="string"?i:i.toLowerCase().replace(/(?:^\w|[A-Z]|\b\w|\s+)/g,(a,e)=>e===0?a.toLowerCase():a.toUpperCase()).replace(/\s+/g,"")})}typeof Handlebars!="undefined"&&n(Handlebars);var c=`<!-- QGDS Component: Accordion -->
...
{{/if}}`;var k=`<div class="col-12 col-md-6 col-lg-12">
...
</html>`;var A=`<!-- QGDS Component: Global Alert -->
...
</nav>`;var z=`<section class="qld-promo-panel {{#ifCond type '==' 'indent-text'}}indent{{/ifCond}} {{#ifCond type '==' 'indent-img'}}indent{{/ifCond}} {{type}}">
...
</section>`;var X=`<!-- QGDS Component: Loading Quick exit -->
...
`;var e2=`<div class="qld-side-navigation">
...
<input id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    isRequired}}required aria-required="true" {{/if}} />`;var d2="<!-- QGDS Partial: typography -->";var c2=`<!-- QGDS Component: Video -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",p),C.registerPartial("banner",f),C.registerPartial("blockquote",u),C.registerPartial("breadcrumbs",h),C.registerPartial("breadcrumbsWrapper",L),C.registerPartial("button",m),C.registerPartial("callToAction",v),C.registerPartial("callout",g),C.registerPartial("card",b),C.registerPartial("contentFooter",H),C.registerPartial("contentFooterWrapper",V),C.registerPartial("contentWrapper",M),C.registerPartial("correctincorrect",Z),C.registerPartial("dateinput",_),C.registerPartial("directionLinks",w),C.registerPartial("customLinks",q),C.registerPartial("feedbackForm",k),C.registerPartial("followLinks",y),C.registerPartial("footer",x),C.registerPartial("formcheck",T),C.registerPartial("fullPage",S),C.registerPartial("globalAlert",A),C.registerPartial("head",P),C.registerPartial("header",R),C.registerPartial("icon",O),C.registerPartial("image",D),C.registerPartial("inpageAlert",E),C.registerPartial("inpagenav",I),C.registerPartial("linkColumns",G),C.registerPartial("logo",N),C.registerPartial("logoCOALandscape",F),C.registerPartial("logoCOALandscape2Lines",Q),C.registerPartial("mainContainerWrapper",J),C.registerPartial("metaDcTerms",B),C.registerPartial("metaOpenGraph",W),C.registerPartial("modal",j),C.registerPartial("navbar",Y),C.registerPartial("pageLayout",U),C.registerPartial("pagination",$),C.registerPartial("promotionalPanel",z),C.registerPartial("quickexit",X),C.registerPartial("searchInput",K),C.registerPartial("select",C2),C.registerPartial("sidenav",e2),C.registerPartial("sidenavWrapper",a2),C.registerPartial("skipLinks",i2),C.registerPartial("spinner",t2),C.registerPartial("table",l2),C.registerPartial("tabs",o2),C.registerPartial("tag",r2),C.registerPartial("textarea",s2),C.registerPartial("textbox",n2),C.registerPartial("typography",d2),C.registerPartial("video",c2)}typeof Handlebars!="undefined"&&d(Handlebars);var p2=!1;function f2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(p2?console.log("HandleBars Helpers And Partials already loaded, loading again"):p2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&f2(Handlebars);})();
