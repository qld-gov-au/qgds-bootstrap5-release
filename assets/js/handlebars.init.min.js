...
{{> footer footer}}`;var P=`<!-- DCTERMS https://www.dublincore.org/specifications/dublin-core/dcmi-terms/-->
{{#if dcTerms}}
...
</div>`;var U=`<div class="container-fluid">
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",f),C.registerPartial("banner",p),C.registerPartial("blockquote",u),C.registerPartial("breadcrumbs",h),C.registerPartial("breadcrumbsWrapper",L),C.registerPartial("button",v),C.registerPartial("callToAction",g),C.registerPartial("callout",m),C.registerPartial("card",V),C.registerPartial("contentFooter",H),C.registerPartial("contentFooterWrapper",b),C.registerPartial("contentWrapper",M),C.registerPartial("correctincorrect",Z),C.registerPartial("dateinput",_),C.registerPartial("directionLinks",w),C.registerPartial("footer",q),C.registerPartial("footerForgov",x),C.registerPartial("formcheck",y),C.registerPartial("fullPage",k),C.registerPartial("globalAlert",T),C.registerPartial("head",S),C.registerPartial("header",R),C.registerPartial("inpageAlert",D),C.registerPartial("inpagenav",O),C.registerPartial("mainContainerWrapper",A),C.registerPartial("metaDcTerms",P),C.registerPartial("metaOpenGraph",E),C.registerPartial("modal",I),C.registerPartial("navbar",F),C.registerPartial("pagination",N),C.registerPartial("quickexit",G),C.registerPartial("searchInput",Q),C.registerPartial("select",B),C.registerPartial("sidenav",J),C.registerPartial("sidenavWrapper",W),C.registerPartial("spinner",Y),C.registerPartial("table",j),C.registerPartial("tabs",U),C.registerPartial("tag",$),C.registerPartial("textarea",z),C.registerPartial("textbox",X),C.registerPartial("typography",K),C.registerPartial("video",C2)}typeof Handlebars!="undefined"&&d(Handlebars);var e2=!1;function t2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(e2?console.log("HandleBars Helpers And Partials already loaded, loading again"):e2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&t2(Handlebars);})();
