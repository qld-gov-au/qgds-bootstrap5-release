"use strict";(()=>{function u2(C,t,i,e){switch(t){case"==":return C==i?e.fn(this):e.inverse(this);case"===":return C===i?e.fn(this):e.inverse(this);case"!=":return C!=i?e.fn(this):e.inverse(this);case"!==":return C!==i?e.fn(this):e.inverse(this);case"<":return C<i?e.fn(this):e.inverse(this);case"<=":return C<=i?e.fn(this):e.inverse(this);case">":return C>i?e.fn(this):e.inverse(this);case">=":return C>=i?e.fn(this):e.inverse(this);case"&&":return C&&i?e.fn(this):e.inverse(this);case"||":return C||i?e.fn(this):e.inverse(this);case"contains":return typeof C=="string"&&typeof i=="string"?C.toLowerCase().indexOf(i.toLowerCase())>=0?e.fn(this):e.inverse(this):e.inverse(this);default:return e.inverse(this)}}function n(C){C.registerHelper("contains",function(t,i,e){return t=C.escapeExpression(t),i=C.escapeExpression(i),i.indexOf(t)>-1?e.fn(this):e.inverse(this)}),C.registerHelper("ifCond",u2),C.registerHelper("isType",function(t,i,e){return t===i?e.fn(this):e.inverse(this)}),C.registerHelper("ifAny",function(...t){let i=t.pop();return t.some(e=>!!e)?i.fn(this):i.inverse(this)}),C.registerHelper("now",function(){return new Date().toISOString()}),C.registerHelper("formatDate",function(t,i,e){let a;if(t&&(a=new Date(t)),isNaN(a)&&i&&(a=new Date(i)),isNaN(a))return"Invalid Date";var l=["January","February","March","April","May","June","July","August","September","October","November","December"],r=a.getDate(),o=l[a.getMonth()],s=a.getFullYear();switch(e){case"YYYY":return`${s}`;case"MMMM YYYY":return`${o} ${s}`;default:return`${r} ${o} ${s}`}}),C.registerHelper("formatDateOrToday",function(t,i){let e=t||new Date().toISOString();return C.helpers.formatDate(t,e,i)}),C.registerHelper("formatDuration",function(t,i){if(!t)return"";if(typeof t=="string"&&i!=="long")return t;let e="",a=[],l,r,o;if(typeof t=="string"){let s=t.split(":");o=s[0],s.length==2?[r="",o=""]=s:s.length==3&&([l="",r="",o=""]=s)}else[l="",r="",o=""]=t;return i==="long"?(l>0&&a.push(`${l} hour${l>1?"s":""}`),r>0&&a.push(`${r} minute${r>1?"s":""}`),o>0&&a.push(`${o} second${o>1?"s":""}`),e=a.join(" ")):(l>0&&a.push(l.toString().padStart(2,0)),a.push(r.toString().padStart(2,0)),a.push(o.toString().padStart(2,0)),e=a.join(":")),e}),C.registerHelper("isdefined",function(t,i){return t!==void 0&&t!==""?t:i}),C.registerHelper("getClassNames",function(t,i){let e=t.split(",").map(l=>l.trim()),a=[];for(let l=0;l<e.length;l++){let r=e[l];if(i){for(let o=0;o<i.length;o++)if(i[o][r]===!0){a.push(r);break}}}return a.length>0?a.join(" "):""}),C.registerHelper("join",function(t,i){return(!i||typeof i!="string")&&(i=" "),Array.isArray(t)?t.join(i):t}),C.registerHelper("toCamelCase",function(t){return typeof t!="string"?t:t.toLowerCase().replace(/(?:^\w|[A-Z]|\b\w|\s+)/g,(i,e)=>e===0?i.toLowerCase():i.toUpperCase()).replace(/\s+/g,"")})}typeof Handlebars!="undefined"&&n(Handlebars);var c=`<!-- QGDS Component: Accordion -->
...
</footer>`;var y=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
  <!-- Footer content container -->
    <div class="container">
        <div class="row">
            <div class="col title">
...
<!-- MAIN NAVIGATION END -->`;var j=`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",f),C.registerPartial("banner",p),C.registerPartial("blockquote",h),C.registerPartial("breadcrumbs",L),C.registerPartial("breadcrumbsWrapper",u),C.registerPartial("button",v),C.registerPartial("callToAction",m),C.registerPartial("callout",g),C.registerPartial("card",V),C.registerPartial("contentFooter",H),C.registerPartial("contentFooterWrapper",M),C.registerPartial("contentWrapper",b),C.registerPartial("correctincorrect",Z),C.registerPartial("dateinput",_),C.registerPartial("directionLinks",w),C.registerPartial("footer",k),C.registerPartial("footerForgov",y),C.registerPartial("formcheck",q),C.registerPartial("fullPage",x),C.registerPartial("globalAlert",T),C.registerPartial("head",S),C.registerPartial("header",P),C.registerPartial("iconLink",A),C.registerPartial("icon",D),C.registerPartial("image",O),C.registerPartial("inpageAlert",R),C.registerPartial("inpagenav",E),C.registerPartial("linkColumns",I),C.registerPartial("logo",F),C.registerPartial("logoCOALandscape",N),C.registerPartial("logoCOALandscape2Lines",G),C.registerPartial("mainContainerWrapper",Q),C.registerPartial("metaDcTerms",B),C.registerPartial("metaOpenGraph",W),C.registerPartial("modal",J),C.registerPartial("navbar",Y),C.registerPartial("pageLayout",j),C.registerPartial("contentPageWithForm",U),C.registerPartial("contentPageWithSideNavigation",$),C.registerPartial("fullWidthLandingPage",z),C.registerPartial("pagination",X),C.registerPartial("promotionalPanel",K),C.registerPartial("quickexit",C2),C.registerPartial("searchInput",e2),C.registerPartial("select",i2),C.registerPartial("sidenav",t2),C.registerPartial("sidenavWrapper",a2),C.registerPartial("skipLinks",l2),C.registerPartial("spinner",o2),C.registerPartial("table",r2),C.registerPartial("tabs",s2),C.registerPartial("tag",n2),C.registerPartial("textarea",d2),C.registerPartial("textbox",c2),C.registerPartial("typography",f2),C.registerPartial("video",p2)}typeof Handlebars!="undefined"&&d(Handlebars);var h2=!1;function L2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(h2?console.log("HandleBars Helpers And Partials already loaded, loading again"):h2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&L2(Handlebars);})();
