...
</a>`;var V=`<!-- QGDS Component: Callout -->
...
<!-- HEADER END -->`;var R=`{{! Image template }}
{{#*inline "imageTag"}}
...
{{/inline}}`;var E=`{{#ifCond logo "===" "coa-landscape"}}
    {{>logoCOALandscape}}
...
{{> footer footer}}`;var G=`<!-- DCTERMS https://www.dublincore.org/specifications/dublin-core/dcmi-terms/-->
{{#if dcTerms}}
...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`;var B=`<!-- Example button to trigger the modal -->
...
<!-- MAIN NAVIGATION END -->`;var W=`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</nav>`;var j=`<section class="qld-promo-panel {{#ifCond type '==' 'indent-text'}}indent{{/ifCond}} {{#ifCond type '==' 'indent-img'}}indent{{/ifCond}} {{type}}">
...
</section>`;var U=`<!-- QGDS Component: Loading Quick exit -->
...
`;var X=`<div class="qld-side-navigation">
...
`;var C2=`<nav class="qld-skip-links" aria-label="skip to content links">
  {{#each skipLinks}}
    <a class="qld-skip-links__item" href="#{{targetId}}">{{label}}</a>
  {{/each}}
</nav>`;var e2=`<!-- QGDS Component: Loading Spinner -->
...
`;var l2=`<!-- QGDS Component: Textarea -->
...
<textarea id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    aria-required="true" {{/if}}></textarea>`;var o2=`<!-- QGDS Component: Textbox -->
...
<input id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    isRequired}}required aria-required="true" {{/if}} />`;var r2="<!-- QGDS Partial: typography -->";var s2=`<!-- QGDS Component: Video -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",p),C.registerPartial("banner",f),C.registerPartial("blockquote",L),C.registerPartial("breadcrumbs",h),C.registerPartial("breadcrumbsWrapper",u),C.registerPartial("button",v),C.registerPartial("callToAction",g),C.registerPartial("callout",V),C.registerPartial("card",m),C.registerPartial("contentFooter",H),C.registerPartial("contentFooterWrapper",M),C.registerPartial("contentWrapper",Z),C.registerPartial("correctincorrect",b),C.registerPartial("dateinput",_),C.registerPartial("directionLinks",w),C.registerPartial("footer",k),C.registerPartial("footerForgov",y),C.registerPartial("formcheck",q),C.registerPartial("fullPage",x),C.registerPartial("globalAlert",T),C.registerPartial("head",S),C.registerPartial("header",A),C.registerPartial("image",R),C.registerPartial("inpageAlert",O),C.registerPartial("inpagenav",P),C.registerPartial("linkColumns",D),C.registerPartial("logo",E),C.registerPartial("logoCOALandscape",I),C.registerPartial("logoCOALandscape2Lines",F),C.registerPartial("mainContainerWrapper",N),C.registerPartial("metaDcTerms",G),C.registerPartial("metaOpenGraph",Q),C.registerPartial("modal",B),C.registerPartial("navbar",J),C.registerPartial("pageLayout",W),C.registerPartial("pagination",Y),C.registerPartial("promotionalPanel",j),C.registerPartial("quickexit",U),C.registerPartial("searchInput",$),C.registerPartial("select",z),C.registerPartial("sidenav",X),C.registerPartial("sidenavWrapper",K),C.registerPartial("skipLinks",C2),C.registerPartial("spinner",e2),C.registerPartial("table",t2),C.registerPartial("tabs",a2),C.registerPartial("tag",i2),C.registerPartial("textarea",l2),C.registerPartial("textbox",o2),C.registerPartial("typography",r2),C.registerPartial("video",s2)}typeof Handlebars!="undefined"&&d(Handlebars);var n2=!1;function d2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(n2?console.log("HandleBars Helpers And Partials already loaded, loading again"):n2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&d2(Handlebars);})();
