"use strict";(()=>{function f2(C,a,i,e){switch(a){case"==":return C==i?e.fn(this):e.inverse(this);case"===":return C===i?e.fn(this):e.inverse(this);case"!=":return C!=i?e.fn(this):e.inverse(this);case"!==":return C!==i?e.fn(this):e.inverse(this);case"<":return C<i?e.fn(this):e.inverse(this);case"<=":return C<=i?e.fn(this):e.inverse(this);case">":return C>i?e.fn(this):e.inverse(this);case">=":return C>=i?e.fn(this):e.inverse(this);case"&&":return C&&i?e.fn(this):e.inverse(this);case"||":return C||i?e.fn(this):e.inverse(this);case"contains":return typeof C=="string"&&typeof i=="string"?C.toLowerCase().indexOf(i.toLowerCase())>=0?e.fn(this):e.inverse(this):e.inverse(this);default:return e.inverse(this)}}function r(C){C.registerHelper("contains",function(a,i,e){return a=C.escapeExpression(a),i=C.escapeExpression(i),i.indexOf(a)>-1?e.fn(this):e.inverse(this)}),C.registerHelper("ifCond",f2),C.registerHelper("isType",function(a,i,e){return a===i?e.fn(this):e.inverse(this)}),C.registerHelper("ifAny",function(...a){let i=a.pop();return a.some(e=>!!e)?i.fn(this):i.inverse(this)}),C.registerHelper("now",function(){return new Date().toISOString()}),C.registerHelper("formatDate",function(a,i,e){let t;if(a&&(t=new Date(a)),isNaN(t)&&i&&(t=new Date(i)),isNaN(t))return"Invalid Date";var s=["January","February","March","April","May","June","July","August","September","October","November","December"],o=t.getDate(),l=s[t.getMonth()],n=t.getFullYear();switch(e){case"YYYY":return`${n}`;case"MMMM YYYY":return`${l} ${n}`;default:return`${o} ${l} ${n}`}}),C.registerHelper("formatDateOrToday",function(a,i){let e=a||new Date().toISOString();return C.helpers.formatDate(a,e,i)}),C.registerHelper("formatDuration",function(a,i){if(!a)return"";if(typeof a=="string"&&i!=="long")return a;let e="",t=[],s,o,l;if(typeof a=="string"){let n=a.split(":");l=n[0],n.length==2?[o="",l=""]=n:n.length==3&&([s="",o="",l=""]=n)}else[s="",o="",l=""]=a;return i==="long"?(s>0&&t.push(`${s} hour${s>1?"s":""}`),o>0&&t.push(`${o} minute${o>1?"s":""}`),l>0&&t.push(`${l} second${l>1?"s":""}`),e=t.join(" ")):(s>0&&t.push(s.toString().padStart(2,0)),t.push(o.toString().padStart(2,0)),t.push(l.toString().padStart(2,0)),e=t.join(":")),e}),C.registerHelper("isdefined",function(a,i){return a!==void 0&&a!==""?a:i}),C.registerHelper("getClassNames",function(a,i){let e=a.split(",").map(s=>s.trim()),t=[];for(let s=0;s<e.length;s++){let o=e[s];if(i){for(let l=0;l<i.length;l++)if(i[l][o]===!0){t.push(o);break}}}return t.length>0?t.join(" "):""}),C.registerHelper("join",function(a,i){return(!i||typeof i!="string")&&(i=" "),Array.isArray(a)?a.join(i):a}),C.registerHelper("toCamelCase",function(a){return typeof a!="string"?a:a.toLowerCase().replace(/(?:^\w|[A-Z]|\b\w|\s+)/g,(i,e)=>e===0?i.toLowerCase():i.toUpperCase()).replace(/\s+/g,"")})}typeof Handlebars!="undefined"&&r(Handlebars);var c=`<!-- QGDS Component: Accordion -->
...
`;var H="";var Z=`<!-- QGDS Component: Date input -->
...
`;var P=`<header class="qld-header" role="banner">
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",f),C.registerPartial("banner",p),C.registerPartial("blockquote",h),C.registerPartial("breadcrumbs",u),C.registerPartial("breadcrumbsWrapper",m),C.registerPartial("button",v),C.registerPartial("callToAction",g),C.registerPartial("callout",L),C.registerPartial("card",b),C.registerPartial("contentFooter",V),C.registerPartial("contentFooterWrapper",w),C.registerPartial("contentWrapper",M),C.registerPartial("correctincorrect",H),C.registerPartial("dateinput",Z),C.registerPartial("directionLinks",_),C.registerPartial("footer",k),C.registerPartial("footerForgov",q),C.registerPartial("formcheck",x),C.registerPartial("fullPage",y),C.registerPartial("globalAlert",T),C.registerPartial("head",S),C.registerPartial("header",P),C.registerPartial("icon",R),C.registerPartial("image",O),C.registerPartial("inpageAlert",A),C.registerPartial("inpagenav",D),C.registerPartial("linkColumns",E),C.registerPartial("logo",I),C.registerPartial("logoCOALandscape",N),C.registerPartial("logoCOALandscape2Lines",F),C.registerPartial("mainContainerWrapper",G),C.registerPartial("metaDcTerms",B),C.registerPartial("metaOpenGraph",Q),C.registerPartial("modal",J),C.registerPartial("navbar",W),C.registerPartial("pageLayout",Y),C.registerPartial("pagination",j),C.registerPartial("promotionalPanel",U),C.registerPartial("quickexit",$),C.registerPartial("searchInput",z),C.registerPartial("select",X),C.registerPartial("sidenav",K),C.registerPartial("sidenavWrapper",C2),C.registerPartial("skipLinks",e2),C.registerPartial("spinner",i2),C.registerPartial("table",a2),C.registerPartial("tabs",t2),C.registerPartial("tag",s2),C.registerPartial("textarea",l2),C.registerPartial("textbox",o2),C.registerPartial("typography",n2),C.registerPartial("video",r2)}typeof Handlebars!="undefined"&&d(Handlebars);var d2=!1;function c2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(d2?console.log("HandleBars Helpers And Partials already loaded, loading again"):d2=!0,r(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&c2(Handlebars);})();
