...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("banner",f),C.registerPartial("blockquote",p),C.registerPartial("breadcrumbs",u),C.registerPartial("breadcrumbsWrapper",h),C.registerPartial("button",L),C.registerPartial("callToAction",v),C.registerPartial("callout",m),C.registerPartial("card",g),C.registerPartial("contentFooter",V),C.registerPartial("contentFooterWrapper",H),C.registerPartial("contentWrapper",M),C.registerPartial("correctincorrect",b),C.registerPartial("dateinput",Z),C.registerPartial("footer",_),C.registerPartial("footerForgov",w),C.registerPartial("formcheck",q),C.registerPartial("fullPage",k),C.registerPartial("globalAlert",x),C.registerPartial("head",y),C.registerPartial("header",T),C.registerPartial("inpageAlert",S),C.registerPartial("inpagenav",R),C.registerPartial("linkColumns",D),C.registerPartial("mainContainerWrapper",O),C.registerPartial("metaDcTerms",A),C.registerPartial("metaOpenGraph",P),C.registerPartial("modal",E),C.registerPartial("navbar",I),C.registerPartial("pagination",N),C.registerPartial("quickexit",F),C.registerPartial("searchInput",G),C.registerPartial("select",Q),C.registerPartial("sidenav",B),C.registerPartial("sidenavWrapper",J),C.registerPartial("spinner",W),C.registerPartial("table",Y),C.registerPartial("tag",j),C.registerPartial("textarea",$),C.registerPartial("textbox",U),C.registerPartial("typography",z),C.registerPartial("video",X)}typeof Handlebars!="undefined"&&d(Handlebars);var K=!1;function C2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(K?console.log("HandleBars Helpers And Partials already loaded, loading again"):K=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&C2(Handlebars);})();
