...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",p),C.registerPartial("banner",f),C.registerPartial("blockquote",h),C.registerPartial("breadcrumbs",L),C.registerPartial("breadcrumbsWrapper",u),C.registerPartial("button",v),C.registerPartial("callToAction",m),C.registerPartial("callout",g),C.registerPartial("card",V),C.registerPartial("containerLayout",H),C.registerPartial("contentFooter",M),C.registerPartial("contentFooterWrapper",b),C.registerPartial("contentWrapper",Z),C.registerPartial("correctincorrect",_),C.registerPartial("dateinput",w),C.registerPartial("directionLinks",y),C.registerPartial("footer",k),C.registerPartial("footerForgov",q),C.registerPartial("formcheck",x),C.registerPartial("fullPage",T),C.registerPartial("globalAlert",S),C.registerPartial("head",P),C.registerPartial("header",A),C.registerPartial("iconLink",D),C.registerPartial("icon",O),C.registerPartial("image",R),C.registerPartial("inpageAlert",I),C.registerPartial("inpagenav",E),C.registerPartial("linkColumns",F),C.registerPartial("logo",N),C.registerPartial("logoCOALandscape",G),C.registerPartial("logoCOALandscape2Lines",Q),C.registerPartial("mainContainerWrapper",B),C.registerPartial("metaDcTerms",W),C.registerPartial("metaOpenGraph",j),C.registerPartial("modal",J),C.registerPartial("navbar",Y),C.registerPartial("pageLayout",U),C.registerPartial("contentPageWithForm",$),C.registerPartial("contentPageWithSideNavigation",z),C.registerPartial("fullWidthLandingPage",X),C.registerPartial("pagination",K),C.registerPartial("promotionalPanel",C2),C.registerPartial("quickexit",e2),C.registerPartial("searchInput",i2),C.registerPartial("select",t2),C.registerPartial("sidenav",a2),C.registerPartial("sidenavWrapper",l2),C.registerPartial("skipLinks",o2),C.registerPartial("spinner",s2),C.registerPartial("table",r2),C.registerPartial("tabs",n2),C.registerPartial("tag",d2),C.registerPartial("textarea",c2),C.registerPartial("textbox",p2),C.registerPartial("typography",f2),C.registerPartial("video",h2)}typeof Handlebars!="undefined"&&d(Handlebars);var L2=!1;function u2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(L2?console.log("HandleBars Helpers And Partials already loaded, loading again"):L2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&u2(Handlebars);})();
