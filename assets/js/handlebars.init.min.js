...
{{/inline}}`;var j=`<!-- QGDS Component: Loading Spinner -->
...
`;var Q=`{{#ifCond logo "===" "coa-landscape"}}
    {{>logoCOALandscape}}
...
`;var r5=`<nav class="qld-skip-links" aria-label="skip to content links">
  ...
  {{/each}}
</nav>`;var d5=`<!-- QGDS Component: Table -->
...
`;function d(e){e.registerPartial("accordion",c),e.registerPartial("backToTop",p),e.registerPartial("banner",f),e.registerPartial("blockquote",u),e.registerPartial("breadcrumbs",m),e.registerPartial("breadcrumbsWrapper",g),e.registerPartial("button",h),e.registerPartial("callToAction",v),e.registerPartial("callout",b),e.registerPartial("card",L),e.registerPartial("containerLayout",q),e.registerPartial("contentFooter",k),e.registerPartial("contentFooterWrapper",y),e.registerPartial("contentWrapper",x),e.registerPartial("correctincorrect",M),e.registerPartial("dateinput",w),e.registerPartial("directionLinks",V),e.registerPartial("customLinks",H),e.registerPartial("feedbackForm",Z),e.registerPartial("followLinks",T),e.registerPartial("footer",S),e.registerPartial("formcheck",A),e.registerPartial("fullPage",P),e.registerPartial("globalAlert",O),e.registerPartial("head",R),e.registerPartial("header",D),e.registerPartial("headerBrand",_),e.registerPartial("icon",I),e.registerPartial("image",E),e.registerPartial("inpageAlert",N),e.registerPartial("inpagenav",F),e.registerPartial("link",G),e.registerPartial("linkColumns",B),e.registerPartial("loadingSpinner",j),e.registerPartial("logo",Q),e.registerPartial("logoCOALandscape",J),e.registerPartial("logoCOALandscape2Lines",W),e.registerPartial("mainContainerWrapper",Y),e.registerPartial("metaDcTerms",U),e.registerPartial("metaOpenGraph",$),e.registerPartial("modal",z),e.registerPartial("navbar",X),e.registerPartial("contentPageWithForm",K),e.registerPartial("contentPageWithSideNavigation",e5),e.registerPartial("homePage",i5),e.registerPartial("pagination",a5),e.registerPartial("promotionalPanel",t5),e.registerPartial("quickexit",s5),e.registerPartial("searchInput",l5),e.registerPartial("select",n5),e.registerPartial("sidenav",o5),e.registerPartial("sidenavWrapper",C5),e.registerPartial("skipLinks",r5),e.registerPartial("table",d5),e.registerPartial("tabs",c5),e.registerPartial("tag",p5),e.registerPartial("textarea",f5),e.registerPartial("textbox",u5),e.registerPartial("typography",m5),e.registerPartial("video",g5)}typeof Handlebars!="undefined"&&d(Handlebars);var h5=!1;function v5(e){typeof e=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof e!="undefined"?(h5?console.log("HandleBars Helpers And Partials already loaded, loading again"):h5=!0,r(e),d(e)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&v5(Handlebars);})();
