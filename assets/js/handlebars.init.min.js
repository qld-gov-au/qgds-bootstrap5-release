...
<!-- HEADER END -->`;var A=`{{! Image template }}
{{#*inline "imageTag"}}
...
{{#if src}}
  ...
  {{else}}
    {{> imageTag}}
  {{/if}}
{{/if}}`;var D=`<div class="alert {{variantClass}} {{customClass}}" role="alert">
    {{#if heading}}
...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`;var F=`<!-- Example button to trigger the modal -->
...
`;function d(C){C.registerPartial("accordion",c),C.registerPartial("backToTop",f),C.registerPartial("banner",p),C.registerPartial("blockquote",u),C.registerPartial("breadcrumbs",h),C.registerPartial("breadcrumbsWrapper",L),C.registerPartial("button",v),C.registerPartial("callToAction",m),C.registerPartial("callout",g),C.registerPartial("card",b),C.registerPartial("contentFooter",V),C.registerPartial("contentFooterWrapper",H),C.registerPartial("contentWrapper",M),C.registerPartial("correctincorrect",Z),C.registerPartial("dateinput",_),C.registerPartial("directionLinks",w),C.registerPartial("footer",k),C.registerPartial("footerForgov",y),C.registerPartial("formcheck",q),C.registerPartial("fullPage",x),C.registerPartial("globalAlert",T),C.registerPartial("head",S),C.registerPartial("header",R),C.registerPartial("image",A),C.registerPartial("inpageAlert",D),C.registerPartial("inpagenav",P),C.registerPartial("linkColumns",O),C.registerPartial("mainContainerWrapper",E),C.registerPartial("metaDcTerms",I),C.registerPartial("metaOpenGraph",N),C.registerPartial("modal",F),C.registerPartial("navbar",G),C.registerPartial("pagination",Q),C.registerPartial("promotionalPanel",B),C.registerPartial("quickexit",J),C.registerPartial("searchInput",Y),C.registerPartial("select",W),C.registerPartial("sidenav",j),C.registerPartial("sidenavWrapper",U),C.registerPartial("spinner",$),C.registerPartial("table",z),C.registerPartial("tabs",X),C.registerPartial("tag",K),C.registerPartial("textarea",C2),C.registerPartial("textbox",e2),C.registerPartial("typography",t2),C.registerPartial("video",i2)}typeof Handlebars!="undefined"&&d(Handlebars);var a2=!1;function l2(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(a2?console.log("HandleBars Helpers And Partials already loaded, loading again"):a2=!0,n(C),d(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&l2(Handlebars);})();
