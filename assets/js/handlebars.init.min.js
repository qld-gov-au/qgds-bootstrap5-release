...
{{/unless}}`;var b=`<a class="qld-cta-link {{getClassNames "small, view-all" class}}"
    {{#if id}}id="{{id}}"{{/if}}
    href="{{href}}" 
    target="{{target}}" 
...
`;var H=`{{! valid class values are: up, down, left, right}}
...
`;var E=`<svg class="qld-icon-{{size}}"{{#if ariaLabel}} aria-label="{{ariaLabel}}"{{/if}}{{#if ariaHidden}} aria-hidden="{{ariaHidden}}"{{/if}}>
  <use href="./assets/img/icons-sprite.svg#qgds-icon-{{iconId}}"></use>
</svg>`;var N=`{{! Image template }}
{{#*inline "imageTag"}}
...
{{#if src}}
  ...
  {{else}}
    {{> imageTag}}
  {{/if}}
{{/if}}`;var G=`<div class="alert {{variantClass}} {{customClass}}" role="alert" 
...
{{> footer footer}}`;var U=`<!-- DCTERMS https://www.dublincore.org/specifications/dublin-core/dcmi-terms/-->
{{#if dcTerms}}
...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`;var z=`<!-- Example button to trigger the modal -->
...
</div>`;var X=`<!-- QGDS Partial: Primary navigation -->
...
`;function d(e){e.registerPartial("accordion",p),e.registerPartial("backToTop",f),e.registerPartial("banner",u),e.registerPartial("blockquote",m),e.registerPartial("breadcrumbs",g),e.registerPartial("breadcrumbsWrapper",v),e.registerPartial("button",h),e.registerPartial("callToAction",b),e.registerPartial("callout",L),e.registerPartial("card",k),e.registerPartial("containerLayout",q),e.registerPartial("contentFooter",y),e.registerPartial("contentFooterWrapper",M),e.registerPartial("contentWrapper",V),e.registerPartial("correctincorrect",x),e.registerPartial("dateinput",w),e.registerPartial("directionLinks",H),e.registerPartial("customLinks",Z),e.registerPartial("feedbackForm",T),e.registerPartial("followLinks",S),e.registerPartial("footer",A),e.registerPartial("formcheck",P),e.registerPartial("fullPage",O),e.registerPartial("globalAlert",R),e.registerPartial("head",D),e.registerPartial("header",I),e.registerPartial("headerBrand",_),e.registerPartial("icon",E),e.registerPartial("image",N),e.registerPartial("inpageAlert",G),e.registerPartial("inpagenav",F),e.registerPartial("link",B),e.registerPartial("linkColumns",Q),e.registerPartial("logo",j),e.registerPartial("logoCOALandscape",J),e.registerPartial("logoCOALandscape2Lines",W),e.registerPartial("mainContainerWrapper",Y),e.registerPartial("metaDcTerms",U),e.registerPartial("metaOpenGraph",$),e.registerPartial("modal",z),e.registerPartial("navbar",X),e.registerPartial("contentPageWithForm",K),e.registerPartial("contentPageWithSideNavigation",e5),e.registerPartial("homePage",i5),e.registerPartial("pagination",a5),e.registerPartial("promotionalPanel",t5),e.registerPartial("quickexit",s5),e.registerPartial("searchInput",l5),e.registerPartial("select",n5),e.registerPartial("sidenav",o5),e.registerPartial("sidenavWrapper",C5),e.registerPartial("skipLinks",r5),e.registerPartial("spinner",d5),e.registerPartial("table",c5),e.registerPartial("tabs",p5),e.registerPartial("tag",f5),e.registerPartial("textarea",u5),e.registerPartial("textbox",m5),e.registerPartial("typography",g5),e.registerPartial("video",v5)}typeof Handlebars!="undefined"&&d(Handlebars);var h5=!1;function b5(e){typeof e=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof e!="undefined"?(h5?console.log("HandleBars Helpers And Partials already loaded, loading again"):h5=!0,r(e),d(e)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&b5(Handlebars);})();
