...
{{/unless}}`;var v=`<a class="qld-cta-link {{getClassNames "small, view-all" class}}"
    {{#if id}}id="{{id}}"{{/if}}
    href="{{href}}" 
    target="{{target}}" 
...
</a>`;var b=`<!-- QGDS Component: Callout -->
...
`;var x="";var w=`<!-- QGDS Component: Date input -->
...
`;var V=`{{! valid class values are: up, down, left, right}}
...
{{/if}}`;var S=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
...
</html>`;var O=`<!-- QGDS Component: Global Alert -->
...
<!-- VERSION_DETAILS={"project_id":"@qld-gov-au/qgds-bootstrap5","version":"2.0.6","branch":"QGDS-325-update-all-icons-to-use-the-qgds-sprite-icons","tag":"","commit":"a6d3eb7f47158b9f189c5e7bed520ff1abfdff7b","majorVersion":"v2"} -->
...
`;var D=`<header class="qld-header" role="banner" >
...
{{#if src}}
  ...
  {{else}}
    {{> imageTag}}
  {{/if}}
{{/if}}`;var N=`<div class="alert {{variantClass}} {{customClass}}" role="alert" 
...
{{> footer footer}}`;var Y=`<!-- DCTERMS https://www.dublincore.org/specifications/dublin-core/dcmi-terms/-->
{{#if dcTerms}}
...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`;var $=`<!-- Example button to trigger the modal -->
...
</div>`;var z=`<!-- QGDS Partial: Primary navigation -->
