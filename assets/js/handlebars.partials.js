...
{{/unless}}`;var f=`<!-- QGDS Banner Component -->
...
</figure>`;var m=`<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    {{#each breadcrumbs}}
...
`;var b=`<a class="qld-cta-link {{getClassNames "small, view-all" class}}"
    {{#if id}}id="{{id}}"{{/if}}
    href="{{href}}" 
    target="{{target}}" 
...
`;var Z=`{{! valid class values are: up, down, left, right}}
...
</a>`;var T=`<div class="col-12 col-md-6 col-lg-12">
...
{{/if}}`;var A=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
...
</html>`;var R=`<!-- QGDS Component: Global Alert -->
...
`;var I=`<header class="qld-header" role="banner" >
...
</html>`;var N=`<svg class="qld-icon-{{size}}"{{#if ariaLabel}} aria-label="{{ariaLabel}}"{{/if}}{{#if ariaHidden}} aria-hidden="{{ariaHidden}}"{{/if}}>
  <use href="./assets/img/icons-sprite.svg#qgds-icon-{{iconId}}"></use>
</svg>`;var F=`{{! Image template }}
{{#*inline "imageTag"}}
...
{{/if}}`;var Q=`<div class="alert {{variantClass}} {{customClass}}" role="alert" 
    ...
    {{/if}}
    {{{ content }}}
</div>`;var B=`<!-- QGDS Partial: inpage-nav -->
...
{{/inline}}`;var J=`{{#ifCond logo "===" "coa-landscape"}}
    {{>logoCOALandscape}}
...
{{> footer footer}}`;var z=`<!-- DCTERMS https://www.dublincore.org/specifications/dublin-core/dcmi-terms/-->
{{#if dcTerms}}
...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`;var K=`<!-- Example button to trigger the modal -->
...
</div>`;var e5=`<!-- QGDS Partial: Primary navigation -->
...
</nav>`;var a5=`<section class="qld-promo-panel {{#ifCond type '==' 'indent-text'}}indent{{/ifCond}} {{#ifCond type '==' 'indent-img'}}indent{{/ifCond}} {{type}}">
...
</section>`;var t5=`<!-- QGDS Component: Loading Quick exit -->
...
`;var C5=`<nav class="qld-skip-links" aria-label="skip to content links">
  {{#each skipLinks}}
    <a class="qld-skip-links__item" href="#{{targetId}}">{{label}}</a>
  {{/each}}
</nav>`;var r5=`<!-- QGDS Component: Loading Spinner -->
...
</section>`;var p5=`<!-- QGDS Component: Tag -->
...
`;var f5=`<!-- QGDS Component: Textarea -->
...
<textarea id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    aria-required="true" {{/if}}></textarea>`;var u5=`<!-- QGDS Component: Textbox -->
...
<input id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    isRequired}}required aria-required="true" {{/if}} />`;var m5="<!-- QGDS Partial: typography -->";var g5=`<!-- QGDS Component: Video -->
...
`;function d(e){e.registerPartial("accordion",c),e.registerPartial("backToTop",p),e.registerPartial("banner",f),e.registerPartial("blockquote",u),e.registerPartial("breadcrumbs",m),e.registerPartial("breadcrumbsWrapper",g),e.registerPartial("button",h),e.registerPartial("callout",v),e.registerPartial("callToAction",b),e.registerPartial("card",L),e.registerPartial("containerLayout",k),e.registerPartial("contentFooter",q),e.registerPartial("contentFooterWrapper",M),e.registerPartial("contentPageWithForm",y),e.registerPartial("contentPageWithSideNavigation",x),e.registerPartial("contentWrapper",w),e.registerPartial("correctincorrect",V),e.registerPartial("customLinks",H),e.registerPartial("dateinput",S),e.registerPartial("directionLinks",Z),e.registerPartial("feedbackForm",T),e.registerPartial("followLinks",P),e.registerPartial("footer",A),e.registerPartial("formcheck",O),e.registerPartial("fullPage",D),e.registerPartial("globalAlert",R),e.registerPartial("head",E),e.registerPartial("header",I),e.registerPartial("headerBrand",_),e.registerPartial("homePage",G),e.registerPartial("icon",N),e.registerPartial("image",F),e.registerPartial("inpageAlert",Q),e.registerPartial("inpagenav",B),e.registerPartial("link",j),e.registerPartial("linkColumns",W),e.registerPartial("logo",J),e.registerPartial("logoCOALandscape",Y),e.registerPartial("logoCOALandscape2Lines",U),e.registerPartial("mainContainerWrapper",$),e.registerPartial("metaDcTerms",z),e.registerPartial("metaOpenGraph",X),e.registerPartial("modal",K),e.registerPartial("navbar",e5),e.registerPartial("pagination",i5),e.registerPartial("promotionalPanel",a5),e.registerPartial("quickexit",t5),e.registerPartial("searchInput",s5),e.registerPartial("select",l5),e.registerPartial("sidenav",n5),e.registerPartial("sidenavWrapper",o5),e.registerPartial("skipLinks",C5),e.registerPartial("spinner",r5),e.registerPartial("table",d5),e.registerPartial("tabs",c5),e.registerPartial("tag",p5),e.registerPartial("textarea",f5),e.registerPartial("textbox",u5),e.registerPartial("typography",m5),e.registerPartial("video",g5)}typeof Handlebars!="undefined"&&d(Handlebars);var h5=!1;function v5(e){typeof e=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof e!="undefined"?(h5?console.log("HandleBars Helpers And Partials already loaded, loading again"):h5=!0,r(e),d(e)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&v5(Handlebars);})();
