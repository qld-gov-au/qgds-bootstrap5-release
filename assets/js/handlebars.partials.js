...
`;var V=`{{!-- BETA CDN --}}
<link rel="stylesheet" href="https://beta-static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/css/qld.bootstrap.css">
<script type="text/javascript" async src="https://beta-static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/js/bootstrap.min.js"><\/script>
<script type="text/javascript" async src="https://beta-static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/js/qld.bootstrap.min.js"><\/script>`;var M=`{{!-- DEV CDN --}}
<link rel="stylesheet" href="https://dev-static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/css/qld.bootstrap.css">
<script type="text/javascript" async src="https://dev-static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/js/bootstrap.min.js"><\/script>
<script type="text/javascript" async src="https://dev-static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/js/qld.bootstrap.min.js"><\/script>`;var k=`{{!-- PROD CDN --}}
<link rel="stylesheet" href="https://static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/css/qld.bootstrap.css">
<script type="text/javascript" async src="https://static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/js/bootstrap.min.js"><\/script>
<script type="text/javascript" async src="https://static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/js/qld.bootstrap.min.js"><\/script>
`;var q=`{{!-- STAGING CDN --}}
<link rel="stylesheet" href="https://staging-static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/css/qld.bootstrap.css">
<script type="text/javascript" async src="https://staging-static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/js/bootstrap.min.js"><\/script>
<script type="text/javascript" async src="https://staging-static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/js/qld.bootstrap.min.js"><\/script>`;var y=`{{!-- TEST CDN --}}
<link rel="stylesheet" href="https://test-static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/css/qld.bootstrap.css">
<script type="text/javascript" async src="https://test-static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/js/bootstrap.min.js"><\/script>
<script type="text/javascript" async src="https://test-static.qgov.net.au/qgds-bootstrap5/v2/v2.x.x-latest/assets/js/qld.bootstrap.min.js"><\/script>`;var x=`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
</html>`;var Z=`  <div class="row {{classes}}">
    {{#if lastUpdated}}
    <div class="col-auto">
...
`;var w=`<div class="container qld-content-footer">
  <div class="row">
    {{> @partial-block }}
  </div>
</div>`;var S=`<!DOCTYPE html>
<html lang="en">
...
{{/if}}`;var D=`<!-- QGDS Component: Date input -->
...
`;var E=`{{! valid class values are: up, down, left, right}}
...
</a>`;var I=`<div class="col-12 col-md-6 col-lg-12">
...
{{/if}}`;var N=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
...
</html>`;var j=`<!-- QGDS Component: Global Alert -->
...
<!-- VERSION_DETAILS={"project_id":"@qld-gov-au/qgds-bootstrap5","version":"2.1.22","branch":"merge-main-to-develop-pre-v2.1.x","tag":"","commit":"0240d6e067196466eba25020db842f392cfba447","majorVersion":"v2"} -->
...
`;var Q=`<header class="qld-header " role="banner">
...
</html>`;var Y=`<svg class="qld-icon-{{size}}"{{#if ariaLabel}} aria-label="{{ariaLabel}}"{{/if}}{{#if ariaHidden}} aria-hidden="{{ariaHidden}}"{{/if}}>
  <use href="./assets/img/icons-sprite.svg#qgds-icon-{{iconId}}"></use>
</svg>`;var U=`{{! Image template }}
{{#*inline "imageTag"}}
...
{{#if src}}
  ...
  {{/ifAny}}
{{/if}}
`;var $=`<div class="alert {{variantClass}} {{customClass}}" role="alert"
    {{#if ariaLabel}}
...
>
    ...
    {{/if}}
    {{{ content }}}
</div>`;var z=`<!-- QGDS Partial: inpage-nav -->
...
{{/inline}}`;var e1=`{{#ifCond logo "===" "coa-landscape"}}
    {{>logoCOALandscape}}
...
{{> footer footer}}`;var s1=`<!-- DCTERMS https://www.dublincore.org/specifications/dublin-core/dcmi-terms/-->
{{#if dcTerms}}
...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`;var n1=`<!-- Example button to trigger the modal -->
...
</div>`;var o1=`<!-- QGDS Partial: Primary navigation -->
...
<nav id="main-nav" class="navbar navbar-expand-lg{{#if metadata.alternativeColor}} dark{{/if}}{{#if metadata.verticalOrientation}} vertical{{/if}}" aria-label="Website navigation" role="navigation">
    <div id="navbarNav" class="container">
        ...
        <div id="overlay"></div>
</nav>`;var r1=`<nav aria-label="{{ arialabel }}">
...
</nav>`;var d1=`<section class="qld-promo-panel {{#ifCond type '==' 'indent-text'}}indent{{/ifCond}} {{#ifCond type '==' 'indent-img'}}indent{{/ifCond}} {{type}}">
...
</section>`;var c1=`<!-- QGDS Component: Loading Quick exit -->
...
<div class="qld-search-input {{customClass}}">
    ...
    {{/ifCond}}    
</div>`;var f1=`<!-- QGDS Component: Select -->
...
`;var u1=`<nav class="qld-side-navigation" aria-label="Side Navigation">
  <button
...
`;var g1=`<nav class="qld-skip-links" aria-label="skip to content links">
  {{#each skipLinks}}
    <a class="qld-skip-links__item" href="#{{targetId}}">{{label}}</a>
  {{/each}}
</nav>`;var v1=`<!-- QGDS Component: Loading Spinner -->
...
</section>`;var L1=`<!-- QGDS Component: Tag -->
...
`;var H1=`<!-- QGDS Component: Textarea -->
...
<textarea id="{{id}}" class="form-control {{customClass}} {{#if isFilled}}is-filled{{/if}} {{#if isValid}}is-valid{{else}}{{#ifCond isValid "===" false}}is-invalid{{/ifCond}}{{/if}}"
    ...
    {{#if hint-text}}aria-describedby="{{id}}-hint"{{/if}}>{{value}}</textarea>`;var V1=`<!-- QGDS Component: Textbox -->
...
<input id={{id}} {{#if value}}value="{{value}}"{{/if}}  class="form-control {{customClass}} {{#if isFilled}}is-filled{{/if}} {{#if isValid}}is-valid{{else}}{{#ifCond isValid "===" false}}is-invalid{{/ifCond}}{{/if}}"
    ...
    isRequired}}required{{/if}} {{#if hint-text}}aria-describedby="{{id}}-hint"{{/if}} />`;var M1="<!-- QGDS Partial: typography -->";var k1=`<!-- QGDS Component: Video -->
...
`;function d(e){e.registerPartial("accordion",p),e.registerPartial("backToTop",f),e.registerPartial("banner",u),e.registerPartial("blockquote",m),e.registerPartial("breadcrumbs",g),e.registerPartial("breadcrumbsWrapper",v),e.registerPartial("button",h),e.registerPartial("callout",b),e.registerPartial("callToAction",L),e.registerPartial("card",H),e.registerPartial("cdn-beta",V),e.registerPartial("cdn-dev",M),e.registerPartial("cdn-prod",k),e.registerPartial("cdn-staging",q),e.registerPartial("cdn-test",y),e.registerPartial("containerLayout",x),e.registerPartial("contentFooter",Z),e.registerPartial("contentFooterWrapper",w),e.registerPartial("contentPageWithForm",S),e.registerPartial("contentPageWithSideNavigation",T),e.registerPartial("contentWrapper",O),e.registerPartial("correctincorrect",A),e.registerPartial("customLinks",R),e.registerPartial("dateinput",D),e.registerPartial("details",P),e.registerPartial("directionLinks",E),e.registerPartial("feedbackForm",I),e.registerPartial("followLinks",_),e.registerPartial("footer",N),e.registerPartial("formcheck",G),e.registerPartial("fullPage",F),e.registerPartial("globalAlert",j),e.registerPartial("head",J),e.registerPartial("header",Q),e.registerPartial("headerBrand",B),e.registerPartial("homePage",W),e.registerPartial("icon",Y),e.registerPartial("image",U),e.registerPartial("inpageAlert",$),e.registerPartial("inpagenav",z),e.registerPartial("link",X),e.registerPartial("linkColumns",K),e.registerPartial("logo",e1),e.registerPartial("logoCOADeliveringForQLD",i1),e.registerPartial("logoCOALandscape",a1),e.registerPartial("logoCOALandscape2Lines",t1),e.registerPartial("mainContainerWrapper",C1),e.registerPartial("metaDcTerms",s1),e.registerPartial("metaOpenGraph",l1),e.registerPartial("modal",n1),e.registerPartial("navbar",o1),e.registerPartial("pagination",r1),e.registerPartial("promotionalPanel",d1),e.registerPartial("quickexit",c1),e.registerPartial("searchInput",p1),e.registerPartial("select",f1),e.registerPartial("sidenav",u1),e.registerPartial("sidenavWrapper",m1),e.registerPartial("skipLinks",g1),e.registerPartial("spinner",v1),e.registerPartial("table",h1),e.registerPartial("tabs",b1),e.registerPartial("tag",L1),e.registerPartial("textarea",H1),e.registerPartial("textbox",V1),e.registerPartial("typography",M1),e.registerPartial("video",k1)}typeof Handlebars!="undefined"&&d(Handlebars);var q1=!1;function y1(e){typeof e=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof e!="undefined"?(q1?console.log("HandleBars Helpers And Partials already loaded, loading again"):q1=!0,r(e),d(e)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&y1(Handlebars);})();
//# @qld-gov-au/qgds-bootstrap5 - v2.1.22
