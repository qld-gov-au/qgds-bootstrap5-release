...
</html>`;var k=`  <div class="row {{classes}}">
    {{#if lastUpdated}}
    <div class="col-auto">
...
{{/if}}`;var Z=`<!-- QGDS Component: Date input -->
...
</a>`;var S=`<div class="col-12 col-md-6 col-lg-12">
...
</html>`;var D=`<!-- QGDS Component: Global Alert -->
...
<!-- VERSION_DETAILS={"project_id":"@qld-gov-au/qgds-bootstrap5","version":"2.0.7","branch":"QGDS-325-update-all-icons-to-use-the-qgds-sprite-icons","tag":"","commit":"b7b507b8d43bfc6ef3e119844a351eab1290fac2","majorVersion":"v2"} -->
...
{{/if}}`;var B=`<div class="alert {{variantClass}} {{customClass}}" role="alert" 
    ...
    {{/if}}
    {{{ content }}}
</div>`;var Q=`<!-- QGDS Partial: inpage-nav -->
...
{{/inline}}`;var W=`{{#ifCond logo "===" "coa-landscape"}}
    {{>logoCOALandscape}}
